...
#       SHA256 = 146DC24E4F06D87619F4D16448A685021BB88D843D6EB67065266F7AE68CD56F
#       Size   = 339456 bytes
#   (2026-07-02: post-match lobby-return fallback, AMP warmup-compatible client
#    bootstrap, disabled broad UI DontDestroyOnLoad protection, and test-only
#    autoplay/auto-disconnect hooks for visible proof. Also suppresses stale
#    post-match disconnect loops, clears direct match auto-join state, and
#    clears stuck IL2CPP loading/splash overlays after MainScene stabilizes.)
#
...
$PinnedDistSha256 = "146DC24E4F06D87619F4D16448A685021BB88D843D6EB67065266F7AE68CD56F"
$PinnedDistSize = 339456
...
# ---------------------------------------------------------------------------
if ($Rebuild) {
    Write-Host "[-Rebuild] Compiling BapCustomServerMelon from source." -ForegroundColor Yellow
    ...
    elseif ($ForceOverwriteDist) {
        ...
        Write-Warning "Overwrote dist DLL with freshly built binary. Verify this build in-game before shipping."
    }
    else {
