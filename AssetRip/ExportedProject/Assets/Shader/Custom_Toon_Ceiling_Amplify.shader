Shader "Custom/Toon/Ceiling_Amplify" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		[Toggle(_WORLDSPACETEXTURE_ON)] _WorldSpaceTexture ("World Space Texture", Float) = 1
		_TextureScale ("Texture Scale", Float) = 1
		[Header(Cracks Parameters)] _CracksTexture ("Cracks Texture", 2D) = "white" {}
		_CracksScale ("Cracks Scale", Float) = 1
		_CracksRotation ("Cracks Rotation", Float) = 0
		_CracksColour ("Cracks Colour", Vector) = (0,0,0,0)
		_ThresholdShadow ("ThresholdShadow", Float) = 0.001
