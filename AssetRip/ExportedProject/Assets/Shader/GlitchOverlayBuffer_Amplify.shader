Shader "GlitchOverlayBuffer_Amplify" {
	Properties {
		...
		_AberrationPreMultiply ("Aberration Pre Multiply", Float) = 1
		_AberrationSeparation ("Aberration Separation", Float) = 0
		_WarpUVStrength ("Warp UV Strength", Range(0, 1)) = 1
		[NoScaleOffset] _WarpUVNoise ("Warp UV Noise", 2D) = "white" {}
		_WarpScale ("Warp Scale", Vector) = (1,1,0,0)
		_WarpSpeed ("Warp Speed", Vector) = (0.1,-0.1,0,0)
		_WarpSecondaryOffset ("Warp Secondary Offset", Vector) = (0,0,0,0)
		_WarpSecondaryScale ("Warp Secondary Scale", Vector) = (0,0,0,0)
		_WarpSecondaryInvertDirection ("Warp Secondary Invert Direction", Range(0, 1)) = 1
