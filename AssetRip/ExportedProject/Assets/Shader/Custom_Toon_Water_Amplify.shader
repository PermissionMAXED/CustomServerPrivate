Shader "Custom/Toon/Water_Amplify" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		[Header(Water Colours)] _ShallowColor ("Shallow Color", Vector) = (0.3921569,0.7803922,1,1)
		_DeepColor ("Deep Color", Vector) = (0.1529412,0.2431373,0.6117647,1)
		_FoamEdgeColor ("Foam Edge Color", Vector) = (0.4352942,0.6470588,0.7254902,1)
		_FoamColor ("Foam Color", Vector) = (0.01960784,0.01960784,0.01960784,1)
		_Transparency ("Transparency", Range(0, 1)) = 1
		[Header(Foam Edge Settings)] _FoamEdgeSize ("Foam Edge Size", Range(0, 1)) = 0
		_FoamEdgeNoiseTiling ("Foam Edge Noise Tiling", Float) = 2.04
		_FoamEdgeNoiseMoveSpeed ("Foam Edge Noise Move Speed", Range(0, 2)) = 1
		[Header(Foam Center Settings)] _FoamSize ("Foam Size", Range(0, 1)) = 0.12
		_FoamNoiseScale ("Foam Noise Scale", Vector) = (0.5,2,0,0)
		_FoamCutoff ("Foam Cutoff", Range(0, 1)) = 0.14
		_FoamDisplacement ("Foam Displacement", Float) = 2.45
		_VertexYDisplacement ("Vertex Y Displacement", Range(0, 1)) = 0
		_FoamTimeMultiplier ("Foam Time Multiplier", Range(0, 1)) = 0
		[Header(Reflection Settings)] _CubemapSky ("Cubemap Sky", 2D) = "white" {}
		_ReflectionsIntensity ("Reflections Intensity", Range(0, 1)) = 0.03
		[Header(Depth Settings)] _DepthDistance ("Depth Distance", Float) = 1.63
		_DepthFalloff ("Depth Falloff", Range(0, 5)) = 0.22
		_#1 ("#", Float) = 0
