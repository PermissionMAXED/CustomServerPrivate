Shader "Toon_Atlantis_Bubble" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		_PopVertexOffset ("Pop Vertex Offset", Float) = 0
		_PopNormal ("Pop Normal", Vector) = (0,0,0,0)
		_2ThicknessDistortionTiling ("2~Thickness Distortion Tiling", Vector) = (2,2,0,0)
		_ThicknessDistortion ("Thickness Distortion", 2D) = "white" {}
		_ThicknessDistortionStrength ("Thickness Distortion Strength", Range(0, 1)) = 1
		_ThicknessDistortionScrollSpeed ("Thickness Distortion Scroll Speed", Float) = 0
		_ThicknessTint ("Thickness Tint", Vector) = (0,0,0,0)
		_2ThicknessDistortionSoftnessAmount ("2~Thickness Distortion Softness / Amount", Vector) = (0,0,0,0)
		[Gradient] _ThicknessGradient ("Thickness Gradient", 2D) = "white" {}
		_ThicknessMapOffset ("Thickness Map Offset", Float) = 0.6
		_PopAlpha ("Pop Alpha", 2D) = "white" {}
		_2PopAlphaTiling ("2~Pop Alpha Tiling", Vector) = (2,2,0,0)
		[Header(MatCap Parameters)] _MatCap ("MatCap", 2D) = "white" {}
		_MatCapContribution ("MatCap Contribution", Range(0, 1)) = 1
		_3RefractionFresnelBiasScalePower ("3~Refraction Fresnel Bias / Scale / Power", Vector) = (0,0,0,0)
		_3FresnelBiasScalePower ("3~Fresnel Bias / Scale / Power", Vector) = (0,1,5,0)
		_BubbleSpecFalloff ("Bubble Spec Falloff", Float) = -8
		_BubbleSpecSmoothness ("Bubble Spec Smoothness", Float) = 130
		_BubbleSpecSize ("Bubble Spec Size", Float) = -6.5
		_#1 ("#", Float) = 0
