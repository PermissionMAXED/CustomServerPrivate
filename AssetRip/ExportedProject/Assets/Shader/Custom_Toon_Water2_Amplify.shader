Shader "Custom/Toon/Water2_Amplify" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		_ShallowColor ("Shallow Color", Vector) = (0,0,0,0)
		_DeepColor ("Deep Color", Vector) = (0,0,0,0)
		...
		_DeepShallowOffset ("Deep Shallow Offset", Float) = 0
		[Header(Depth)] _DepthFadeDistance ("Depth Fade Distance", Float) = 1
		_FarColor ("Far Color", Vector) = (0,0,0,0)
		[Header(Near  Far Fresnel)] _FarBias ("Far Bias", Float) = 0
		_FarScale ("Far Scale", Float) = 1
		_FarPower ("Far Power", Float) = 5
		[Toggle(_RIVER_ON)] _RIVER ("RIVER", Float) = 1
		[Header(Flow Map)] [NoScaleOffset] _FlowMap ("Flow Map", 2D) = "white" {}
		_BaseFlowTiling ("Base Flow Tiling", Float) = 1
		_BaseFlowSpeed ("Base Flow Speed", Vector) = (0,0,0,0)
		...
		_NormalScale1 ("Normal Scale", Range(0, 5)) = 0
		[Header(Refraction)] _RefractionStrength ("Refraction Strength", Float) = 0
		[Toggle(_REFLECTIONS_ON)] _REFLECTIONS ("REFLECTIONS", Float) = 1
		[Header(Reflection)] _ReflectionExponent ("Reflection Exponent", Float) = 0
		_ReflectionTint ("Reflection Tint", Vector) = (0,0,0,0)
		[Toggle(_SURFACE_FOAM_ON)] _SURFACE_FOAM ("SURFACE_FOAM", Float) = 1
		[Header(Surface Foam)] [NoScaleOffset] _SurfaceFoam ("Surface Foam", 2D) = "white" {}
		_SurfaceFoamColor ("Surface Foam Color", Vector) = (1,1,1,0)
		_SurfaceFoamTiling ("Surface Foam Tiling", Float) = 1
		_SurfaceFoamSpeed ("Surface Foam Speed", Vector) = (0,0,0,0)
		_SurfaceFoamDistortion ("Surface Foam Distortion", Float) = 0
		_SurfaceFoamMin ("Surface Foam Min", Float) = 0
		_SurfaceFoamAdd ("Surface Foam Add", Float) = 0
		[Toggle(_INTERSECTION_FOAM_ON)] _INTERSECTION_FOAM ("INTERSECTION_FOAM", Float) = 1
		[Header(Intersection Foam)] [NoScaleOffset] _IntersectionFoam ("Intersection Foam", 2D) = "white" {}
		_IntersectionFoamColor ("Intersection Foam Color", Vector) = (0,0,0,0)
		_IntersectionFoamTiling ("Intersection Foam Tiling", Float) = 1
		_IntersectionFoamSpeed ("Intersection Foam Speed", Vector) = (0,0,0,0)
		_IntersectionFoamDistortion ("Intersection Foam Distortion", Float) = 0
		_IntersectionFoamMaskMin ("Intersection Foam Mask Min", Float) = 0
		_IntersectionFoamMaskAdd ("Intersection Foam Mask Add", Float) = 0
		_IntersectionFoamFadeDistance ("Intersection Foam Fade Distance", Float) = 1
		_IntersectionFoamMin ("Intersection Foam Min", Float) = 0
		_IntersectionFoamAdd ("Intersection Foam Add", Float) = 0
		[Toggle(_FLOW_GINT_ON)] _FLOW_GINT ("FLOW_GINT", Float) = 1
		[Header(Flow Glint)] _FlowGlintTint ("Flow Glint Tint", Vector) = (0,0,0,0)
		_FlowGlintMin ("Flow Glint Min", Float) = 0
		_FlowGlintAdd ("Flow Glint Add", Float) = 0
		_FlowGlintMod ("Flow Glint Mod", Float) = 0
		...
		_CausticsPower ("Caustics Power", Float) = 0
		_CausticsSpeed ("Caustics Speed", Vector) = (0,0,0,0)
		_AbsorptionRate ("Absorption Rate", Float) = 0
		[Toggle(_ENVIRONMENTEFFECTS_ON)] _ENVIRONMENTEFFECTS ("_ENVIRONMENTEFFECTS", Float) = 1
		[HDR] _SinCityTint ("Sin City Tint", Vector) = (0,0,0,0)
		_#1 ("#", Float) = 0
