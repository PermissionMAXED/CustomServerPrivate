Shader "Custom/Toon/ToonConsumableContainer" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		[Enum(Common,0,Uncommon,1,Rare,2,Epic,3,Legendary,4)] _Tier ("Tier", Float) = 0
		[Gradient] _Common ("Common", 2D) = "white" {}
		[Gradient] _Uncommon ("Uncommon", 2D) = "white" {}
		[Gradient] _Rare ("Rare", 2D) = "white" {}
		[Gradient] _Epic ("Epic", 2D) = "white" {}
		[Gradient] _Legendary ("Legendary", 2D) = "white" {}
