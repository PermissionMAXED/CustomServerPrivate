Shader "Custom/Toon/Toon_SinCiity_Gun_Amplify" {
	Properties {
		...
		_ErosionSoftness ("Erosion Softness", Range(0, 1)) = 0.05
		_ErosionTextureTiling ("Erosion Texture Tiling", Float) = 0
		_ErosionFalloff ("Erosion Falloff", Float) = 0
		_EdgeOffset ("Edge Offset", Float) = 0
		_EdgeTint ("Edge Tint", Vector) = (0,0,0,0)
		_RevealProgress ("Reveal Progress", Range(0, 1)) = 0
		[PerRendererData] _DestroyProgress ("DestroyProgress", Float) = 0
		[Toggle(_REVEALPROGRESSISUV0Z_ON)] _RevealProgressIsUV0Z ("RevealProgressIsUV0Z", Float) = 0
		[HideInInspector] _OverrideDimension ("OverrideDimension", Float) = 2
