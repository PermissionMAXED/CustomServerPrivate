Shader "WaitingRoomBG_Write_Amplify" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		_ScreenUVHeightStretch ("Screen UV Height Stretch", Range(0.01, 8)) = 2
		_ScreenUVRotation ("Screen UV Rotation", Float) = 0
		_2ScreenUVScrolling ("2~Screen UV Scrolling", Vector) = (0,0,0,0)
		_ScreenUVTiling ("Screen UV Tiling", Float) = 1
		_2ScreenUVOffset ("2~Screen UV Offset", Vector) = (0,0,0,0)
		_#1 ("#", Float) = 0
