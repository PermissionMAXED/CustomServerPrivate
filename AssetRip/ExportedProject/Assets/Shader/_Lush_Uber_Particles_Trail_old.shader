Shader "/Lush/Uber_Particles_Trail_old" {
	Properties {
		[Space(33)] [Header(Texture)] [Space(33)] _Tex ("Tex", 2D) = "white" {}
		_PanSpeed ("Pan Speed", Vector) = (1,0,0,0)
		_GradStartAdd ("Grad Start Add", Float) = 0
		_GradStartMult ("Grad Start Mult", Float) = 0
		_GradAdd ("Grad Add", Float) = 0
		_GradMult ("Grad Mult", Float) = 1.15
		_LUT ("LUT", 2D) = "white" {}
