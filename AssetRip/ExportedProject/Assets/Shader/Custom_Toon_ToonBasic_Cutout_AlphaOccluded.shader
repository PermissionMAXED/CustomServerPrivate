Shader "Custom/Toon/ToonBasic_Cutout_AlphaOccluded" {
	Properties {
		...
		[Header(Alpha Occlusion Parameters)] _OcclusionAreaScreenRadius ("Occlusion Area Screen Radius", Range(0, 1)) = 0.2
		_OcclusionMinAlpha ("Occlusion Min Alpha", Range(0, 1)) = 0.1
		[Header(Alpha Occlusion Height Parameters)] _OcclusionHeightStart ("Occlusion Height Start", Float) = 4
		_OcclusionHeightSoftness ("Occlusion Height Softness", Float) = 1
	}
