Shader "Custom/VertexDisplacementToon" {
	Properties {
		[Header(Base Parameters)] _Color ("Tint", Vector) = (1,1,1,1)
		...
		[Header(Vertex Displacement Settings)] [Space(6)] _Amplitude ("Amplitude", Float) = 1
