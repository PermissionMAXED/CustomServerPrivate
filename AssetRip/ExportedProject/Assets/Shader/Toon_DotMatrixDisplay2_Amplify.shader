Shader "Toon_DotMatrixDisplay2_Amplify" {
	Properties {
		...
		_StepModifier ("StepModifier", Float) = 1
		_StaticStrength ("Static Strength", Range(0, 1)) = 0
		[Toggle(_FLIPBOOKANIMATION_ON)] _FlipBookAnimation ("FlipBook Animation", Float) = 0
		_AnimColumns ("Anim Columns", Float) = 3
		_AnimRows ("Anim Rows", Float) = 3
		_AnimSpeed ("Anim Speed", Float) = 1
		[Toggle(_WORLDSPACEUV_ON)] _WorldSpaceUV ("World Space UV", Float) = 0
		_WorldSpaceTiling ("World Space Tiling", Float) = 0
