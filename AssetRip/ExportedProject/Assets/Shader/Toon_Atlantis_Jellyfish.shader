Shader "Toon_Atlantis_Jellyfish" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		_SineYWidth ("Sine Y Width", Float) = 3
		_TimeScale ("Time Scale", Float) = 3
		_VertexStrengthModifier ("Vertex Strength Modifier", Range(0, 1)) = 0.4
		_SineYMid ("Sine Y Mid", Float) = 1
		_3FresnelBSP ("3~Fresnel B/S/P", Vector) = (0,1,5,0)
		_VertexColorBSinOffsetModifier ("Vertex Color B Sin Offset Modifier", Float) = 1
		_SpinningTimeScale ("Spinning Time Scale", Float) = 1
		[HDR] _PanningStripesColor ("Panning Stripes Color", Vector) = (0,0,0,0)
		[HDR] _ElectricityTint ("Electricity Tint", Vector) = (0,0,0,0)
		_3ElectricityFresnelBSP ("3~Electricity Fresnel B/S/P", Vector) = (0,1,5,0)
		_Electricity ("Electricity", 2D) = "white" {}
		_BobOffset ("Bob Offset", Float) = 0.1
		_ElectricityPanningSpeed ("Electricity Panning Speed", Float) = 0
