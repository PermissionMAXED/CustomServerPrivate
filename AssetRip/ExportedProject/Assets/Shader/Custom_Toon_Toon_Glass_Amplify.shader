Shader "Custom/Toon/Toon_Glass_Amplify" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		[Header(Alpha Settings)] _PerpendicularAlphaAdd ("PerpendicularAlphaAdd", Range(0, 1)) = 0
		...
		[Header(Reflection Settings)] _ReflectionTexture ("ReflectionTexture", 2D) = "white" {}
		_ReflectionStrength ("ReflectionStrength", Range(0, 1)) = 1
		_ReflectionTiling ("ReflectionTiling", Range(0.01, 10)) = 0.01
		_ReflectionTint ("ReflectionTint", Vector) = (1,1,1,0)
		_SpecularColor ("Specular Color", Vector) = (0,0,0,0)
		_SpecCutoffLightDir ("Spec Cutoff Light Dir", Float) = 0
		_SpecSmoothnessLightDir ("Spec Smoothness Light Dir", Float) = 0
		_SpecCutoffViewDir ("Spec Cutoff View Dir", Float) = 0
		_SpecSmoothnessViewDir ("Spec Smoothness View Dir", Float) = 0
		_OuterRimColor ("Outer Rim Color", Vector) = (0,0,0,0)
		_RimPowerOuter ("Rim Power Outer", Float) = 0
		_OuterCutoff ("Outer Cutoff", Float) = 0
		_InnerRimColor ("Inner Rim Color", Vector) = (0,0,0,0)
		_RimPowerInner ("Rim Power Inner", Float) = 0
		_InnerCutoff ("Inner Cutoff", Float) = 0
		_SpecularStrength ("Specular Strength", Float) = 0
		[Header(Fog Of War)] [Toggle] _FOWOccluded ("FOW Occluded", Float) = 1
