Shader "Custom/Toon/Toon_Hologram_Amplify" {
	Properties {
		...
		_HologramLineStrength ("HologramLineStrength", Range(0, 1)) = 1
		_HologramFresnelPower ("HologramFresnelPower", Float) = 5
		_LineVertexOffsetStrength ("LineVertexOffsetStrength", Range(0, 1)) = 0.11
		_DisplacementVector ("DisplacementVector", Vector) = (0,1,0,0)
		_DisplacementScale ("DisplacementScale", Range(0, 1)) = 1
		_DisplacementSpeed ("DisplacementSpeed", Range(0, 5)) = 1
