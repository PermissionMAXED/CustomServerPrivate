Shader "WaitingRoomBG_Read_Amplify" {
	Properties {
		...
		_PixelShape ("Pixel Shape", 2D) = "white" {}
		_PixelsPerLine ("Pixels Per Line", Float) = 32
		_HorizontalScroll ("Horizontal Scroll", Float) = 10
		_VerticalScroll ("Vertical Scroll", Float) = 0
		_Brightness ("Brightness", Float) = 0
		_Overbright ("Overbright", Float) = 0
		[Toggle(_STEPPIXELBYTEXTURE_ON)] _StepPixelByTexture ("StepPixelByTexture", Float) = 0
		_StaticStrength ("Static Strength", Range(0, 1)) = 0
		[Header(LUT Settings)] [Space] [Toggle(_APPLYLUTTOMAINTEX_ON)] _ApplyLUTToMainTex ("Apply LUT To MainTex", Float) = 0
		[Gradient] _LUTGradient ("LUT Gradient", 2D) = "white" {}
		[KeywordHide(_APPLYLUTTOMAINTEX_ON, 0)] _LUTOffset ("LUT Offset", Float) = 0
		_ErosionSoftness ("Erosion Softness", Float) = 0
		[Gradient] _SizeLUT ("Size LUT", 2D) = "white" {}
		_NoiseTiling ("Noise Tiling", Float) = 0
		_NoiseTexture ("Noise Texture", 2D) = "white" {}
		_NoiseStrength ("Noise Strength", Range(0, 1)) = 0.1
		[Toggle(_APPLYEFFECTS_ON)] _ApplyEffects ("Apply Effects", Float) = 1
		_2PixelVignetteSoftnessAmount ("2~Pixel Vignette Softness Amount", Vector) = (0.08,0.89,0,0)
		_2OverlayVignetteSoftnessAmount ("2~Overlay Vignette Softness Amount", Vector) = (0.08,0.89,0,0)
		_VignetteColor ("Vignette Color", Vector) = (0,0,0,0)
