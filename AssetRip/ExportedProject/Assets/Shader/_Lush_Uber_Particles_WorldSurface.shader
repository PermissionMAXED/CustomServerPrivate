Shader "/Lush/Uber_Particles_WorldSurface" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		[Space(33)] [Header(Texture)] [Space(33)] _WorldTex ("WorldTex", 2D) = "white" {}
		_WorldTexNormal ("World Tex Normal", 2D) = "bump" {}
		[Space(33)] [Header(Texture)] [Space(33)] _Tex ("Tex", 2D) = "white" {}
		[Header(MatCap Parameters)] _Matcap ("Matcap", 2D) = "white" {}
		_WorldTexScale ("World Tex Scale", Float) = 1
		_WorldTexNormalScale ("World Tex Normal Scale", Float) = 1
		_WorldTexMult ("World Tex Mult", Float) = 0
		...
		[Toggle(_GROUNDDEPTHFADE_ON)] _GroundDepthFade ("GroundDepthFade", Float) = 0
