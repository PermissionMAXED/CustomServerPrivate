Shader "Custom/Toon/ToonSplatCoverage_Amplify" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		_BlueChannelStrength ("Blue Channel Strength", Range(0, 1)) = 0
		_BlueMin ("Blue Min", Float) = 0.5
		_BlueAdd ("Blue Add", Float) = 0.3
		[Toggle(_WORLDTILETOPTEXTURE_ON)] _WorldTileTopTexture ("WorldTileTopTexture", Float) = 0
		_TopTextureTilingScale ("Top Texture Tiling Scale", Float) = 0
		_TopTextureTilingOffset ("Top Texture Tiling Offset", Vector) = (0,0,0,0)
		_HeightPower ("Height Power", Float) = 0
		_BottomTexture ("Bottom Texture", 2D) = "white" {}
		[Toggle(_SPLATISVERTEXCOLOR_ON)] _SplatIsVertexColor ("SplatIsVertexColor", Float) = 0
		[Toggle(_BLENDWITHRGVERTEXVALUES_ON)] _BlendWithRGVertexValues ("Blend With RG Vertex Values", Float) = 0
		[Toggle(_WORLDTILEBOTTOMTEXTURE_ON)] _WorldTileBottomTexture ("WorldTileBottomTexture", Float) = 0
		_BlendVertexColourTop ("Blend Vertex Colour Top", Vector) = (1,1,1,0)
		_BlendVertexColourBottom ("Blend Vertex Colour Bottom", Vector) = (1,1,1,0)
		_BottomTint ("Bottom Tint", Vector) = (0,0,0,0)
		_BottomDeepTint ("Bottom Deep Tint", Vector) = (0,0,0,0)
		_BottomHeightPower ("Bottom Height Power", Float) = 0
		_BlendAmount ("Blend Amount", Range(0.001, 2)) = 0
		_BottomTextureTilingScale ("Bottom Texture Tiling Scale", Float) = 0
		_#1 ("#", Float) = 0
