Shader "Custom/Toon/Toon_PowerCore_Amplify" {
	Properties {
		...
		_CoreColor ("CoreColor", Vector) = (0,0,0,0)
		...
		[Space(15)] [Header(Overlay Fx)] [Space(5)] [Toggle(_WORLDSPACE_ON)] _WorldSpace ("WorldSpace", Float) = 0
		_OverlayFxTexture ("OverlayFxTexture", 2D) = "white" {}
		_OverlayFxSpeed ("OverlayFxSpeed", Float) = 1
		_OverlayrTextureScale ("OverlayrTextureScale", Float) = 1
		_OverlayFxIntensity ("OverlayFxIntensity", Range(0, 1)) = 0.5
		_twist ("twist", Float) = 0
		_FXPower ("FX Power", Float) = 1
