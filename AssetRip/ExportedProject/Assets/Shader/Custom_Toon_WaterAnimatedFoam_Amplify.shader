Shader "Custom/Toon/WaterAnimatedFoam_Amplify" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		[Header(Foam Settings)] _NoiseFlowmap ("Noise Flowmap", 2D) = "white" {}
		_FoamColor ("Foam Color", Vector) = (0.7490196,0.9490197,1,1)
		_CutoutValue ("Cutout Value", Float) = 0.35
		_WaveAmount ("Wave Amount", Float) = 3.5
		_WaveSpeed ("Wave Speed", Float) = 0.15
		_NoiseSpeed ("Noise Speed", Float) = 0.025
