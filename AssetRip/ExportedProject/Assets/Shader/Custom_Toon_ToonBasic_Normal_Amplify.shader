Shader "Custom/Toon/ToonBasic_Normal_Amplify" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		[Header(WS Height Blend)] [Toggle(_WORLDSPACEHEIGHTBLEND_ON)] _WorldSpaceHeightBlend ("WorldSpaceHeightBlend", Float) = 0
		[KeywordHide(_WORLDSPACEHEIGHTBLEND_ON, 0) ] _WSBlendMinHeight ("WS Blend Min Height", Float) = 0
		[KeywordHide(_WORLDSPACEHEIGHTBLEND_ON, 0) ] _WSBlendMaxHeight ("WS Blend Max Height", Float) = 1
		[KeywordHide(_WORLDSPACEHEIGHTBLEND_ON, 0) ] _WSGradientSpread ("WS Gradient Spread", Range(-1, 1)) = 0
		[KeywordHide(_WORLDSPACEHEIGHTBLEND_ON, 0) ] _WSBlendColor ("WS Blend Color", Vector) = (0.6074225,0.6362904,0.735849,0)
		[Toggle(_VCEDGEMASK_ON)] _VCEdgeMask ("VC Edge Mask", Float) = 0
		[Toggle(_VCOCCLUSION_ON)] _VCOcclusion ("VCOcclusion", Float) = 0
		_EdgeMask ("Edge Mask", Range(0, 1)) = 0
		_VCEMHueShift ("VCEM Hue Shift", Range(-0.5, 0.5)) = 0
		_VCEMSaturationShift ("VCEM Saturation Shift", Range(-0.5, 0.5)) = 0
		_VCEMValueShift ("VCEM Value Shift", Range(-0.5, 0.5)) = 0
		_EdgeMaskNoiseScale ("Edge Mask Noise Scale", Float) = 0
		_EdgeMaskNoise ("Edge Mask Noise", 2D) = "white" {}
		_EdgeMaskNoiseOffset ("Edge Mask Noise Offset", Float) = 0
		_VCOStep ("VCO Step", Range(0, 1)) = 0
		_VCOStepOffset ("VCO Step Offset", Range(0, 1)) = 0
		[Enum(None,0,Red,1,Green,2,Blue,3,Alpha,4)] _DebugMode ("Debug Mode", Float) = 0
