Shader "Toon_Atlantis_Fish" {
	Properties {
		...
		_SideToSide ("Side To Side", Range(0, 1)) = 0
		_PivotAmount ("Pivot Amount", Float) = 0
		_TwistAmount ("Twist Amount", Float) = 0
		_Wave ("Wave", Float) = 0
		_FishLength ("Fish Length", Float) = 0
		_MaskStart ("Mask Start", Float) = 0
		_MaskEnd ("Mask End", Float) = 0
		[Header(MatCap Parameters)] _MatCap ("MatCap", 2D) = "white" {}
		_MatCapContribution ("MatCap Contribution", Range(0, 1)) = 1
		_VelocityCurrent ("VelocityCurrent", Vector) = (0,0,0,0)
		_VelocityPrevious ("VelocityPrevious", Vector) = (0,0,0,0)
		_InstanceColor ("InstanceColor", Vector) = (0,0,0,0)
		_DebugView ("Debug View", Range(0, 1)) = 0
		_InstanceCount ("Instance Count", Float) = 0
