Shader "Custom/Toon/Toon_Floor_Amplify" {
	Properties {
		...
		_PlanarTiling ("PlanarTiling", Range(0.01, 10)) = 0
		_TileNormal ("TileNormal", 2D) = "bump" {}
		_ReflectionTiling ("ReflectionTiling", Range(0.01, 10)) = 0
		_ReflectionTint ("ReflectionTint", Vector) = (0,0,0,0)
		_floor_tile_Roughness ("floor_tile_Roughness", 2D) = "white" {}
