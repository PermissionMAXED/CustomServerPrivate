Shader "/Lush/New_Uber_Particles_Advanced_scroll_AlphaTint" {
	Properties {
		...
		[Toggle(_MULTIPLYTINTALPHA_ON)] _MultiplyTintAlpha ("Multiply Tint Alpha", Float) = 0
		[Toggle(_USETEXTURERGBA_ON)] _UseTextureRGBA ("Use Texture RGBA", Float) = 0
