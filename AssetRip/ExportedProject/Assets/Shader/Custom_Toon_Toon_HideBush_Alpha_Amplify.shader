Shader "Custom/Toon/Toon_HideBush_Alpha_Amplify" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		_BiomeBlendMinHeight ("Biome Blend Min Height", Float) = 0
		_BiomeBlendMaxHeight ("Biome Blend Max Height", Float) = 0
		...
		[Toggle(_MASKALPHABYDIMENSION_ON)] _MaskAlphaByDimension ("Mask Alpha By Dimension", Float) = 0
