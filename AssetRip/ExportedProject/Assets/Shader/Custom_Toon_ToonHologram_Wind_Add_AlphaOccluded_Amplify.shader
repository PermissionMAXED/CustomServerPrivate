Shader "Custom/Toon/ToonHologram_Wind_Add_AlphaOccluded_Amplify" {
	Properties {
		...
		_LinePanSpeed ("LinePanSpeed", Vector) = (1,1,0,0)
		...
		_LineTiling ("LineTiling", Range(0.01, 10)) = 1
		_OcclusionHeightSoftness ("Occlusion Height Softness", Float) = 2.7
		_HologramLineStep ("HologramLineStep", Range(0, 1)) = 0.1
		[Header(Wind Parameters)] _WindDirection ("Wind Direction", Vector) = (1,0,1,0)
		_WindIntensity ("Wind Intensity", Range(0, 300)) = 8
		_WindSpeed ("Wind Speed", Float) = 5
		_WindTurbulence ("Wind Turbulence", Range(0, 1)) = 0.3
		_WindScale ("Wind Scale", Range(0, 1)) = 0.5
		_LineBlendStrength ("LineBlendStrength", Range(0, 1)) = 0.56
		_LineTint ("LineTint", Vector) = (1,1,1,0)
