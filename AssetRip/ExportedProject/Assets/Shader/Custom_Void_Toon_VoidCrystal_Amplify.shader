Shader "Custom/Void/Toon_VoidCrystal_Amplify" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		[Header(Fresnel Settings)] _ParallaxTexture ("ParallaxTexture", 2D) = "white" {}
		_ParallaxStrength ("ParallaxStrength", Range(0, 1)) = 1
		_ParallaxOffset ("ParallaxOffset", Float) = 1
		_ParallaxTint ("ParallaxTint", Vector) = (1,1,1,0)
		[Header(Fresnel Settings)] _FresnelNoise ("FresnelNoise", 2D) = "white" {}
		_FresnelSize ("FresnelSize", Float) = 1
		_FresnelColor ("Fresnel Color", Vector) = (0,0,0,0)
		_FresnelNoiseSpeed ("FresnelNoiseSpeed", Vector) = (1,1,0,0)
		[Header(Vertex Offset Settings)] _MoveAmplitude ("Move Amplitude", Float) = 1
		_MoveFrequency ("Move Frequency", Float) = 1
