Shader "Custom/Toon/Toon_Frozen_Amplify" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		[Header(Gradient Parameters)] _TopColor ("Top Color", Vector) = (0.64,0.77,0.94,1)
		_BottomColor ("Bottom Color", Vector) = (0.23,0,0.95,1)
		_BottomColorIntensity ("Bottom Color Intensity", Range(0, 1)) = 1
		_TintColor ("TintColor", Vector) = (1,1,1,1)
		[Header(Shared Parameters)] _NoiseTexture ("Noise Texture", 2D) = "white" {}
		[Header(Shared Parameters)] _IcicleNoiseTexture ("Icicle Noise Texture", 2D) = "white" {}
		[Header(Ice Parameters)] _NoiseScale ("Noise Scale", Float) = 1
		_IcicleNoisePower ("Icicle Noise Power", Range(0, 10)) = 0
		_IcicleEffectIntensity ("Icicle Effect Intensity", Range(0, 1)) = 0
		_IcicleAmplitude ("Icicle Amplitude", Float) = 0
		_VertexNormalExpand ("Vertex Normal Expand", Float) = 0
		_InnerRimOffset ("Inner Rim Offset", Float) = 1.5
		_InnerRimPower ("Inner Rim Power", Float) = 0.7
		[Header(Sparkles Parameters)] _SparkleTiling ("Sparkle Tiling", Float) = 0
		_SparkleSpeed ("Sparkle Speed", Range(0, 0.1)) = 0
		_FresnelBiasScalePower ("Fresnel Bias, Scale, Power", Vector) = (0,0,0,0)
		_Brightness ("Brightness", Float) = 0
		_ScreenContribution ("Screen Contribution", Float) = 0
		_#1 ("#", Float) = 0
