Shader "Custom/Toon/ToonBasic_PatternOverlay_Amplify" {
	Properties {
		...
		_WSBlendMinHeight ("WS Blend Min Height", Float) = 0
		_WSBlendMaxHeight ("WS Blend Max Height", Float) = 1
		_WSGradientSpread ("WS Gradient Spread", Range(-1, 1)) = 0
		_WSBlendColor ("WS Blend Color", Vector) = (0.6074225,0.6362904,0.735849,0)
		_PatternScale ("Pattern Scale", Float) = 1
		_PatternOpacity ("Pattern Opacity", Range(0, 1)) = 1
		_Rotation ("Rotation", Float) = 0
		_TopOpacity ("Top Opacity", Range(0, 1)) = 0
		[Toggle(_MULTIPLYVERTEXCOLORS_ON)] _MultiplyVertexColors ("Multiply Vertex Colors", Float) = 1
		_Pattern ("Pattern", 2D) = "white" {}
		_Local ("!Local", Range(0, 1)) = 0
		_LocalDenominator ("Local Denominator", Float) = 0
		_LocalTilingSize ("Local Tiling Size", Vector) = (0,0,0,0)
		_BlendingPower ("Blending Power", Range(1, 10)) = 1
