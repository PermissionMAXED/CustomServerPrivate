Shader "Custom/Toon/Toon_Roads_Amplify" {
	Properties {
		_Centered ("[Centered]", Float) = 0
		_AmplifyProperties ("#Amplify Properties", Float) = 0
		[HideInInspector] _EmissionColor ("Emission Color", Vector) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff ("Alpha Cutoff ", Range(0, 1)) = 0.5
		[Toggle(_WORLDTILED_ON)] _WorldTiled ("World Tiled", Float) = 0
		_WorldTilingScale ("World Tiling Scale", Float) = 0
		_WorldTilingOffset ("World Tiling Offset", Vector) = (0,0,0,0)
		_RTexture1 ("(R) Texture 1", 2D) = "white" {}
		_RTexture2 ("(R) Texture 2", 2D) = "white" {}
		_RTexture3 ("(R) Texture 3", 2D) = "white" {}
		_GTexture ("(G) Texture", 2D) = "white" {}
		_BTexture ("(B) Texture", 2D) = "white" {}
		[Toggle(_DEBUGVERTEXCOLOR_ON)] _DebugVertexColor ("Debug Vertex Color", Float) = 0
		_BlendAmount ("Blend Amount", Range(0.001, 2)) = 0
		_MaskFalloff1 ("Mask Falloff", Range(0, 1)) = 0.1
		_MaskBounds ("Mask Bounds", Float) = 0
		_EdgeNoise ("Edge Noise", 2D) = "white" {}
		_ErosionSoftness ("Erosion Softness", Float) = 0
		_ErosionSoftness2 ("Erosion Softness 2", Float) = 0
		_BottomHeightPower ("Bottom Height Power", Float) = 0
		_AlphaSmoothstepMin ("Alpha Smoothstep Min", Float) = 0
		_AlphaSmoothstepAdd ("Alpha Smoothstep Add", Float) = 0
		_AlphaClipThreshold ("Alpha Clip Threshold", Float) = 0
		_EdgeDarkAdd ("Edge Dark Add", Float) = 0
		_#1 ("#", Float) = 0
