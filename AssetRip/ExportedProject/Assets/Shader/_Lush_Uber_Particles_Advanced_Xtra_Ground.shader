Shader "/Lush/Uber_Particles_Advanced_Xtra_Ground" {
	Properties {
		...
		[Toggle(_ISADDITIVE_ON)] _IsAdditive ("IsAdditive", Float) = 0
		[Toggle(_INVERTMASK_ON)] _InvertMask ("Invert Mask", Float) = 0
		[Toggle(_ROUNDMASKBYTC_ON)] _RoundMaskByTC ("Round Mask By TC", Float) = 0
		_#1 ("#", Float) = 0
