...
namespace GameAnalyticsSDK.Events
{
	public static class GA_Progression
	{
		...
		public static void CreateEvent(GAProgressionStatus progressionStatus, string progression01, string progression02, string progression03, int? score, IDictionary<string, object> fields, bool mergeFields)
		{
		}
	}
}
