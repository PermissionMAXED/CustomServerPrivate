...
namespace BAPBAP.UI
{
	public class UILobbyGameModifierIcon : MonoBehaviour
	{
		...
		{
			public UILobbyGameModifierIcon Prefab;
		}
		...
		public class Factory
		{
			...
			public UILobbyGameModifierIcon Create(Action clickAction)
			{
				return null;
			}
		}
		...
		public void SetUp(GameModifier.GameModifierConfiguration modConfig)
		{
		}
