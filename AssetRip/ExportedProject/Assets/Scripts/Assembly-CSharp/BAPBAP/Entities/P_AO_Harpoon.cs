...
namespace BAPBAP.Entities
{
	public class P_AO_Harpoon : Passive
	{
		...
		{
			[NonSerialized]
			public P_AO_Harpoon passive;

			public CustomShootSubroutine(P_AO_Harpoon _ability)
			{
			}
		...
		public class CallGenericAbilityTrigger1 : SimulationSubroutine
		{
			...
			public CallGenericAbilityTrigger1(P_AO_Harpoon _ability)
			{
			}
		...
		public class CustomEquipSubroutine : SimulationSubroutine
		{
			...
			public CustomEquipSubroutine(P_AO_Harpoon _ability)
			{
			}
		...
		public class CustomRemovePistolSubroutine : SimulationSubroutine
		{
			...
			public CustomRemovePistolSubroutine(P_AO_Harpoon _ability)
			{
			}
		...
		public P_AO_Harpoon(EntityManager entityManager, Config config)
			: base(null)
		{
		}
