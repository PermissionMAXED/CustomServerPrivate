...
namespace BAPBAP.Entities
{
	public class P_OnDamage_Execute : Passive
	{
		...
		{
			[NonSerialized]
			public P_OnDamage_Execute passive;

			[NonSerialized]
			public byte triggerFinished;

			public CustomPassiveSubroutine(P_OnDamage_Execute _ability, byte _triggerFinished)
			{
			}
		...
		public P_OnDamage_Execute(EntityManager entityManager, Config config)
			: base(null)
		{
		}
