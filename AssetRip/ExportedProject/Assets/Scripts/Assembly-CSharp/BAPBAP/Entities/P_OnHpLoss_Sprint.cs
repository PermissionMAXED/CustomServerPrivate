...
{
	public class P_OnHpLoss_Sprint : Passive
	{
		[Serializable]
		...
		{
			[NonSerialized]
			public P_OnHpLoss_Sprint passive;

			[NonSerialized]
			public byte triggerFinished;

			public CustomPassiveSubroutine(P_OnHpLoss_Sprint _ability, byte _triggerFinished)
			{
			}
		...
		public P_OnHpLoss_Sprint(EntityManager entityManager, Config config)
			: base(null)
		{
		}
