...
namespace BAPBAP.Entities
{
	public class P_OnUse_Lmb_Burn : Passive
	{
		...
		{
			[NonSerialized]
			public P_OnUse_Lmb_Burn passive;

			[NonSerialized]
			public byte triggerFinished;

			public CustomPassiveSubroutine(P_OnUse_Lmb_Burn _ability, byte _triggerFinished)
			{
			}
		...
		public P_OnUse_Lmb_Burn(EntityManager entityManager, Config config)
			: base(null)
		{
		}
