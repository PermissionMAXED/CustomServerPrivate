...
namespace BAPBAP.Entities
{
	public class P_AO_Shotgun : Passive
	{
		...
		public class IdleReloadSubroutine : SimulationSubroutine
		{
			...
			public IdleReloadSubroutine(P_AO_Shotgun _ability, float _autoReloadTime, byte _reloadTrigger)
			{
			}
		...
		public class CustomShootSubroutine : SimulationSubroutine
		{
			...
			public CustomShootSubroutine(P_AO_Shotgun _ability)
			{
			}
		...
		public class CallGenericAbilityTrigger1 : SimulationSubroutine
		{
			...
			public CallGenericAbilityTrigger1(P_AO_Shotgun _ability)
			{
			}
		...
		public class CustomCheckAmmoSubroutine : SimulationSubroutine
		{
			...
			public CustomCheckAmmoSubroutine(P_AO_Shotgun _ability, byte _triggerIdle, byte _triggerReload, byte _triggerRemove)
			{
			}
		...
		public class CustomIdleReloadAmmoSubroutine : SimulationSubroutine
		{
			...
			public CustomIdleReloadAmmoSubroutine(P_AO_Shotgun _ability, float _reloadTime, byte _finishedTrigger)
			{
			}
		...
		public class CustomReloadAmmoSubroutine : SimulationSubroutine
		{
			...
			public CustomReloadAmmoSubroutine(P_AO_Shotgun _ability)
			{
			}
		...
		public class CustomRemovePistolSubroutine : SimulationSubroutine
		{
			...
			public CustomRemovePistolSubroutine(P_AO_Shotgun _ability)
			{
			}
		...
		public P_AO_Shotgun(EntityManager entityManager, Config config)
			: base(null)
		{
		}
