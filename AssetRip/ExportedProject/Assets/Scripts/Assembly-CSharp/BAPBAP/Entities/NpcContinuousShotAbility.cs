...
namespace BAPBAP.Entities
{
	public class NpcContinuousShotAbility : Ability
	{
		...
		{
			[NonSerialized]
			public NpcContinuousShotAbility ability;

			[NonSerialized]
			public bool setEnabled;

			public CustomCastVfxSubroutine(NpcContinuousShotAbility _ability, bool _setEnabled)
			{
			}
		...
		public class CustomVisibleIndicatorSubroutine : SimulationSubroutine
		{
			...
			public CustomVisibleIndicatorSubroutine(NpcContinuousShotAbility _ability, bool _setEnabled)
			{
			}
		...
		public class CustomShootSubroutine : SimulationSubroutine
		{
			...
			public CustomShootSubroutine(NpcContinuousShotAbility _ability, byte _finishTrigger, byte _silenceTrigger, float _shootDurationTime, AnimLayerIndices _animLayer)
			{
			}
		...
		public void ShootProjectile(Vector3 lookDir, int predTickNum)
		{
		}
