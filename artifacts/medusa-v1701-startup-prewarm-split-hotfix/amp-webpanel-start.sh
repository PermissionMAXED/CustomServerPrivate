...
export CustomServer__GameServerManagedBootstrapStatusTimeoutSeconds="${GAME_MANAGED_BOOTSTRAP_TIMEOUT:-90}"
...
[ -n "$DEPLOYED_RELEASE" ] || DEPLOYED_RELEASE="medusa-v1688-match-cleanup-map2"
