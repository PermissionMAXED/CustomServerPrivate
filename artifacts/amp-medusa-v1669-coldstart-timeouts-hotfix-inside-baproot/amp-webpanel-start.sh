...
export CustomServer__GameServerReadyTimeoutSeconds="${BAPCUSTOM_GAME_READY_TIMEOUT:-300}"
export CustomServer__RequireGameServerKcpPort="${REQUIRE_GAME_KCP_PORT:-false}"
export CustomServer__GameServerTcpPortReadyTimeoutSeconds="${BAPCUSTOM_GAME_TCP_READY_TIMEOUT:-180}"
...
export CustomServer__GameServerStartupStallGraceSeconds="${BAPCUSTOM_GAME_STARTUP_STALL_GRACE:-210}"
export CustomServer__GameServerStartupStallSeconds="${BAPCUSTOM_GAME_STARTUP_STALL:-90}"
...
[ -n "$DEPLOYED_RELEASE" ] || DEPLOYED_RELEASE="medusa-v1669-coldstart-timeouts"
