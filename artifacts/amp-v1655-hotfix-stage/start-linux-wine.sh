...
export CustomServer__GameServerTcpPortReadyTimeoutSeconds="${GAME_TCP_READY_TIMEOUT:-180}"
...
export CustomServer__GameServerStartupStallGraceSeconds="${GAME_STARTUP_STALL_GRACE:-210}"
export CustomServer__GameServerStartupStallSeconds="${GAME_STARTUP_STALL:-90}"
...
export BAPCUSTOM_RELEASE_LABEL="${BAPCUSTOM_RELEASE_LABEL:-bapcustomserver-20260602-medusa-queue-hotfix-110702}"
