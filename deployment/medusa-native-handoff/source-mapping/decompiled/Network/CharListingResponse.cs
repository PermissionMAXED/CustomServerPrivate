...
[System.Serializable]
public class CharListingResponse : Il2CppSystem.Object
{
	[System.Serializable]
	public class CharListing : Il2CppSystem.Object
	{
		...
		static CharListing()
		{
			Il2CppClassPointerStore<CharListing>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<CharListingResponse>.NativeClassPtr, "CharListing");
			...
			NativeFieldInfoPtr_rewards = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CharListing>.NativeClassPtr, "rewards");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CharListing>.NativeClassPtr, 100666507);
		}
	...
	public class Asset : Il2CppSystem.Object
	{
		...
		static Asset()
		{
			Il2CppClassPointerStore<Asset>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<CharListingResponse>.NativeClassPtr, "Asset");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Asset>.NativeClassPtr, 100666508);
		}
	...
	static CharListingResponse()
	{
		Il2CppClassPointerStore<CharListingResponse>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Network", "CharListingResponse");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CharListingResponse>.NativeClassPtr);
		NativeFieldInfoPtr_charListings = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CharListingResponse>.NativeClassPtr, "charListings");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CharListingResponse>.NativeClassPtr, 100666506);
	}

	[CallerCount(5410)]
	[CachedScanResults(RefRangeStart = 11, RefRangeEnd = 5421, XrefRangeStart = 11, XrefRangeEnd = 5421, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe CharListingResponse()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CharListingResponse>.NativeClassPtr))
	{
		System.IntPtr* ptr = null;
		Unsafe.SkipInit(out System.IntPtr intPtr2);
		System.IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
	...
	public CharListingResponse(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
