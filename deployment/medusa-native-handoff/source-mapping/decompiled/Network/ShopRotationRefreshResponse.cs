...
[System.Serializable]
public class ShopRotationRefreshResponse : Il2CppSystem.Object
{
	[System.Serializable]
	public class Asset : Il2CppSystem.Object
	{
		...
		static Asset()
		{
			Il2CppClassPointerStore<Asset>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<ShopRotationRefreshResponse>.NativeClassPtr, "Asset");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Asset>.NativeClassPtr, 100666599);
		}
	...
	public unsafe Il2CppReferenceArray<ShopResponse.Listing> rotationListings
	{
		get
		{
			...
			return (intPtr != (System.IntPtr)0) ? Il2CppObjectPool.Get<Il2CppReferenceArray<ShopResponse.Listing>>(intPtr) : null;
		}
		set
		{
	...
	public unsafe Il2CppReferenceArray<ShopResponse.Listing> freebieListings
	{
		get
		{
	...
	public unsafe Asset cost
	{
		get
		{
			...
			System.IntPtr intPtr = *(System.IntPtr*)num;
			return (intPtr != (System.IntPtr)0) ? Il2CppObjectPool.Get<Asset>(intPtr) : null;
		}
		set
		{
			System.IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (System.IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_cost)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)asset));
		}
	}

	static ShopRotationRefreshResponse()
	{
		Il2CppClassPointerStore<ShopRotationRefreshResponse>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Network", "ShopRotationRefreshResponse");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ShopRotationRefreshResponse>.NativeClassPtr);
		NativeFieldInfoPtr_rotationListings = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ShopRotationRefreshResponse>.NativeClassPtr, "rotationListings");
		NativeFieldInfoPtr_freebieListings = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ShopRotationRefreshResponse>.NativeClassPtr, "freebieListings");
		NativeFieldInfoPtr_currentDropRefreshes = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ShopRotationRefreshResponse>.NativeClassPtr, "currentDropRefreshes");
		NativeFieldInfoPtr_cost = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ShopRotationRefreshResponse>.NativeClassPtr, "cost");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShopRotationRefreshResponse>.NativeClassPtr, 100666598);
	}

	[CallerCount(5410)]
	[CachedScanResults(RefRangeStart = 11, RefRangeEnd = 5421, XrefRangeStart = 11, XrefRangeEnd = 5421, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ShopRotationRefreshResponse()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ShopRotationRefreshResponse>.NativeClassPtr))
	{
		System.IntPtr* ptr = null;
		Unsafe.SkipInit(out System.IntPtr intPtr2);
		System.IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
	...
	public ShopRotationRefreshResponse(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
