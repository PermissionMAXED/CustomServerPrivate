...
[System.Serializable]
public class LinkResponse : Il2CppSystem.Object
{
	...
	static LinkResponse()
	{
		Il2CppClassPointerStore<LinkResponse>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Network", "LinkResponse");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<LinkResponse>.NativeClassPtr);
		NativeFieldInfoPtr_provider = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<LinkResponse>.NativeClassPtr, "provider");
		NativeFieldInfoPtr_params = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<LinkResponse>.NativeClassPtr, "params");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LinkResponse>.NativeClassPtr, 100666568);
	}

	[CallerCount(5410)]
	[CachedScanResults(RefRangeStart = 11, RefRangeEnd = 5421, XrefRangeStart = 11, XrefRangeEnd = 5421, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe LinkResponse()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<LinkResponse>.NativeClassPtr))
	{
	...
	public LinkResponse(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
