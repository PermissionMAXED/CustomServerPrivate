...
public class P_D_Atlantis_SO : PassiveSO
{
	...
	public unsafe P_D_Atlantis.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<P_D_Atlantis.Config>(intPtr) : null;
		}
		set
		{
	...
	static P_D_Atlantis_SO()
	{
		Il2CppClassPointerStore<P_D_Atlantis_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_D_Atlantis_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_D_Atlantis_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_D_Atlantis_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_D_Atlantis_SO>.NativeClassPtr, 100677119);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_Passive_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_D_Atlantis_SO>.NativeClassPtr, 100677120);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_D_Atlantis_SO>.NativeClassPtr, 100677121);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 176005, XrefRangeEnd = 176008, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe P_D_Atlantis_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_D_Atlantis_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public P_D_Atlantis_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
