...
public class P_CharAugment_BigShot : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		public unsafe float scaleMult
		{
			...
			set
			{
				*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_scaleMult)) = num;
			}
		}

		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_CharAugment_BigShot>.NativeClassPtr, "Config");
			...
			NativeFieldInfoPtr_scaleMult = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "scaleMult");
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100676552);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 172971, XrefRangeEnd = 172972, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static P_CharAugment_BigShot()
	{
		Il2CppClassPointerStore<P_CharAugment_BigShot>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_CharAugment_BigShot");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_CharAugment_BigShot>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_CharAugment_BigShot>.NativeClassPtr, "config");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_CharAugment_BigShot>.NativeClassPtr, 100676548);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_CharAugment_BigShot>.NativeClassPtr, 100676549);
		NativeMethodInfoPtr_OnHitboxSpawned_Public_Virtual_Void_GameObject_EntityManager_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_CharAugment_BigShot>.NativeClassPtr, 100676550);
		NativeMethodInfoPtr_ModifyHitbox_Private_Void_GameObject_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_CharAugment_BigShot>.NativeClassPtr, 100676551);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 172972, XrefRangeEnd = 172978, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_CharAugment_BigShot(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_CharAugment_BigShot>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 172978, XrefRangeEnd = 172988, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_CharAugment_BigShot(IntPtr pointer)
		: base(pointer)
	{
	}
}
