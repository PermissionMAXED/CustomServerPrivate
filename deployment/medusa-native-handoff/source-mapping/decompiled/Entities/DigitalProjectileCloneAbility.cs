...
public class DigitalProjectileCloneAbility : Ability
{
	public class CustomShootSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_DigitalProjectileCloneAbility_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0;

		public unsafe DigitalProjectileCloneAbility ability
		{
			get
			{
				...
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<DigitalProjectileCloneAbility>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_ability)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)digitalProjectileCloneAbility));
			}
		}

		static CustomShootSubroutine()
		{
			Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "CustomShootSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_DigitalProjectileCloneAbility_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr, 100674729);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr, 100674730);
		}
		...
		public unsafe CustomShootSubroutine(DigitalProjectileCloneAbility _ability)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr))
		{
			...
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_ability);
			...
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_DigitalProjectileCloneAbility_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 151103, XrefRangeEnd = 151108, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static DigitalProjectileCloneAbility()
	{
		Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "DigitalProjectileCloneAbility");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr);
		NativeFieldInfoPtr_spellPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "spellPrefab");
		NativeFieldInfoPtr_firingPoint = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "firingPoint");
		NativeFieldInfoPtr_castMotionLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "castMotionLockType");
		NativeFieldInfoPtr_applyAtkSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "applyAtkSpeedMultiplier");
		NativeFieldInfoPtr_applyCooldownMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "applyCooldownMultiplier");
		NativeFieldInfoPtr_damage = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "damage");
		NativeFieldInfoPtr_damageScaling = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "damageScaling");
		NativeFieldInfoPtr_speed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "speed");
		NativeFieldInfoPtr_ttl = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "ttl");
		NativeFieldInfoPtr_spread = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "spread");
		NativeFieldInfoPtr_castingTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "castingTime");
		NativeFieldInfoPtr_recoveryTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "recoveryTime");
		NativeFieldInfoPtr_baseCooldownTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "baseCooldownTime");
		NativeFieldInfoPtr_camKickPower = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "camKickPower");
		NativeFieldInfoPtr_animLayer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "animLayer");
		NativeFieldInfoPtr_primaryCharManager = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "primaryCharManager");
		NativeFieldInfoPtr_primaryTv = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "primaryTv");
		NativeFieldInfoPtr_EXTERNAL_TRIGGER_CAST = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, "EXTERNAL_TRIGGER_CAST");
		NativeMethodInfoPtr_PreAwake_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, 100674722);
		NativeMethodInfoPtr_Start_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, 100674723);
		NativeMethodInfoPtr_Destroy_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, 100674724);
		NativeMethodInfoPtr_DoAttack_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, 100674725);
		NativeMethodInfoPtr_Shoot_Private_Void_Vector3_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, 100674726);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, 100674727);
		NativeMethodInfoPtr_Weaved_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr, 100674728);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 151108, XrefRangeEnd = 151197, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 151197, XrefRangeEnd = 151211, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 151211, XrefRangeEnd = 151224, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 151224, RefRangeEnd = 151225, XrefRangeStart = 151224, XrefRangeEnd = 151224, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 151267, RefRangeEnd = 151268, XrefRangeStart = 151225, XrefRangeEnd = 151267, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe DigitalProjectileCloneAbility()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<DigitalProjectileCloneAbility>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public DigitalProjectileCloneAbility(IntPtr pointer)
		: base(pointer)
	{
	}
}
