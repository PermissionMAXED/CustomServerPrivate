...
public class P_OnUse_PoisonWave : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		private static readonly IntPtr NativeFieldInfoPtr_numberOfAbilitiesToTrigger;
		...
		public unsafe int numberOfAbilitiesToTrigger
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_numberOfAbilitiesToTrigger);
				return *(int*)num;
			}
			set
			{
				*(int*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_numberOfAbilitiesToTrigger)) = num;
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr, "Config");
			...
			NativeFieldInfoPtr_numberOfAbilitiesToTrigger = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "numberOfAbilitiesToTrigger");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677816);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 178498, XrefRangeEnd = 178503, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomPassiveReadySubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_P_OnUse_PoisonWave_Byte_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0;

		public unsafe P_OnUse_PoisonWave passive
		{
			get
			{
				...
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<P_OnUse_PoisonWave>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_passive)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)p_OnUse_PoisonWave));
			}
		}
		...
		{
			Il2CppClassPointerStore<CustomPassiveReadySubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr, "CustomPassiveReadySubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_P_OnUse_PoisonWave_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveReadySubroutine>.NativeClassPtr, 100677817);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveReadySubroutine>.NativeClassPtr, 100677818);
		}
		...
		public unsafe CustomPassiveReadySubroutine(P_OnUse_PoisonWave _ability, byte _triggerFinished)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomPassiveReadySubroutine>.NativeClassPtr))
		{
			...
			*(byte**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_triggerFinished;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_P_OnUse_PoisonWave_Byte_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}
	...
	public class CustomPassiveSubroutine : SimulationSubroutine
	{
		...
		{
			Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr, "CustomPassiveSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_P_OnUse_PoisonWave_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677819);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677820);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677821);
		}

		[CallerCount(35)]
		[CachedScanResults(RefRangeStart = 123824, RefRangeEnd = 123859, XrefRangeStart = 123824, XrefRangeEnd = 123859, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomPassiveSubroutine(P_OnUse_PoisonWave _ability, byte _triggerFinished)
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 178503, XrefRangeEnd = 178506, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	private static readonly IntPtr NativeFieldInfoPtr_currentUseCount;

	private static readonly IntPtr NativeFieldInfoPtr_bufferTime;

	private static readonly IntPtr NativeFieldInfoPtr_bufferTimer;

	private static readonly IntPtr NativeFieldInfoPtr_bufferAbilityId;
	...
	private static readonly IntPtr NativeMethodInfoPtr_SpawnDmgObject_Public_Void_Int32_0;
	...
	public unsafe int currentUseCount
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_currentUseCount);
			return *(int*)num;
		}
		set
		{
			*(int*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_currentUseCount)) = num;
		}
	}

	public unsafe float bufferTime
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_bufferTime);
			return *(float*)num;
		}
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_bufferTime)) = num;
		}
	}

	public unsafe float bufferTimer
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_bufferTimer);
			return *(float*)num;
		}
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_bufferTimer)) = num;
		}
	}

	public unsafe int bufferAbilityId
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_bufferAbilityId);
			return *(int*)num;
		}
		set
		{
			*(int*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_bufferAbilityId)) = num;
		}
	}
	...
	static P_OnUse_PoisonWave()
	{
		Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_OnUse_PoisonWave");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr, "config");
		NativeFieldInfoPtr_currentUseCount = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr, "currentUseCount");
		NativeFieldInfoPtr_bufferTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr, "bufferTime");
		NativeFieldInfoPtr_bufferTimer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr, "bufferTimer");
		NativeFieldInfoPtr_bufferAbilityId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr, "bufferAbilityId");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr, 100677811);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr, 100677812);
		NativeMethodInfoPtr_SpawnDmgObject_Public_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr, 100677813);
		NativeMethodInfoPtr_OnHitboxSpawned_Public_Virtual_Void_GameObject_EntityManager_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr, 100677814);
		NativeMethodInfoPtr_ActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr, 100677815);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 178529, RefRangeEnd = 178530, XrefRangeStart = 178506, XrefRangeEnd = 178529, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_OnUse_PoisonWave(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_OnUse_PoisonWave>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[2];
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 178555, RefRangeEnd = 178556, XrefRangeStart = 178530, XrefRangeEnd = 178555, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void SpawnDmgObject(int predTickNum)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[1];
		*ptr = (nint)(&predTickNum);
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_SpawnDmgObject_Public_Void_Int32_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 178556, XrefRangeEnd = 178559, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 178559, XrefRangeEnd = 178561, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_OnUse_PoisonWave(IntPtr pointer)
		: base(pointer)
	{
	}
}
