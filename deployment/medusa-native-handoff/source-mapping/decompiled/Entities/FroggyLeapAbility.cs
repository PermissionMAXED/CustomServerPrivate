...
public class FroggyLeapAbility : Ability
{
	public class CustomJumpSubroutine : NetworkedSimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_FroggyLeapAbility_Byte_Single_0;
		...
		public unsafe FroggyLeapAbility ability
		{
			get
			{
				...
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<FroggyLeapAbility>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_ability)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)froggyLeapAbility));
			}
		}
		...
		{
			Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "CustomJumpSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_FroggyLeapAbility_Byte_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100673491);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100673492);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100673493);
			NativeMethodInfoPtr_OnExit_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100673494);
			NativeMethodInfoPtr_OnNetDeserialize_Public_Virtual_Void_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100673495);
			NativeMethodInfoPtr_OnNetSerialize_Public_Virtual_Void_NetworkWriter_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100673496);
			NativeMethodInfoPtr_OnNetDebugCompare_Public_Virtual_Boolean_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100673497);
			NativeMethodInfoPtr_OnNetDebugLog_Public_Virtual_Void_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100673498);
		}
		...
		public unsafe CustomJumpSubroutine(FroggyLeapAbility _ability, byte _trigger, float _waitTime)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr))
		{
			...
			*(float**)((byte*)ptr + checked((nuint)2u * unchecked((nuint)sizeof(IntPtr)))) = &_waitTime;
			...
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_FroggyLeapAbility_Byte_Single_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130716, XrefRangeEnd = 130737, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130737, XrefRangeEnd = 130745, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130745, XrefRangeEnd = 130752, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130752, XrefRangeEnd = 130768, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomCooldownHitSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_FroggyLeapAbility_0;
		...
		static CustomCooldownHitSubroutine()
		{
			Il2CppClassPointerStore<CustomCooldownHitSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "CustomCooldownHitSubroutine");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CustomCooldownHitSubroutine>.NativeClassPtr);
			NativeFieldInfoPtr_ability = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomCooldownHitSubroutine>.NativeClassPtr, "ability");
			NativeMethodInfoPtr__ctor_Public_Void_FroggyLeapAbility_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomCooldownHitSubroutine>.NativeClassPtr, 100673499);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomCooldownHitSubroutine>.NativeClassPtr, 100673500);
		}
		...
		public unsafe CustomCooldownHitSubroutine(FroggyLeapAbility _ability)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomCooldownHitSubroutine>.NativeClassPtr))
		{
			IntPtr* ptr = stackalloc IntPtr[1];
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_ability);
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_FroggyLeapAbility_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130768, XrefRangeEnd = 130769, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override byte OnTick(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
		...
		public CustomCooldownHitSubroutine(IntPtr pointer)
			: base(pointer)
		{
		}
	}
	...
	private static readonly IntPtr NativeFieldInfoPtr_cdHitReductionTime;
	...
	public unsafe float cdHitReductionTime
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_cdHitReductionTime);
			return *(float*)num;
		}
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_cdHitReductionTime)) = num;
		}
	}
	...
	static FroggyLeapAbility()
	{
		Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "FroggyLeapAbility");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr);
		NativeFieldInfoPtr_spellPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "spellPrefab");
		NativeFieldInfoPtr_firingPoint = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "firingPoint");
		NativeFieldInfoPtr_castMotionLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "castMotionLockType");
		NativeFieldInfoPtr_jumpRotationLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "jumpRotationLockType");
		NativeFieldInfoPtr_applyAtkSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "applyAtkSpeedMultiplier");
		NativeFieldInfoPtr_applyCooldownMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "applyCooldownMultiplier");
		NativeFieldInfoPtr_inputType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "inputType");
		NativeFieldInfoPtr_damage = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "damage");
		NativeFieldInfoPtr_damageScaling = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "damageScaling");
		NativeFieldInfoPtr_ttl = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "ttl");
		NativeFieldInfoPtr_statusEffects = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "statusEffects");
		NativeFieldInfoPtr_hitboxRadius = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "hitboxRadius");
		NativeFieldInfoPtr_cdHitReductionTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "cdHitReductionTime");
		NativeFieldInfoPtr_castingTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "castingTime");
		NativeFieldInfoPtr_jumpTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "jumpTime");
		NativeFieldInfoPtr_recoveryTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "recoveryTime");
		NativeFieldInfoPtr_baseCooldownTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "baseCooldownTime");
		NativeFieldInfoPtr_indicatorPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "indicatorPrefab");
		NativeFieldInfoPtr_indicatorMouseHalfScale = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "indicatorMouseHalfScale");
		NativeFieldInfoPtr_indicatorBaseHalfScale = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "indicatorBaseHalfScale");
		NativeFieldInfoPtr_indicatorOffset = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "indicatorOffset");
		NativeFieldInfoPtr_indicatorMaxDistance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "indicatorMaxDistance");
		NativeFieldInfoPtr_indicatorRotateWithDirection = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "indicatorRotateWithDirection");
		NativeFieldInfoPtr_hitboxConeAngleHalf = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "hitboxConeAngleHalf");
		NativeFieldInfoPtr_jumpLerpCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "jumpLerpCurve");
		NativeFieldInfoPtr_baseShadowAlphaCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "baseShadowAlphaCurve");
		NativeFieldInfoPtr_zoomOutMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "zoomOutMultiplier");
		NativeFieldInfoPtr_jumpRadiusCheck = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "jumpRadiusCheck");
		NativeFieldInfoPtr_maxJumpDistance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "maxJumpDistance");
		NativeFieldInfoPtr_camShakeTrauma = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "camShakeTrauma");
		NativeFieldInfoPtr_vfxCastPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "vfxCastPrefab");
		NativeFieldInfoPtr_vfxLoopPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "vfxLoopPrefab");
		NativeFieldInfoPtr_sfxCast = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "sfxCast");
		NativeFieldInfoPtr_animLayer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "animLayer");
		NativeFieldInfoPtr_hitSuccess = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, "hitSuccess");
		NativeMethodInfoPtr_PreAwake_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, 100673484);
		NativeMethodInfoPtr_Shoot_Private_Void_Vector3_Vector3_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, 100673485);
		NativeMethodInfoPtr_OnTargetHit_Public_Virtual_Void_EntityManager_HitboxBase_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, 100673486);
		NativeMethodInfoPtr_GetTooltipDescription_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, 100673487);
		NativeMethodInfoPtr_GetTooltipExpandedDescription_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, 100673488);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, 100673489);
		NativeMethodInfoPtr_Weaved_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr, 100673490);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130769, XrefRangeEnd = 130981, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 131012, RefRangeEnd = 131013, XrefRangeStart = 130981, XrefRangeEnd = 131012, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void Shoot(Vector3 landingPosition, Vector3 lookDir, int predTickNum)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[3];
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 131013, XrefRangeEnd = 131020, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 131020, XrefRangeEnd = 131034, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 131034, XrefRangeEnd = 131042, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 131042, XrefRangeEnd = 131047, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe FroggyLeapAbility()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<FroggyLeapAbility>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public FroggyLeapAbility(IntPtr pointer)
		: base(pointer)
	{
	}
}
