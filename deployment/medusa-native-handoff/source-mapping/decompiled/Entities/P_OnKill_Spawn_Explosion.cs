...
public class P_OnKill_Spawn_Explosion : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		private static readonly IntPtr NativeFieldInfoPtr_percentHpDmg;
		...
		private static readonly IntPtr NativeFieldInfoPtr_onlyPlayers;
		...
		public unsafe float percentHpDmg
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_percentHpDmg);
				return *(float*)num;
			}
			set
			{
				*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_percentHpDmg)) = num;
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OnKill_Spawn_Explosion>.NativeClassPtr, "Config");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Config>.NativeClassPtr);
			NativeFieldInfoPtr_damage = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "damage");
			NativeFieldInfoPtr_percentHpDmg = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "percentHpDmg");
			...
			NativeFieldInfoPtr_hitboxActivateTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "hitboxActivateTime");
			...
			NativeFieldInfoPtr_onlyPlayers = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "onlyPlayers");
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677628);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177863, XrefRangeEnd = 177864, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	private static readonly IntPtr NativeFieldInfoPtr_dmgHitboxObj;
	...
	public unsafe GameObject dmgHitboxObj
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_dmgHitboxObj);
			IntPtr intPtr = *(IntPtr*)num;
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<GameObject>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_dmgHitboxObj)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)gameObject));
		}
	}
	...
	static P_OnKill_Spawn_Explosion()
	{
		Il2CppClassPointerStore<P_OnKill_Spawn_Explosion>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_OnKill_Spawn_Explosion");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_OnKill_Spawn_Explosion>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnKill_Spawn_Explosion>.NativeClassPtr, "config");
		NativeFieldInfoPtr_dmgHitboxObj = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnKill_Spawn_Explosion>.NativeClassPtr, "dmgHitboxObj");
		NativeFieldInfoPtr_vfxReadyId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnKill_Spawn_Explosion>.NativeClassPtr, "vfxReadyId");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_Spawn_Explosion>.NativeClassPtr, 100677620);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_Spawn_Explosion>.NativeClassPtr, 100677621);
		NativeMethodInfoPtr_SpawnDmgObject_Public_Void_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_Spawn_Explosion>.NativeClassPtr, 100677622);
		NativeMethodInfoPtr_OnKillTrigger_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_Spawn_Explosion>.NativeClassPtr, 100677623);
		NativeMethodInfoPtr_OnAssistTrigger_Public_Virtual_Void_EntityManager_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_Spawn_Explosion>.NativeClassPtr, 100677624);
		NativeMethodInfoPtr_DeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_Spawn_Explosion>.NativeClassPtr, 100677625);
		NativeMethodInfoPtr_ClActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_Spawn_Explosion>.NativeClassPtr, 100677626);
		NativeMethodInfoPtr_ClDeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_Spawn_Explosion>.NativeClassPtr, 100677627);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177864, XrefRangeEnd = 177868, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_OnKill_Spawn_Explosion(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_OnKill_Spawn_Explosion>.NativeClassPtr))
	{
	...
	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 177890, RefRangeEnd = 177892, XrefRangeStart = 177868, XrefRangeEnd = 177890, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177892, XrefRangeEnd = 177896, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177896, XrefRangeEnd = 177900, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177900, XrefRangeEnd = 177904, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_OnKill_Spawn_Explosion(IntPtr pointer)
		: base(pointer)
	{
	}
}
