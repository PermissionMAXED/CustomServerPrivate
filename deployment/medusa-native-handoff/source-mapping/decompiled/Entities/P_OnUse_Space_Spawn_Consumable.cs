...
public class P_OnUse_Space_Spawn_Consumable : Passive
{
	...
	{
		private static readonly IntPtr NativeFieldInfoPtr_consumableToDrop;

		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_0;

		public unsafe Consumable consumableToDrop
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_consumableToDrop);
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<Consumable>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_consumableToDrop)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)consumable));
			}
		}

		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OnUse_Space_Spawn_Consumable>.NativeClassPtr, "Config");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Config>.NativeClassPtr);
			NativeFieldInfoPtr_consumableToDrop = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "consumableToDrop");
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677874);
		}
	...
	static P_OnUse_Space_Spawn_Consumable()
	{
		Il2CppClassPointerStore<P_OnUse_Space_Spawn_Consumable>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_OnUse_Space_Spawn_Consumable");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_OnUse_Space_Spawn_Consumable>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnUse_Space_Spawn_Consumable>.NativeClassPtr, "config");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_Space_Spawn_Consumable>.NativeClassPtr, 100677868);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_Space_Spawn_Consumable>.NativeClassPtr, 100677869);
		NativeMethodInfoPtr_OnHitboxSpawned_Public_Virtual_Void_GameObject_EntityManager_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_Space_Spawn_Consumable>.NativeClassPtr, 100677870);
		NativeMethodInfoPtr_DeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_Space_Spawn_Consumable>.NativeClassPtr, 100677871);
		NativeMethodInfoPtr_ClActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_Space_Spawn_Consumable>.NativeClassPtr, 100677872);
		NativeMethodInfoPtr_ClDeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_Space_Spawn_Consumable>.NativeClassPtr, 100677873);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 178724, XrefRangeEnd = 178725, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_OnUse_Space_Spawn_Consumable(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_OnUse_Space_Spawn_Consumable>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 178725, XrefRangeEnd = 178726, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_OnUse_Space_Spawn_Consumable(IntPtr pointer)
		: base(pointer)
	{
	}
}
