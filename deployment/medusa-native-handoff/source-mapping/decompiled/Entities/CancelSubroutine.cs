...
public class CancelSubroutine : NetworkedSimulationSubroutine
{
	...
	private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_Ability_Byte_Single_0;
	...
	private static readonly IntPtr NativeMethodInfoPtr_ReupdateCooldown_Private_Void_0;
	...
	static CancelSubroutine()
	{
		Il2CppClassPointerStore<CancelSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "CancelSubroutine");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CancelSubroutine>.NativeClassPtr);
		NativeFieldInfoPtr_ability = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CancelSubroutine>.NativeClassPtr, "ability");
		NativeFieldInfoPtr_trigger = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CancelSubroutine>.NativeClassPtr, "trigger");
		NativeFieldInfoPtr_duration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CancelSubroutine>.NativeClassPtr, "duration");
		NativeFieldInfoPtr_timeElapsed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CancelSubroutine>.NativeClassPtr, "timeElapsed");
		NativeMethodInfoPtr__ctor_Public_Void_Ability_Byte_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CancelSubroutine>.NativeClassPtr, 100674952);
		NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CancelSubroutine>.NativeClassPtr, 100674953);
		NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CancelSubroutine>.NativeClassPtr, 100674954);
		NativeMethodInfoPtr_ReupdateCooldown_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CancelSubroutine>.NativeClassPtr, 100674955);
		NativeMethodInfoPtr_OnNetDeserialize_Public_Virtual_Void_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CancelSubroutine>.NativeClassPtr, 100674956);
		NativeMethodInfoPtr_OnNetSerialize_Public_Virtual_Void_NetworkWriter_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CancelSubroutine>.NativeClassPtr, 100674957);
		NativeMethodInfoPtr_OnNetDebugCompare_Public_Virtual_Boolean_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CancelSubroutine>.NativeClassPtr, 100674958);
		NativeMethodInfoPtr_OnNetDebugLog_Public_Virtual_Void_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CancelSubroutine>.NativeClassPtr, 100674959);
	}
	...
	public unsafe CancelSubroutine(Ability ability, byte trigger, float duration)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CancelSubroutine>.NativeClassPtr))
	{
		...
		*(float**)((byte*)ptr + checked((nuint)2u * unchecked((nuint)sizeof(IntPtr)))) = &duration;
		...
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_Ability_Byte_Single_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 155389, XrefRangeEnd = 155390, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 155390, XrefRangeEnd = 155396, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 155396, XrefRangeEnd = 155402, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void ReupdateCooldown()
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_ReupdateCooldown_Private_Void_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 155402, XrefRangeEnd = 155409, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 155409, XrefRangeEnd = 155416, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public CancelSubroutine(IntPtr pointer)
		: base(pointer)
	{
	}
}
