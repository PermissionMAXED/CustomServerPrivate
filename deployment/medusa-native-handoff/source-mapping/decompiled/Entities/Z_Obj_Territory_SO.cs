...
public class Z_Obj_Territory_SO : Z_Obj_SO
{
	...
	public unsafe Z_Obj_Territory.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<Z_Obj_Territory.Config>(intPtr) : null;
		}
		set
		{
	...
	static Z_Obj_Territory_SO()
	{
		Il2CppClassPointerStore<Z_Obj_Territory_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "Z_Obj_Territory_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Z_Obj_Territory_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Z_Obj_Territory_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_Z_ObjConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Z_Obj_Territory_SO>.NativeClassPtr, 100682187);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_Z_Obj_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Z_Obj_Territory_SO>.NativeClassPtr, 100682188);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Z_Obj_Territory_SO>.NativeClassPtr, 100682189);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 210063, XrefRangeEnd = 210084, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe Z_Obj_Territory_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Z_Obj_Territory_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public Z_Obj_Territory_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
