...
{
	private static readonly IntPtr NativeFieldInfoPtr_beeSwarmPrefab;
	...
	private static readonly IntPtr NativeFieldInfoPtr_goToPositionIfNoTarget;
	...
	public unsafe GameObject beeSwarmPrefab
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_beeSwarmPrefab);
		...
		set
		{
			...
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_beeSwarmPrefab)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)gameObject));
		}
	}
	...
	static EntityActivateProjectileAimHitboxDps()
	{
		Il2CppClassPointerStore<EntityActivateProjectileAimHitboxDps>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "EntityActivateProjectileAimHitboxDps");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<EntityActivateProjectileAimHitboxDps>.NativeClassPtr);
		NativeFieldInfoPtr_beeSwarmPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EntityActivateProjectileAimHitboxDps>.NativeClassPtr, "beeSwarmPrefab");
		NativeFieldInfoPtr_damage = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EntityActivateProjectileAimHitboxDps>.NativeClassPtr, "damage");
		NativeFieldInfoPtr_tickRate = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EntityActivateProjectileAimHitboxDps>.NativeClassPtr, "tickRate");
		NativeFieldInfoPtr_ttl = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EntityActivateProjectileAimHitboxDps>.NativeClassPtr, "ttl");
		NativeFieldInfoPtr_speed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EntityActivateProjectileAimHitboxDps>.NativeClassPtr, "speed");
		NativeFieldInfoPtr_searchRadius = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EntityActivateProjectileAimHitboxDps>.NativeClassPtr, "searchRadius");
		NativeFieldInfoPtr_statusEffects = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EntityActivateProjectileAimHitboxDps>.NativeClassPtr, "statusEffects");
		NativeFieldInfoPtr_counterable = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EntityActivateProjectileAimHitboxDps>.NativeClassPtr, "counterable");
		NativeFieldInfoPtr_goToPositionIfNoTarget = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EntityActivateProjectileAimHitboxDps>.NativeClassPtr, "goToPositionIfNoTarget");
		NativeMethodInfoPtr_Activate_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EntityActivateProjectileAimHitboxDps>.NativeClassPtr, 100681799);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EntityActivateProjectileAimHitboxDps>.NativeClassPtr, 100681800);
		NativeMethodInfoPtr_Weaved_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EntityActivateProjectileAimHitboxDps>.NativeClassPtr, 100681801);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 207050, XrefRangeEnd = 207077, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 207077, XrefRangeEnd = 207082, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe EntityActivateProjectileAimHitboxDps()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<EntityActivateProjectileAimHitboxDps>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public EntityActivateProjectileAimHitboxDps(IntPtr pointer)
		: base(pointer)
	{
	}
}
