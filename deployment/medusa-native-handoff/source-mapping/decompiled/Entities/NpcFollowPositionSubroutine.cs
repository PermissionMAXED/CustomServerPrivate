...
public class NpcFollowPositionSubroutine : SimulationSubroutine
{
	...
	static NpcFollowPositionSubroutine()
	{
		Il2CppClassPointerStore<NpcFollowPositionSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "NpcFollowPositionSubroutine");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<NpcFollowPositionSubroutine>.NativeClassPtr);
		NativeFieldInfoPtr_npcBehaviour = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcFollowPositionSubroutine>.NativeClassPtr, "npcBehaviour");
		NativeFieldInfoPtr_triggerFinished = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcFollowPositionSubroutine>.NativeClassPtr, "triggerFinished");
		NativeFieldInfoPtr_agent = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcFollowPositionSubroutine>.NativeClassPtr, "agent");
		NativeFieldInfoPtr_stopMovingAngleThreshold = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcFollowPositionSubroutine>.NativeClassPtr, "stopMovingAngleThreshold");
		NativeFieldInfoPtr_stopDistance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcFollowPositionSubroutine>.NativeClassPtr, "stopDistance");
		NativeMethodInfoPtr__ctor_Public_Void_NpcBehaviour_Byte_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcFollowPositionSubroutine>.NativeClassPtr, 100675735);
		NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcFollowPositionSubroutine>.NativeClassPtr, 100675736);
		NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcFollowPositionSubroutine>.NativeClassPtr, 100675737);
		NativeMethodInfoPtr_OnExit_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcFollowPositionSubroutine>.NativeClassPtr, 100675738);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 164943, RefRangeEnd = 164945, XrefRangeStart = 164941, XrefRangeEnd = 164943, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe NpcFollowPositionSubroutine(NpcBehaviour _npcBehaviour, byte _triggerFinished, float _stopDistance = 1f)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<NpcFollowPositionSubroutine>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 164945, XrefRangeEnd = 164948, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 164948, XrefRangeEnd = 164969, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public NpcFollowPositionSubroutine(IntPtr pointer)
		: base(pointer)
	{
	}
}
