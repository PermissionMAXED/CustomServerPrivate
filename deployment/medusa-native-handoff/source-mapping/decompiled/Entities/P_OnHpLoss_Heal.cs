...
public class P_OnHpLoss_Heal : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OnHpLoss_Heal>.NativeClassPtr, "Config");
			...
			NativeFieldInfoPtr_percentHealDamageTaken = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "percentHealDamageTaken");
			NativeFieldInfoPtr_healMaxAmountPercent = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "healMaxAmountPercent");
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677572);
		}
	...
	private static readonly IntPtr NativeFieldInfoPtr_vfxShieldBrokenId;
	...
	private static readonly IntPtr NativeMethodInfoPtr_OnImmuneDamageTrigger_Public_Virtual_Void_Int32_0;
	...
	public unsafe int vfxShieldBrokenId
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_vfxShieldBrokenId);
			return *(int*)num;
		}
		set
		{
			*(int*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_vfxShieldBrokenId)) = num;
		}
	}
	...
	static P_OnHpLoss_Heal()
	{
		Il2CppClassPointerStore<P_OnHpLoss_Heal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_OnHpLoss_Heal");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_OnHpLoss_Heal>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnHpLoss_Heal>.NativeClassPtr, "config");
		NativeFieldInfoPtr_vfxShieldBrokenId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnHpLoss_Heal>.NativeClassPtr, "vfxShieldBrokenId");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnHpLoss_Heal>.NativeClassPtr, 100677567);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnHpLoss_Heal>.NativeClassPtr, 100677568);
		NativeMethodInfoPtr_OnImmuneDamageTrigger_Public_Virtual_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnHpLoss_Heal>.NativeClassPtr, 100677569);
		NativeMethodInfoPtr_ActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnHpLoss_Heal>.NativeClassPtr, 100677570);
		NativeMethodInfoPtr_DeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnHpLoss_Heal>.NativeClassPtr, 100677571);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177727, XrefRangeEnd = 177731, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_OnHpLoss_Heal(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_OnHpLoss_Heal>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177731, XrefRangeEnd = 177736, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe override void OnImmuneDamageTrigger(int damage)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[1];
		*ptr = (nint)(&damage);
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(IL2CPP.il2cpp_object_get_virtual_method(IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)this), NativeMethodInfoPtr_OnImmuneDamageTrigger_Public_Virtual_Void_Int32_0), IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177736, XrefRangeEnd = 177743, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177743, XrefRangeEnd = 177749, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_OnHpLoss_Heal(IntPtr pointer)
		: base(pointer)
	{
	}
}
