...
public class P_BloodDive_SO : PassiveSO
{
	...
	public unsafe P_BloodDive.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<P_BloodDive.Config>(intPtr) : null;
		}
		set
		{
	...
	static P_BloodDive_SO()
	{
		Il2CppClassPointerStore<P_BloodDive_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_BloodDive_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_BloodDive_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_BloodDive_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_BloodDive_SO>.NativeClassPtr, 100676865);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_Passive_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_BloodDive_SO>.NativeClassPtr, 100676866);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_BloodDive_SO>.NativeClassPtr, 100676867);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 174998, XrefRangeEnd = 175001, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe P_BloodDive_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_BloodDive_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public P_BloodDive_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
