...
public class P_Empty_SO : PassiveSO
{
	...
	public unsafe Passive.PassiveConfiguration configuration
	{
		get
		{
		...
		set
		{
			...
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_configuration)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)passiveConfiguration));
		}
	}
	...
	static P_Empty_SO()
	{
		Il2CppClassPointerStore<P_Empty_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_Empty_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_Empty_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Empty_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Empty_SO>.NativeClassPtr, 100677170);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_Passive_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Empty_SO>.NativeClassPtr, 100677171);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Empty_SO>.NativeClassPtr, 100677172);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 176241, XrefRangeEnd = 176244, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe P_Empty_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_Empty_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public P_Empty_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
