...
public class AB_ShieldZone : AB_Use_Base
{
	[Serializable]
	public new class Config : AB_Use_Base.Config
	{
		...
		private static readonly IntPtr NativeFieldInfoPtr_hitboxDirectional;

		private static readonly IntPtr NativeFieldInfoPtr_destroyOnCharHit;

		private static readonly IntPtr NativeFieldInfoPtr_onlyAllies;

		private static readonly IntPtr NativeFieldInfoPtr_damageAllowedToOwnerPlayer;
		...
		public unsafe bool hitboxDirectional
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_hitboxDirectional);
				return *(bool*)num;
			}
			set
			{
				*(bool*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_hitboxDirectional)) = flag;
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_ShieldZone>.NativeClassPtr, "Config");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Config>.NativeClassPtr);
			NativeFieldInfoPtr_hitboxPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "hitboxPrefab");
			...
			NativeFieldInfoPtr_hitboxDirectional = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "hitboxDirectional");
			NativeFieldInfoPtr_destroyOnCharHit = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "destroyOnCharHit");
			NativeFieldInfoPtr_onlyAllies = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "onlyAllies");
			NativeFieldInfoPtr_damageAllowedToOwnerPlayer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "damageAllowedToOwnerPlayer");
			NativeFieldInfoPtr_destroyOnStaticCollision = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "destroyOnStaticCollision");
			NativeFieldInfoPtr_counterable = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "counterable");
			NativeFieldInfoPtr_stayOnOwnerDestroyed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "stayOnOwnerDestroyed");
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100675398);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 161704, XrefRangeEnd = 161705, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static AB_ShieldZone()
	{
		Il2CppClassPointerStore<AB_ShieldZone>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "AB_ShieldZone");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_ShieldZone>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_ShieldZone>.NativeClassPtr, "config");
		NativeMethodInfoPtr__ctor_Public_Void_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_ShieldZone>.NativeClassPtr, 100675396);
		NativeMethodInfoPtr_DoUse_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_ShieldZone>.NativeClassPtr, 100675397);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe AB_ShieldZone(Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_ShieldZone>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 161705, XrefRangeEnd = 161734, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public AB_ShieldZone(IntPtr pointer)
		: base(pointer)
	{
	}
}
