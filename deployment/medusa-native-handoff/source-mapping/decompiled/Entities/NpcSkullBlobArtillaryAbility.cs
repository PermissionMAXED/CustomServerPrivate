...
public class NpcSkullBlobArtillaryAbility : Ability
{
	public class CustomCastVfxSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_NpcSkullBlobArtillaryAbility_Int32_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0;

		public unsafe NpcSkullBlobArtillaryAbility ability
		{
			get
			{
				...
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<NpcSkullBlobArtillaryAbility>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_ability)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)npcSkullBlobArtillaryAbility));
			}
		}
		...
		{
			Il2CppClassPointerStore<CustomCastVfxSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "CustomCastVfxSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_NpcSkullBlobArtillaryAbility_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomCastVfxSubroutine>.NativeClassPtr, 100674164);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomCastVfxSubroutine>.NativeClassPtr, 100674165);
		}
		...
		public unsafe CustomCastVfxSubroutine(NpcSkullBlobArtillaryAbility _ability, int _attackId)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomCastVfxSubroutine>.NativeClassPtr))
		{
			...
			*(int**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_attackId;
			...
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_NpcSkullBlobArtillaryAbility_Int32_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 142787, XrefRangeEnd = 142797, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomShootSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_NpcSkullBlobArtillaryAbility_Byte_Byte_0;
		...
		{
			Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "CustomShootSubroutine");
			...
			NativeFieldInfoPtr_silencedTrigger = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr, "silencedTrigger");
			NativeMethodInfoPtr__ctor_Public_Void_NpcSkullBlobArtillaryAbility_Byte_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr, 100674166);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr, 100674167);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr, 100674168);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 142797, XrefRangeEnd = 142798, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomShootSubroutine(NpcSkullBlobArtillaryAbility _ability, byte _trigger, byte _silenced)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr))
		{
			...
			*(byte**)((byte*)ptr + checked((nuint)2u * unchecked((nuint)sizeof(IntPtr)))) = &_silenced;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_NpcSkullBlobArtillaryAbility_Byte_Byte_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 142798, XrefRangeEnd = 142800, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
	...
	private static readonly IntPtr NativeFieldInfoPtr_hitboxImpactTime;
	...
	private static readonly IntPtr NativeMethodInfoPtr_CastSpell_Private_Void_Int32_0;
	...
	public unsafe float hitboxImpactTime
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_hitboxImpactTime);
			return *(float*)num;
		}
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_hitboxImpactTime)) = num;
		}
	}
	...
	{
		Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "NpcSkullBlobArtillaryAbility");
		NativeFieldInfoPtr_spellPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "spellPrefab");
		NativeFieldInfoPtr_castMotionLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "castMotionLockType");
		NativeFieldInfoPtr_castRotationLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "castRotationLockType");
		NativeFieldInfoPtr_applyAtkSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "applyAtkSpeedMultiplier");
		NativeFieldInfoPtr_applyCooldownMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "applyCooldownMultiplier");
		NativeFieldInfoPtr_damage = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "damage");
		NativeFieldInfoPtr_damageScaling = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "damageScaling");
		NativeFieldInfoPtr_ttl = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "ttl");
		NativeFieldInfoPtr_hitboxRadius = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "hitboxRadius");
		NativeFieldInfoPtr_numProjectiles = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "numProjectiles");
		NativeFieldInfoPtr_statusEffects = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "statusEffects");
		NativeFieldInfoPtr_randomOffset = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "randomOffset");
		NativeFieldInfoPtr_castingTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "castingTime");
		NativeFieldInfoPtr_hitboxImpactTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "hitboxImpactTime");
		NativeFieldInfoPtr_shootDurationTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "shootDurationTime");
		NativeFieldInfoPtr_recoveryTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "recoveryTime");
		NativeFieldInfoPtr_baseCooldownTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "baseCooldownTime");
		NativeFieldInfoPtr_castSfxDelay = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "castSfxDelay");
		NativeFieldInfoPtr_sfxCast = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "sfxCast");
		NativeFieldInfoPtr_castVfx = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "castVfx");
		NativeFieldInfoPtr_shootVfx = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "shootVfx");
		NativeFieldInfoPtr_animLayer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "animLayer");
		NativeFieldInfoPtr_npcBehaviour = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "npcBehaviour");
		NativeFieldInfoPtr_currentVisibleIndicator = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, "currentVisibleIndicator");
		NativeMethodInfoPtr_PreAwake_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, 100674152);
		NativeMethodInfoPtr_CastSpell_Private_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, 100674153);
		NativeMethodInfoPtr_RpcDestroyVisibleIndicator_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, 100674154);
		NativeMethodInfoPtr_RpcPlayCastVFX_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, 100674155);
		NativeMethodInfoPtr_RpcPlayShootVFX_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, 100674156);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, 100674157);
		NativeMethodInfoPtr_Weaved_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, 100674158);
		NativeMethodInfoPtr_UserCode_RpcDestroyVisibleIndicator_Protected_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, 100674159);
		NativeMethodInfoPtr_InvokeUserCode_RpcDestroyVisibleIndicator_Protected_Static_Void_NetworkBehaviour_NetworkReader_NetworkConnectionToClient_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, 100674160);
		NativeMethodInfoPtr_UserCode_RpcPlayCastVFX_Protected_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, 100674161);
		NativeMethodInfoPtr_InvokeUserCode_RpcPlayCastVFX_Protected_Static_Void_NetworkBehaviour_NetworkReader_NetworkConnectionToClient_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr, 100674162);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 142800, XrefRangeEnd = 142943, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 142968, RefRangeEnd = 142969, XrefRangeStart = 142943, XrefRangeEnd = 142968, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void CastSpell(int predTickNum)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[1];
		*ptr = (nint)(&predTickNum);
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_CastSpell_Private_Void_Int32_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 142969, XrefRangeEnd = 142978, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 142978, XrefRangeEnd = 142987, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 142991, RefRangeEnd = 142992, XrefRangeStart = 142987, XrefRangeEnd = 142991, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 142992, XrefRangeEnd = 142997, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe NpcSkullBlobArtillaryAbility()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<NpcSkullBlobArtillaryAbility>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 142997, XrefRangeEnd = 143002, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 143002, XrefRangeEnd = 143013, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 143013, XrefRangeEnd = 143017, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 143017, XrefRangeEnd = 143027, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public NpcSkullBlobArtillaryAbility(IntPtr pointer)
		: base(pointer)
	{
	}
}
