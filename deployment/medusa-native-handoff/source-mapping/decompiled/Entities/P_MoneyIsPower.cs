...
public class P_MoneyIsPower : Passive
{
	...
	{
		private static readonly IntPtr NativeFieldInfoPtr_damagePerGold;
		...
		public unsafe float damagePerGold
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_damagePerGold);
				return *(float*)num;
			}
			set
			{
				*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_damagePerGold)) = num;
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_MoneyIsPower>.NativeClassPtr, "Config");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Config>.NativeClassPtr);
			NativeFieldInfoPtr_damagePerGold = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "damagePerGold");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677267);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 176482, XrefRangeEnd = 176483, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static P_MoneyIsPower()
	{
		Il2CppClassPointerStore<P_MoneyIsPower>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_MoneyIsPower");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_MoneyIsPower>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_MoneyIsPower>.NativeClassPtr, "config");
		NativeFieldInfoPtr_prevGold = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_MoneyIsPower>.NativeClassPtr, "prevGold");
		NativeFieldInfoPtr_vfxLoopId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_MoneyIsPower>.NativeClassPtr, "vfxLoopId");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_MoneyIsPower>.NativeClassPtr, 100677260);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_MoneyIsPower>.NativeClassPtr, 100677261);
		NativeMethodInfoPtr_OnItemsChanged_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_MoneyIsPower>.NativeClassPtr, 100677262);
		NativeMethodInfoPtr_ActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_MoneyIsPower>.NativeClassPtr, 100677263);
		NativeMethodInfoPtr_DeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_MoneyIsPower>.NativeClassPtr, 100677264);
		NativeMethodInfoPtr_ClActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_MoneyIsPower>.NativeClassPtr, 100677265);
		NativeMethodInfoPtr_ClDeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_MoneyIsPower>.NativeClassPtr, 100677266);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 176483, XrefRangeEnd = 176487, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_MoneyIsPower(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_MoneyIsPower>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 176487, XrefRangeEnd = 176494, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 176494, XrefRangeEnd = 176495, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 176495, XrefRangeEnd = 176497, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_MoneyIsPower(IntPtr pointer)
		: base(pointer)
	{
	}
}
