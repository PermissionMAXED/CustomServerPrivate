...
public class P_OnDamage_Skull : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OnDamage_Skull>.NativeClassPtr, "Config");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677456);
		}
	...
	public class CustomPassiveSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_P_OnDamage_Skull_Byte_0;
		...
		public unsafe P_OnDamage_Skull passive
		{
			get
			{
				...
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<P_OnDamage_Skull>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_passive)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)p_OnDamage_Skull));
			}
		}
		...
		{
			Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OnDamage_Skull>.NativeClassPtr, "CustomPassiveSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_P_OnDamage_Skull_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677457);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677458);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677459);
		}
		...
		public unsafe CustomPassiveSubroutine(P_OnDamage_Skull _ability, byte _triggerFinished)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr))
		{
			...
			*(byte**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_triggerFinished;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_P_OnDamage_Skull_Byte_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}
	...
	static P_OnDamage_Skull()
	{
		Il2CppClassPointerStore<P_OnDamage_Skull>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_OnDamage_Skull");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_OnDamage_Skull>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnDamage_Skull>.NativeClassPtr, "config");
		NativeFieldInfoPtr_passiveReady = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnDamage_Skull>.NativeClassPtr, "passiveReady");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnDamage_Skull>.NativeClassPtr, 100677453);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnDamage_Skull>.NativeClassPtr, 100677454);
		NativeMethodInfoPtr_OnDealtDamageTrigger_Public_Virtual_Void_EntityManager_Int32_Boolean_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnDamage_Skull>.NativeClassPtr, 100677455);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 177271, RefRangeEnd = 177272, XrefRangeStart = 177244, XrefRangeEnd = 177271, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_OnDamage_Skull(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_OnDamage_Skull>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[2];
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177272, XrefRangeEnd = 177292, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_OnDamage_Skull(IntPtr pointer)
		: base(pointer)
	{
	}
}
