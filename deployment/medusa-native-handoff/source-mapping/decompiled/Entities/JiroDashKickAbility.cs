...
public class JiroDashKickAbility : Ability
{
	public class CustomTeleportLerpSubroutine : NetworkedSimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_JiroDashKickAbility_Byte_Single_0;
		...
		public unsafe JiroDashKickAbility ability
		{
			get
			{
				...
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<JiroDashKickAbility>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_ability)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)jiroDashKickAbility));
			}
		}
		...
		{
			Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "CustomTeleportLerpSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_JiroDashKickAbility_Byte_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673574);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673575);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673576);
			NativeMethodInfoPtr_OnExit_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673577);
			NativeMethodInfoPtr_OnNetDeserialize_Public_Virtual_Void_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673578);
			NativeMethodInfoPtr_OnNetSerialize_Public_Virtual_Void_NetworkWriter_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673579);
			NativeMethodInfoPtr_OnNetDebugCompare_Public_Virtual_Boolean_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673580);
			NativeMethodInfoPtr_OnNetDebugLog_Public_Virtual_Void_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673581);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 132207, XrefRangeEnd = 132211, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomTeleportLerpSubroutine(JiroDashKickAbility _ability, byte _trigger, float _waitTime)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr))
		{
			...
			*(float**)((byte*)ptr + checked((nuint)2u * unchecked((nuint)sizeof(IntPtr)))) = &_waitTime;
			...
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_JiroDashKickAbility_Byte_Single_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 132211, XrefRangeEnd = 132238, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 132238, XrefRangeEnd = 132243, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 132243, XrefRangeEnd = 132244, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 132244, XrefRangeEnd = 132260, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomShootSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_JiroDashKickAbility_0;
		...
		{
			Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "CustomShootSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_JiroDashKickAbility_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr, 100673582);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr, 100673583);
		}
		...
		public unsafe CustomShootSubroutine(JiroDashKickAbility _ability)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr))
		{
			IntPtr* ptr = stackalloc IntPtr[1];
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_ability);
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_JiroDashKickAbility_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 132260, XrefRangeEnd = 132266, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
	...
	private static readonly IntPtr NativeFieldInfoPtr_recoveryMotionLockType;
	...
	private static readonly IntPtr NativeFieldInfoPtr_vfxDashCastPrefab;

	private static readonly IntPtr NativeFieldInfoPtr_vfxDashFollowPrefab;

	private static readonly IntPtr NativeFieldInfoPtr_sfxDashCast;
	...
	private static readonly IntPtr NativeMethodInfoPtr_ShootDash_Private_Void_Vector3_Vector3_Int32_0;
	...
	public unsafe MotionLockType recoveryMotionLockType
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_recoveryMotionLockType);
			return *(MotionLockType*)num;
		}
		set
		{
			*(MotionLockType*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_recoveryMotionLockType)) = motionLockType;
		}
	}
	...
	public unsafe GameObject vfxDashCastPrefab
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_vfxDashCastPrefab);
			IntPtr intPtr = *(IntPtr*)num;
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<GameObject>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_vfxDashCastPrefab)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)gameObject));
		}
	}

	public unsafe GameObject vfxDashFollowPrefab
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_vfxDashFollowPrefab);
			IntPtr intPtr = *(IntPtr*)num;
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<GameObject>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_vfxDashFollowPrefab)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)gameObject));
		}
	}

	public unsafe AudioClipData sfxDashCast
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_sfxDashCast);
			IntPtr intPtr = *(IntPtr*)num;
		...
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_sfxDashCast)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)audioClipData));
		}
	}
	...
	static JiroDashKickAbility()
	{
		Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "JiroDashKickAbility");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr);
		NativeFieldInfoPtr_dashPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "dashPrefab");
		NativeFieldInfoPtr_castMotionLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "castMotionLockType");
		NativeFieldInfoPtr_dashRotationLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "dashRotationLockType");
		NativeFieldInfoPtr_recoveryMotionLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "recoveryMotionLockType");
		NativeFieldInfoPtr_applyAtkSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "applyAtkSpeedMultiplier");
		NativeFieldInfoPtr_applyCooldownMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "applyCooldownMultiplier");
		NativeFieldInfoPtr_inputType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "inputType");
		NativeFieldInfoPtr_kickFiringPoint = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "kickFiringPoint");
		NativeFieldInfoPtr_indicatorPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "indicatorPrefab");
		NativeFieldInfoPtr_indicatorHalfScale = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "indicatorHalfScale");
		NativeFieldInfoPtr_indicatorOffset = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "indicatorOffset");
		NativeFieldInfoPtr_indicatorDoCollision = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "indicatorDoCollision");
		NativeFieldInfoPtr_indicatorClampToMouse = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "indicatorClampToMouse");
		NativeFieldInfoPtr_damage = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "damage");
		NativeFieldInfoPtr_damageScaling = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "damageScaling");
		NativeFieldInfoPtr_castingTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "castingTime");
		NativeFieldInfoPtr_teleportLerpTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "teleportLerpTime");
		NativeFieldInfoPtr_recoveryTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "recoveryTime");
		NativeFieldInfoPtr_baseCooldownTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "baseCooldownTime");
		NativeFieldInfoPtr_jumpLerpCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "jumpLerpCurve");
		NativeFieldInfoPtr_teleportMaxDistance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "teleportMaxDistance");
		NativeFieldInfoPtr_teleportRadiusCheck = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "teleportRadiusCheck");
		NativeFieldInfoPtr_camShakeTrauma = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "camShakeTrauma");
		NativeFieldInfoPtr_vfxDashCastPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "vfxDashCastPrefab");
		NativeFieldInfoPtr_vfxDashFollowPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "vfxDashFollowPrefab");
		NativeFieldInfoPtr_sfxDashCast = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "sfxDashCast");
		NativeFieldInfoPtr_animLayer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, "animLayer");
		NativeMethodInfoPtr_PreAwake_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, 100673568);
		NativeMethodInfoPtr_ShootDash_Private_Void_Vector3_Vector3_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, 100673569);
		NativeMethodInfoPtr_GetTooltipDescription_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, 100673570);
		NativeMethodInfoPtr_GetTooltipExpandedDescription_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, 100673571);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, 100673572);
		NativeMethodInfoPtr_Weaved_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr, 100673573);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 132266, XrefRangeEnd = 132420, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 132444, RefRangeEnd = 132445, XrefRangeStart = 132420, XrefRangeEnd = 132444, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void ShootDash(Vector3 lookDir, Vector3 targetPos, int predTickNum)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[3];
		*ptr = (nint)(&lookDir);
		...
		*(int**)((byte*)ptr + checked((nuint)2u * unchecked((nuint)sizeof(IntPtr)))) = &predTickNum;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_ShootDash_Private_Void_Vector3_Vector3_Int32_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 132445, XrefRangeEnd = 132452, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 132452, XrefRangeEnd = 132460, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe JiroDashKickAbility()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<JiroDashKickAbility>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public JiroDashKickAbility(IntPtr pointer)
		: base(pointer)
	{
	}
}
