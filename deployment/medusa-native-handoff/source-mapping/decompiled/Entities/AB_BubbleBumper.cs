...
public class AB_BubbleBumper : AbilityBehaviour
{
	...
	public class Config : AbilityBehaviourConfig
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_BubbleBumper>.NativeClassPtr, "Config");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100675318);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 160641, XrefRangeEnd = 160642, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomSpawnEntitySubroutine : NetworkedSimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_AB_BubbleBumper_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0;

		public unsafe AB_BubbleBumper behaviour
		{
			get
			{
				...
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<AB_BubbleBumper>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_behaviour)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)aB_BubbleBumper));
			}
		}
		...
		{
			Il2CppClassPointerStore<CustomSpawnEntitySubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_BubbleBumper>.NativeClassPtr, "CustomSpawnEntitySubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_AB_BubbleBumper_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomSpawnEntitySubroutine>.NativeClassPtr, 100675319);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomSpawnEntitySubroutine>.NativeClassPtr, 100675320);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 160642, XrefRangeEnd = 160646, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomSpawnEntitySubroutine(AB_BubbleBumper _behaviour)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomSpawnEntitySubroutine>.NativeClassPtr))
		{
			...
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_behaviour);
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_AB_BubbleBumper_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 160646, XrefRangeEnd = 160672, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static AB_BubbleBumper()
	{
		Il2CppClassPointerStore<AB_BubbleBumper>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "AB_BubbleBumper");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_BubbleBumper>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_BubbleBumper>.NativeClassPtr, "config");
		NativeFieldInfoPtr_spawnPos = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_BubbleBumper>.NativeClassPtr, "spawnPos");
		NativeMethodInfoPtr__ctor_Public_Void_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_BubbleBumper>.NativeClassPtr, 100675315);
		NativeMethodInfoPtr_Build_Public_Virtual_Void_Ability_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_BubbleBumper>.NativeClassPtr, 100675316);
		NativeMethodInfoPtr_DoUse_Private_Void_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_BubbleBumper>.NativeClassPtr, 100675317);
	}
	...
	public unsafe AB_BubbleBumper(Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_BubbleBumper>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[1];
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 160672, XrefRangeEnd = 160865, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 160876, RefRangeEnd = 160877, XrefRangeStart = 160865, XrefRangeEnd = 160876, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public AB_BubbleBumper(IntPtr pointer)
		: base(pointer)
	{
	}
}
