...
public class P_OnCd_Weaken : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		private static readonly IntPtr NativeFieldInfoPtr_weakenAmount;

		private static readonly IntPtr NativeFieldInfoPtr_weakenDuration;
		...
		public unsafe float weakenAmount
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_weakenAmount);
				return *(float*)num;
			}
			set
			{
				*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_weakenAmount)) = num;
			}
		}

		public unsafe float weakenDuration
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_weakenDuration);
				return *(float*)num;
			}
			set
			{
				*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_weakenDuration)) = num;
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OnCd_Weaken>.NativeClassPtr, "Config");
			...
			NativeFieldInfoPtr_weakenAmount = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "weakenAmount");
			NativeFieldInfoPtr_weakenDuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "weakenDuration");
			NativeFieldInfoPtr_vfxReadyPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "vfxReadyPrefab");
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677413);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177104, XrefRangeEnd = 177105, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomPassiveSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_P_OnCd_Weaken_Byte_0;
		...
		public unsafe P_OnCd_Weaken passive
		{
			get
			{
				...
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<P_OnCd_Weaken>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_passive)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)p_OnCd_Weaken));
			}
		}
		...
		{
			Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OnCd_Weaken>.NativeClassPtr, "CustomPassiveSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_P_OnCd_Weaken_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677414);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677415);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677416);
		}
		...
		public unsafe CustomPassiveSubroutine(P_OnCd_Weaken _ability, byte _triggerFinished)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr))
		{
			...
			*(byte**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_triggerFinished;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_P_OnCd_Weaken_Byte_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}
	...
	static P_OnCd_Weaken()
	{
		Il2CppClassPointerStore<P_OnCd_Weaken>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_OnCd_Weaken");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_OnCd_Weaken>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnCd_Weaken>.NativeClassPtr, "config");
		NativeFieldInfoPtr_passiveReady = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnCd_Weaken>.NativeClassPtr, "passiveReady");
		NativeFieldInfoPtr_triggeredAbilityId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnCd_Weaken>.NativeClassPtr, "triggeredAbilityId");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnCd_Weaken>.NativeClassPtr, 100677408);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnCd_Weaken>.NativeClassPtr, 100677409);
		NativeMethodInfoPtr_OnHitboxSpawned_Public_Virtual_Void_GameObject_EntityManager_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnCd_Weaken>.NativeClassPtr, 100677410);
		NativeMethodInfoPtr_OnBonusHitboxSpawned_Public_Virtual_Void_GameObject_EntityManager_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnCd_Weaken>.NativeClassPtr, 100677411);
		NativeMethodInfoPtr_ModifyHitbox_Private_Void_GameObject_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnCd_Weaken>.NativeClassPtr, 100677412);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 177132, RefRangeEnd = 177133, XrefRangeStart = 177105, XrefRangeEnd = 177132, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_OnCd_Weaken(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_OnCd_Weaken>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[2];
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177133, XrefRangeEnd = 177135, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177135, XrefRangeEnd = 177136, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 177147, RefRangeEnd = 177149, XrefRangeStart = 177136, XrefRangeEnd = 177147, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_OnCd_Weaken(IntPtr pointer)
		: base(pointer)
	{
	}
}
