...
public class RoamingWolfBehaviour : PathingNpcBehaviour
{
	public class CustomEnableAlertSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_RoamingWolfBehaviour_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0;

		public unsafe RoamingWolfBehaviour behaviour
		{
			get
			{
				...
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<RoamingWolfBehaviour>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_behaviour)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)roamingWolfBehaviour));
			}
		}

		static CustomEnableAlertSubroutine()
		{
			Il2CppClassPointerStore<CustomEnableAlertSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, "CustomEnableAlertSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_RoamingWolfBehaviour_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomEnableAlertSubroutine>.NativeClassPtr, 100675625);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomEnableAlertSubroutine>.NativeClassPtr, 100675626);
		}
		...
		public unsafe CustomEnableAlertSubroutine(RoamingWolfBehaviour _behaviour)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomEnableAlertSubroutine>.NativeClassPtr))
		{
			...
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_behaviour);
			...
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_RoamingWolfBehaviour_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 163897, XrefRangeEnd = 163900, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomDisableAlertSubroutine : SimulationSubroutine
	{
		...
		{
			Il2CppClassPointerStore<CustomDisableAlertSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, "CustomDisableAlertSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_RoamingWolfBehaviour_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomDisableAlertSubroutine>.NativeClassPtr, 100675627);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomDisableAlertSubroutine>.NativeClassPtr, 100675628);
		}

		[CallerCount(534)]
		[CachedScanResults(RefRangeStart = 124041, RefRangeEnd = 124575, XrefRangeStart = 124041, XrefRangeEnd = 124575, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomDisableAlertSubroutine(RoamingWolfBehaviour _behaviour)
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 163900, XrefRangeEnd = 163903, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
	...
	static RoamingWolfBehaviour()
	{
		Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "RoamingWolfBehaviour");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr);
		NativeFieldInfoPtr_meleeAbility = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, "meleeAbility");
		NativeFieldInfoPtr_dashAbility = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, "dashAbility");
		NativeFieldInfoPtr_alertVfxObj = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, "alertVfxObj");
		NativeFieldInfoPtr_audioPlayRandom = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, "audioPlayRandom");
		NativeFieldInfoPtr_isInAlert = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, "isInAlert");
		NativeMethodInfoPtr_PreAwake_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, 100675615);
		NativeMethodInfoPtr_ClSetIsInAlert_Public_Void_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, 100675616);
		NativeMethodInfoPtr_PropertyName_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, 100675617);
		NativeMethodInfoPtr_OnIsInAlertChanged_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, 100675618);
		NativeMethodInfoPtr_OnNetDeserialize_Public_Virtual_Void_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, 100675619);
		NativeMethodInfoPtr_OnNetSerialize_Public_Virtual_Void_NetworkWriter_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, 100675620);
		NativeMethodInfoPtr_OnNetDebugCompare_Public_Virtual_Boolean_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, 100675621);
		NativeMethodInfoPtr_OnNetDebugLog_Public_Virtual_Void_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, 100675622);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, 100675623);
		NativeMethodInfoPtr_Weaved_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr, 100675624);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 163903, XrefRangeEnd = 164064, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 164064, XrefRangeEnd = 164065, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 164065, XrefRangeEnd = 164070, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe RoamingWolfBehaviour()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<RoamingWolfBehaviour>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public RoamingWolfBehaviour(IntPtr pointer)
		: base(pointer)
	{
	}
}
