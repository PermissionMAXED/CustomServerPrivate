...
public class P_Aura_DamageReduction_SO : PassiveSO
{
	...
	public unsafe P_Aura_DamageReduction.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<P_Aura_DamageReduction.Config>(intPtr) : null;
		}
		set
		{
	...
	static P_Aura_DamageReduction_SO()
	{
		Il2CppClassPointerStore<P_Aura_DamageReduction_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_Aura_DamageReduction_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_Aura_DamageReduction_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Aura_DamageReduction_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_DamageReduction_SO>.NativeClassPtr, 100676798);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_Passive_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_DamageReduction_SO>.NativeClassPtr, 100676799);
		NativeMethodInfoPtr_OnValidate_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_DamageReduction_SO>.NativeClassPtr, 100676800);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_DamageReduction_SO>.NativeClassPtr, 100676801);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 174651, XrefRangeEnd = 174657, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 174657, XrefRangeEnd = 174660, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe P_Aura_DamageReduction_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_Aura_DamageReduction_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public P_Aura_DamageReduction_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
