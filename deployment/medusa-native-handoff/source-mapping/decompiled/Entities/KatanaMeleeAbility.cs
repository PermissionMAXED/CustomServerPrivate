...
public class KatanaMeleeAbility : Ability
{
	public class CustomVfxSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeFieldInfoPtr_vfxFireId;
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_KatanaMeleeAbility_VfxEventAction_VfxTarget_GameObject_GameObject_Vector3_Quaternion_Byte_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0;

		public unsafe KatanaMeleeAbility ability
		{
			get
			{
				...
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<KatanaMeleeAbility>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_ability)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)katanaMeleeAbility));
			}
		}
		...
		public unsafe int vfxFireId
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_vfxFireId);
				return *(int*)num;
			}
			set
			{
				*(int*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_vfxFireId)) = num;
			}
		}
		...
		{
			Il2CppClassPointerStore<CustomVfxSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "CustomVfxSubroutine");
			...
			NativeFieldInfoPtr_vfxFireId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomVfxSubroutine>.NativeClassPtr, "vfxFireId");
			...
			NativeMethodInfoPtr__ctor_Public_Void_KatanaMeleeAbility_VfxEventAction_VfxTarget_GameObject_GameObject_Vector3_Quaternion_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomVfxSubroutine>.NativeClassPtr, 100674574);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomVfxSubroutine>.NativeClassPtr, 100674575);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 148754, XrefRangeEnd = 148757, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomVfxSubroutine(KatanaMeleeAbility ability, VfxEventAction vfxAction, VfxTarget vfxTarget, GameObject vfxPrefab, GameObject vfxFirePrefab, Vector3 position, Quaternion rotation, byte attachableId = 0)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomVfxSubroutine>.NativeClassPtr))
		{
			...
			*(IntPtr*)((byte*)ptr + checked((nuint)4u * unchecked((nuint)sizeof(IntPtr)))) = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)vfxFirePrefab);
			...
			*(byte**)((byte*)ptr + checked((nuint)7u * unchecked((nuint)sizeof(IntPtr)))) = &attachableId;
			...
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_KatanaMeleeAbility_VfxEventAction_VfxTarget_GameObject_GameObject_Vector3_Quaternion_Byte_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 148757, XrefRangeEnd = 148765, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomSnapAimSubroutine : SimulationSubroutine
	{
		...
		static CustomSnapAimSubroutine()
		{
			Il2CppClassPointerStore<CustomSnapAimSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "CustomSnapAimSubroutine");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CustomSnapAimSubroutine>.NativeClassPtr);
			NativeFieldInfoPtr_ability = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomSnapAimSubroutine>.NativeClassPtr, "ability");
			NativeMethodInfoPtr__ctor_Public_Void_Ability_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomSnapAimSubroutine>.NativeClassPtr, 100674576);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomSnapAimSubroutine>.NativeClassPtr, 100674577);
		}
		...
		public unsafe CustomSnapAimSubroutine(Ability _ability)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomSnapAimSubroutine>.NativeClassPtr))
		{
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 148765, XrefRangeEnd = 148767, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
		...
		public CustomSnapAimSubroutine(IntPtr pointer)
			: base(pointer)
		{
		}
	}
	...
	public class CustomCheckBonusSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_KatanaMeleeAbility_Byte_0;
		...
		static CustomCheckBonusSubroutine()
		{
			Il2CppClassPointerStore<CustomCheckBonusSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "CustomCheckBonusSubroutine");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CustomCheckBonusSubroutine>.NativeClassPtr);
			NativeFieldInfoPtr_ability = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomCheckBonusSubroutine>.NativeClassPtr, "ability");
			NativeFieldInfoPtr_trigger = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomCheckBonusSubroutine>.NativeClassPtr, "trigger");
			NativeMethodInfoPtr__ctor_Public_Void_KatanaMeleeAbility_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomCheckBonusSubroutine>.NativeClassPtr, 100674578);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomCheckBonusSubroutine>.NativeClassPtr, 100674579);
			NativeMethodInfoPtr_OnExit_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomCheckBonusSubroutine>.NativeClassPtr, 100674580);
		}
		...
		public unsafe CustomCheckBonusSubroutine(KatanaMeleeAbility _ability, byte _trigger)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomCheckBonusSubroutine>.NativeClassPtr))
		{
			IntPtr* ptr = stackalloc IntPtr[2];
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_ability);
			*(byte**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_trigger;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_KatanaMeleeAbility_Byte_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}
		...
		public CustomCheckBonusSubroutine(IntPtr pointer)
			: base(pointer)
		{
		}
	}
	...
	public class CustomRemoveBonusSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_KatanaMeleeAbility_0;
		...
		static CustomRemoveBonusSubroutine()
		{
			Il2CppClassPointerStore<CustomRemoveBonusSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "CustomRemoveBonusSubroutine");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CustomRemoveBonusSubroutine>.NativeClassPtr);
			NativeFieldInfoPtr_ability = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomRemoveBonusSubroutine>.NativeClassPtr, "ability");
			NativeMethodInfoPtr__ctor_Public_Void_KatanaMeleeAbility_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomRemoveBonusSubroutine>.NativeClassPtr, 100674581);
			NativeMethodInfoPtr_OnExit_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomRemoveBonusSubroutine>.NativeClassPtr, 100674582);
		}

		[CallerCount(534)]
		[CachedScanResults(RefRangeStart = 124041, RefRangeEnd = 124575, XrefRangeStart = 124041, XrefRangeEnd = 124575, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomRemoveBonusSubroutine(KatanaMeleeAbility _ability)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomRemoveBonusSubroutine>.NativeClassPtr))
		{
			IntPtr* ptr = stackalloc IntPtr[1];
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_ability);
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_KatanaMeleeAbility_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}
		...
		public CustomRemoveBonusSubroutine(IntPtr pointer)
			: base(pointer)
		{
		}
	}
	...
	public class CustomAttackSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_KatanaMeleeAbility_Int32_0;
		...
		{
			Il2CppClassPointerStore<CustomAttackSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "CustomAttackSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_KatanaMeleeAbility_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomAttackSubroutine>.NativeClassPtr, 100674583);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomAttackSubroutine>.NativeClassPtr, 100674584);
		}
		...
		public unsafe CustomAttackSubroutine(KatanaMeleeAbility _ability, int _attackId)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomAttackSubroutine>.NativeClassPtr))
		{
			...
			*(int**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_attackId;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_KatanaMeleeAbility_Int32_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 148767, XrefRangeEnd = 148774, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
	...
	private static readonly IntPtr NativeFieldInfoPtr_spellAttack3Prefab;
	...
	private static readonly IntPtr NativeFieldInfoPtr_extendedInputBufferDuration;
	...
	private static readonly IntPtr NativeFieldInfoPtr_damage3;

	private static readonly IntPtr NativeFieldInfoPtr_damage3Scaling;

	private static readonly IntPtr NativeFieldInfoPtr_bonusHitStatusEffects;
	...
	private static readonly IntPtr NativeFieldInfoPtr_vfxCast3Prefab;

	private static readonly IntPtr NativeFieldInfoPtr_vfxCast3FirePrefab;
	...
	private static readonly IntPtr NativeFieldInfoPtr_projectileAbility;

	private static readonly IntPtr NativeFieldInfoPtr_bonusEnabled;

	private static readonly IntPtr NativeFieldInfoPtr_baseInputBufferDuration;

	private static readonly IntPtr NativeMethodInfoPtr_PreAwake_Public_Virtual_Void_EntityManager_0;

	private static readonly IntPtr NativeMethodInfoPtr_DoAttack_Private_Void_Vector3_GameObject_Int32_Single_Int32_Int32_0;

	private static readonly IntPtr NativeMethodInfoPtr_PrepareChargedAttack_Public_Void_0;

	private static readonly IntPtr NativeMethodInfoPtr_SetExtendedInputBufferTime_Public_Void_0;

	private static readonly IntPtr NativeMethodInfoPtr_OnTargetHit_Public_Virtual_Void_EntityManager_HitboxBase_0;

	private static readonly IntPtr NativeMethodInfoPtr_SetInputBufferTime_Public_Void_Single_0;
	...
	public unsafe GameObject spellAttack3Prefab
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_spellAttack3Prefab);
			IntPtr intPtr = *(IntPtr*)num;
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<GameObject>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_spellAttack3Prefab)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)gameObject));
		}
	}
	...
	public unsafe float extendedInputBufferDuration
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_extendedInputBufferDuration);
			return *(float*)num;
		}
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_extendedInputBufferDuration)) = num;
		}
	}
	...
	public unsafe int damage3
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_damage3);
			return *(int*)num;
		}
		set
		{
			*(int*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_damage3)) = num;
		}
	}

	public unsafe float damage3Scaling
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_damage3Scaling);
			return *(float*)num;
		}
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_damage3Scaling)) = num;
		}
	}

	public unsafe List<StatusEffectInfo> bonusHitStatusEffects
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_bonusHitStatusEffects);
			IntPtr intPtr = *(IntPtr*)num;
		...
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_bonusHitStatusEffects)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)list));
		}
	}
	...
	public unsafe GameObject vfxCast3Prefab
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_vfxCast3Prefab);
			IntPtr intPtr = *(IntPtr*)num;
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<GameObject>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_vfxCast3Prefab)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)gameObject));
		}
	}

	public unsafe GameObject vfxCast3FirePrefab
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_vfxCast3FirePrefab);
			IntPtr intPtr = *(IntPtr*)num;
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<GameObject>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_vfxCast3FirePrefab)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)gameObject));
		}
	}
	...
	public unsafe FireyEmpoweredDashAbility dashAbility
	{
		get
		{
			...
			IntPtr intPtr = *(IntPtr*)num;
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<FireyEmpoweredDashAbility>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_dashAbility)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)fireyEmpoweredDashAbility));
		}
	}

	public unsafe FireyChargedProjectileAbility projectileAbility
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_projectileAbility);
			IntPtr intPtr = *(IntPtr*)num;
		...
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_projectileAbility)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)fireyChargedProjectileAbility));
		}
	}
	...
	public unsafe float baseInputBufferDuration
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_baseInputBufferDuration);
			return *(float*)num;
		}
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_baseInputBufferDuration)) = num;
		}
	}

	static KatanaMeleeAbility()
	{
		Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "KatanaMeleeAbility");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr);
		NativeFieldInfoPtr_spellAttack1Prefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "spellAttack1Prefab");
		NativeFieldInfoPtr_spellAttack2Prefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "spellAttack2Prefab");
		NativeFieldInfoPtr_spellAttack3Prefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "spellAttack3Prefab");
		NativeFieldInfoPtr_firingPoint = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "firingPoint");
		NativeFieldInfoPtr_castMotionLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "castMotionLockType");
		NativeFieldInfoPtr_rotationLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "rotationLockType");
		NativeFieldInfoPtr_applyAtkSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "applyAtkSpeedMultiplier");
		NativeFieldInfoPtr_applyCooldownMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "applyCooldownMultiplier");
		NativeFieldInfoPtr_inputType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "inputType");
		NativeFieldInfoPtr_extendedInputBufferDuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "extendedInputBufferDuration");
		NativeFieldInfoPtr_ttl = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "ttl");
		NativeFieldInfoPtr_damage1 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "damage1");
		NativeFieldInfoPtr_damage1Scaling = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "damage1Scaling");
		NativeFieldInfoPtr_damage2 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "damage2");
		NativeFieldInfoPtr_damage2Scaling = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "damage2Scaling");
		NativeFieldInfoPtr_damage3 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "damage3");
		NativeFieldInfoPtr_damage3Scaling = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "damage3Scaling");
		NativeFieldInfoPtr_bonusHitStatusEffects = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "bonusHitStatusEffects");
		NativeFieldInfoPtr_castingTime1 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "castingTime1");
		NativeFieldInfoPtr_recoveryTime1 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "recoveryTime1");
		NativeFieldInfoPtr_cooldownTime1 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "cooldownTime1");
		NativeFieldInfoPtr_castingTime2 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "castingTime2");
		NativeFieldInfoPtr_recoveryTime2 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "recoveryTime2");
		NativeFieldInfoPtr_cooldownTime2 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "cooldownTime2");
		NativeFieldInfoPtr_castingTime3 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "castingTime3");
		NativeFieldInfoPtr_recoveryTime3 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "recoveryTime3");
		NativeFieldInfoPtr_comboCooldownTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "comboCooldownTime");
		NativeFieldInfoPtr_comboResetTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "comboResetTime");
		NativeFieldInfoPtr_vfxCast1Prefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "vfxCast1Prefab");
		NativeFieldInfoPtr_vfxCast2Prefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "vfxCast2Prefab");
		NativeFieldInfoPtr_vfxCast3Prefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "vfxCast3Prefab");
		NativeFieldInfoPtr_vfxCast3FirePrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "vfxCast3FirePrefab");
		NativeFieldInfoPtr_sfxCast1 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "sfxCast1");
		NativeFieldInfoPtr_sfxCast2 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "sfxCast2");
		NativeFieldInfoPtr_sfxCast3 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "sfxCast3");
		NativeFieldInfoPtr_animLayer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "animLayer");
		NativeFieldInfoPtr_dashAbility = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "dashAbility");
		NativeFieldInfoPtr_projectileAbility = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "projectileAbility");
		NativeFieldInfoPtr_bonusEnabled = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "bonusEnabled");
		NativeFieldInfoPtr_baseInputBufferDuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, "baseInputBufferDuration");
		NativeMethodInfoPtr_PreAwake_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, 100674564);
		NativeMethodInfoPtr_DoAttack_Private_Void_Vector3_GameObject_Int32_Single_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, 100674565);
		NativeMethodInfoPtr_PrepareChargedAttack_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, 100674566);
		NativeMethodInfoPtr_SetExtendedInputBufferTime_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, 100674567);
		NativeMethodInfoPtr_OnTargetHit_Public_Virtual_Void_EntityManager_HitboxBase_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, 100674568);
		NativeMethodInfoPtr_SetInputBufferTime_Public_Void_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, 100674569);
		NativeMethodInfoPtr_GetTooltipDescription_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, 100674570);
		NativeMethodInfoPtr_GetTooltipExpandedDescription_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, 100674571);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, 100674572);
		NativeMethodInfoPtr_Weaved_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr, 100674573);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 148774, XrefRangeEnd = 149171, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 149208, RefRangeEnd = 149209, XrefRangeStart = 149171, XrefRangeEnd = 149208, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void DoAttack(Vector3 lookDir, GameObject spellPrefab, int damage, float damageScaling, int attackId, int predTickNum)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		...
		*(int**)((byte*)ptr + checked((nuint)4u * unchecked((nuint)sizeof(IntPtr)))) = &attackId;
		*(int**)((byte*)ptr + checked((nuint)5u * unchecked((nuint)sizeof(IntPtr)))) = &predTickNum;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_DoAttack_Private_Void_Vector3_GameObject_Int32_Single_Int32_Int32_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	public unsafe void PrepareChargedAttack()
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_PrepareChargedAttack_Public_Void_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	public unsafe void SetExtendedInputBufferTime()
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_SetExtendedInputBufferTime_Public_Void_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 149209, XrefRangeEnd = 149217, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe override void OnTargetHit(EntityManager otherCharManager, HitboxBase hitboxBase)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[2];
	...
	[CallerCount(0)]
	public unsafe void SetInputBufferTime(float b)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[1];
		*ptr = (nint)(&b);
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_SetInputBufferTime_Public_Void_Single_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 149217, XrefRangeEnd = 149222, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 149222, XrefRangeEnd = 149230, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 149230, XrefRangeEnd = 149235, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe KatanaMeleeAbility()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<KatanaMeleeAbility>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public KatanaMeleeAbility(IntPtr pointer)
		: base(pointer)
	{
	}
}
