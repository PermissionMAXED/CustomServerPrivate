...
public class ChannelingSubroutine : NetworkedSimulationSubroutine
{
	...
	private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_Ability_Byte_Byte_Byte_Single_Boolean_0;
	...
	private static readonly IntPtr NativeMethodInfoPtr_GetAdjustedChannelingTime_Private_Single_0;

	private static readonly IntPtr NativeMethodInfoPtr_ReupdateChanneling_Public_Void_0;
	...
	static ChannelingSubroutine()
	{
		Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "ChannelingSubroutine");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr);
		NativeFieldInfoPtr_ability = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, "ability");
		NativeFieldInfoPtr_finishTrigger = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, "finishTrigger");
		NativeFieldInfoPtr_silenceTrigger = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, "silenceTrigger");
		NativeFieldInfoPtr_cancelTrigger = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, "cancelTrigger");
		NativeFieldInfoPtr_channelingTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, "channelingTime");
		NativeFieldInfoPtr_applyAtkSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, "applyAtkSpeedMultiplier");
		NativeFieldInfoPtr_isUlt = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, "isUlt");
		NativeFieldInfoPtr_isSuccess = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, "isSuccess");
		NativeFieldInfoPtr_timeElapsed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, "timeElapsed");
		NativeMethodInfoPtr__ctor_Public_Void_Ability_Byte_Byte_Byte_Single_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, 100674984);
		NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, 100674985);
		NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, 100674986);
		NativeMethodInfoPtr_OnExit_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, 100674987);
		NativeMethodInfoPtr_GetAdjustedChannelingTime_Private_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, 100674988);
		NativeMethodInfoPtr_ReupdateChanneling_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, 100674989);
		NativeMethodInfoPtr_OnNetDeserialize_Public_Virtual_Void_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, 100674990);
		NativeMethodInfoPtr_OnNetSerialize_Public_Virtual_Void_NetworkWriter_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, 100674991);
		NativeMethodInfoPtr_OnNetDebugCompare_Public_Virtual_Boolean_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, 100674992);
		NativeMethodInfoPtr_OnNetDebugLog_Public_Virtual_Void_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr, 100674993);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 155645, RefRangeEnd = 155647, XrefRangeStart = 155644, XrefRangeEnd = 155645, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ChannelingSubroutine(Ability ability, byte finishTrigger, byte silenceTrigger, byte cancelTrigger, float channelingTime, bool applyAtkSpeedMultiplier)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ChannelingSubroutine>.NativeClassPtr))
	{
		...
		*(float**)((byte*)ptr + checked((nuint)4u * unchecked((nuint)sizeof(IntPtr)))) = &channelingTime;
		*(bool**)((byte*)ptr + checked((nuint)5u * unchecked((nuint)sizeof(IntPtr)))) = &applyAtkSpeedMultiplier;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_Ability_Byte_Byte_Byte_Single_Boolean_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 155647, XrefRangeEnd = 155648, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 155648, XrefRangeEnd = 155657, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 155657, XrefRangeEnd = 155664, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	public unsafe float GetAdjustedChannelingTime()
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_GetAdjustedChannelingTime_Private_Single_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		return *(float*)IL2CPP.il2cpp_object_unbox(intPtr);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 155664, XrefRangeEnd = 155670, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void ReupdateChanneling()
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_ReupdateChanneling_Public_Void_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 155677, XrefRangeEnd = 155684, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public ChannelingSubroutine(IntPtr pointer)
		: base(pointer)
	{
	}
}
