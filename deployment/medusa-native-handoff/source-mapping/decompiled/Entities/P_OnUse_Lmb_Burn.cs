...
public class P_OnUse_Lmb_Burn : Passive
{
	[Serializable]
	public class Config : PassiveConfiguration
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OnUse_Lmb_Burn>.NativeClassPtr, "Config");
			...
			NativeFieldInfoPtr_burnDuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "burnDuration");
			NativeFieldInfoPtr_vfxFollowPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "vfxFollowPrefab");
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677771);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 178313, XrefRangeEnd = 178314, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomPassiveSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_P_OnUse_Lmb_Burn_Byte_0;
		...
		public unsafe P_OnUse_Lmb_Burn passive
		{
			get
			{
				...
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<P_OnUse_Lmb_Burn>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_passive)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)p_OnUse_Lmb_Burn));
			}
		}
		...
		{
			Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OnUse_Lmb_Burn>.NativeClassPtr, "CustomPassiveSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_P_OnUse_Lmb_Burn_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677772);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677773);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677774);
		}
		...
		public unsafe CustomPassiveSubroutine(P_OnUse_Lmb_Burn _ability, byte _triggerFinished)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr))
		{
			...
			*(byte**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_triggerFinished;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_P_OnUse_Lmb_Burn_Byte_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}
	...
	private static readonly IntPtr NativeMethodInfoPtr_ModifyHitbox_Private_Void_GameObject_EntityManager_0;
	...
	static P_OnUse_Lmb_Burn()
	{
		Il2CppClassPointerStore<P_OnUse_Lmb_Burn>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_OnUse_Lmb_Burn");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_OnUse_Lmb_Burn>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnUse_Lmb_Burn>.NativeClassPtr, "config");
		NativeFieldInfoPtr_passiveReady = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnUse_Lmb_Burn>.NativeClassPtr, "passiveReady");
		NativeFieldInfoPtr_triggeredAbilityId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnUse_Lmb_Burn>.NativeClassPtr, "triggeredAbilityId");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_Lmb_Burn>.NativeClassPtr, 100677766);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_Lmb_Burn>.NativeClassPtr, 100677767);
		NativeMethodInfoPtr_OnHitboxSpawned_Public_Virtual_Void_GameObject_EntityManager_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_Lmb_Burn>.NativeClassPtr, 100677768);
		NativeMethodInfoPtr_OnBonusHitboxSpawned_Public_Virtual_Void_GameObject_EntityManager_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_Lmb_Burn>.NativeClassPtr, 100677769);
		NativeMethodInfoPtr_ModifyHitbox_Private_Void_GameObject_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnUse_Lmb_Burn>.NativeClassPtr, 100677770);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 178343, RefRangeEnd = 178344, XrefRangeStart = 178314, XrefRangeEnd = 178343, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_OnUse_Lmb_Burn(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_OnUse_Lmb_Burn>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[2];
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 178344, XrefRangeEnd = 178346, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 178346, XrefRangeEnd = 178347, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 178358, RefRangeEnd = 178360, XrefRangeStart = 178347, XrefRangeEnd = 178358, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void ModifyHitbox(GameObject g, EntityManager cM)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[2];
		*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)g);
		*(IntPtr*)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)cM);
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_ModifyHitbox_Private_Void_GameObject_EntityManager_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	public P_OnUse_Lmb_Burn(IntPtr pointer)
		: base(pointer)
	{
	}
}
