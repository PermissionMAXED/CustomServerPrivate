...
public class AB_PoisonInfuse_SO : AbilityBehaviourSO
{
	...
	public unsafe AB_PoisonInfuse.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<AB_PoisonInfuse.Config>(intPtr) : null;
		}
		set
		{
	...
	static AB_PoisonInfuse_SO()
	{
		Il2CppClassPointerStore<AB_PoisonInfuse_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "AB_PoisonInfuse_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_PoisonInfuse_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_PoisonInfuse_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_AbilityBehaviourConfig_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_PoisonInfuse_SO>.NativeClassPtr, 100675381);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_AbilityBehaviour_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_PoisonInfuse_SO>.NativeClassPtr, 100675382);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_PoisonInfuse_SO>.NativeClassPtr, 100675383);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 161525, XrefRangeEnd = 161528, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe AB_PoisonInfuse_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_PoisonInfuse_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public AB_PoisonInfuse_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
