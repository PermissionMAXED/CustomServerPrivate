...
public class P_Blood_OnKill_Explosion : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_Blood_OnKill_Explosion>.NativeClassPtr, "Config");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100676954);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175610, XrefRangeEnd = 175612, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static P_Blood_OnKill_Explosion()
	{
		Il2CppClassPointerStore<P_Blood_OnKill_Explosion>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_Blood_OnKill_Explosion");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_Blood_OnKill_Explosion>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Blood_OnKill_Explosion>.NativeClassPtr, "config");
		NativeFieldInfoPtr_dmgHitboxObj = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Blood_OnKill_Explosion>.NativeClassPtr, "dmgHitboxObj");
		NativeFieldInfoPtr_vfxReadyId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Blood_OnKill_Explosion>.NativeClassPtr, "vfxReadyId");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Explosion>.NativeClassPtr, 100676946);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Explosion>.NativeClassPtr, 100676947);
		NativeMethodInfoPtr_SpawnDmgObject_Public_Void_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Explosion>.NativeClassPtr, 100676948);
		NativeMethodInfoPtr_OnKillTrigger_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Explosion>.NativeClassPtr, 100676949);
		NativeMethodInfoPtr_ActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Explosion>.NativeClassPtr, 100676950);
		NativeMethodInfoPtr_DeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Explosion>.NativeClassPtr, 100676951);
		NativeMethodInfoPtr_ClActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Explosion>.NativeClassPtr, 100676952);
		NativeMethodInfoPtr_ClDeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Explosion>.NativeClassPtr, 100676953);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175612, XrefRangeEnd = 175616, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_Blood_OnKill_Explosion(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_Blood_OnKill_Explosion>.NativeClassPtr))
	{
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 175636, RefRangeEnd = 175637, XrefRangeStart = 175616, XrefRangeEnd = 175636, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175637, XrefRangeEnd = 175640, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175640, XrefRangeEnd = 175642, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175642, XrefRangeEnd = 175647, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_Blood_OnKill_Explosion(IntPtr pointer)
		: base(pointer)
	{
	}
}
