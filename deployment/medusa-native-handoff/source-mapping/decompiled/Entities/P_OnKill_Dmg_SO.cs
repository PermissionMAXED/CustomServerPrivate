...
public class P_OnKill_Dmg_SO : PassiveSO
{
	...
	public unsafe P_OnKill_Dmg.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<P_OnKill_Dmg.Config>(intPtr) : null;
		}
		set
		{
	...
	static P_OnKill_Dmg_SO()
	{
		Il2CppClassPointerStore<P_OnKill_Dmg_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_OnKill_Dmg_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_OnKill_Dmg_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnKill_Dmg_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_Dmg_SO>.NativeClassPtr, 100677585);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_Passive_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_Dmg_SO>.NativeClassPtr, 100677586);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_Dmg_SO>.NativeClassPtr, 100677587);
	}
	...
	public unsafe P_OnKill_Dmg_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_OnKill_Dmg_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public P_OnKill_Dmg_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
