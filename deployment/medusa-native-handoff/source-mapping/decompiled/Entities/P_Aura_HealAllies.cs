...
public class P_Aura_HealAllies : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		private static readonly IntPtr NativeFieldInfoPtr_maxHPHealPercent;

		private static readonly IntPtr NativeFieldInfoPtr_healRange;
		...
		public unsafe float maxHPHealPercent
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_maxHPHealPercent);
				return *(float*)num;
			}
			set
			{
				*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_maxHPHealPercent)) = num;
			}
		}

		public unsafe float healRange
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_healRange);
				return *(float*)num;
			}
			set
			{
				*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_healRange)) = num;
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_Aura_HealAllies>.NativeClassPtr, "Config");
			...
			NativeFieldInfoPtr_maxHPHealPercent = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "maxHPHealPercent");
			NativeFieldInfoPtr_healRange = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "healRange");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100676819);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 174710, XrefRangeEnd = 174711, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	private static readonly IntPtr NativeMethodInfoPtr_TryHealTeammates_Public_Void_0;
	...
	static P_Aura_HealAllies()
	{
		Il2CppClassPointerStore<P_Aura_HealAllies>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_Aura_HealAllies");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_Aura_HealAllies>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Aura_HealAllies>.NativeClassPtr, "config");
		NativeFieldInfoPtr_timeElapsed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Aura_HealAllies>.NativeClassPtr, "timeElapsed");
		NativeFieldInfoPtr_vfxReadyId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Aura_HealAllies>.NativeClassPtr, "vfxReadyId");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_HealAllies>.NativeClassPtr, 100676813);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_HealAllies>.NativeClassPtr, 100676814);
		NativeMethodInfoPtr_Tick_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_HealAllies>.NativeClassPtr, 100676815);
		NativeMethodInfoPtr_TryHealTeammates_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_HealAllies>.NativeClassPtr, 100676816);
		NativeMethodInfoPtr_ClActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_HealAllies>.NativeClassPtr, 100676817);
		NativeMethodInfoPtr_ClDeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_HealAllies>.NativeClassPtr, 100676818);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 174711, XrefRangeEnd = 174715, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_Aura_HealAllies(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_Aura_HealAllies>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 174715, XrefRangeEnd = 174717, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 174749, RefRangeEnd = 174750, XrefRangeStart = 174717, XrefRangeEnd = 174749, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void TryHealTeammates()
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_TryHealTeammates_Public_Void_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}
	...
	public P_Aura_HealAllies(IntPtr pointer)
		: base(pointer)
	{
	}
}
