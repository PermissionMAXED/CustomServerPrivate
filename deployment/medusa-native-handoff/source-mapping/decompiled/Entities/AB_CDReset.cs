...
public class AB_CDReset : AB_Use_Base
{
	...
	public new class Config : AB_Use_Base.Config
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_CDReset>.NativeClassPtr, "Config");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100675327);
		}

		[CallerCount(1)]
		[CachedScanResults(RefRangeStart = 160881, RefRangeEnd = 160882, XrefRangeStart = 160880, XrefRangeEnd = 160881, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public new class CustomUseSubroutine : NetworkedSimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_AB_CDReset_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0;

		public unsafe AB_CDReset behaviour
		{
			get
			{
				...
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<AB_CDReset>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_behaviour)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)aB_CDReset));
			}
		}

		static CustomUseSubroutine()
		{
			Il2CppClassPointerStore<CustomUseSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_CDReset>.NativeClassPtr, "CustomUseSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_AB_CDReset_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomUseSubroutine>.NativeClassPtr, 100675328);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomUseSubroutine>.NativeClassPtr, 100675329);
		}
		...
		public unsafe CustomUseSubroutine(AB_CDReset _behaviour)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomUseSubroutine>.NativeClassPtr))
		{
			...
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_behaviour);
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_AB_CDReset_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}
	...
	static AB_CDReset()
	{
		Il2CppClassPointerStore<AB_CDReset>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "AB_CDReset");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_CDReset>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_CDReset>.NativeClassPtr, "config");
		NativeMethodInfoPtr__ctor_Public_Void_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_CDReset>.NativeClassPtr, 100675324);
		NativeMethodInfoPtr_Build_Public_Virtual_Void_Ability_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_CDReset>.NativeClassPtr, 100675325);
		NativeMethodInfoPtr_DoUse_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_CDReset>.NativeClassPtr, 100675326);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe AB_CDReset(Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_CDReset>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[1];
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 160882, XrefRangeEnd = 161053, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 161053, XrefRangeEnd = 161059, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public AB_CDReset(IntPtr pointer)
		: base(pointer)
	{
	}
}
