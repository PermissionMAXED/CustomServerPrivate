...
public class AB_Chains_SO : AbilityBehaviourSO
{
	...
	public unsafe AB_Chains.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<AB_Chains.Config>(intPtr) : null;
		}
		set
		{
	...
	static AB_Chains_SO()
	{
		Il2CppClassPointerStore<AB_Chains_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "AB_Chains_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_Chains_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_Chains_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_AbilityBehaviourConfig_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Chains_SO>.NativeClassPtr, 100675330);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_AbilityBehaviour_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Chains_SO>.NativeClassPtr, 100675331);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Chains_SO>.NativeClassPtr, 100675332);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 161059, XrefRangeEnd = 161068, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe AB_Chains_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_Chains_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public AB_Chains_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
