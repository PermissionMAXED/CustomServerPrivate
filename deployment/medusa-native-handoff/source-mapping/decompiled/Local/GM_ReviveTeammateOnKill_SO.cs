...
public class GM_ReviveTeammateOnKill_SO : GameModifierSO
{
	...
	public unsafe GM_ReviveTeammateOnKill.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<GM_ReviveTeammateOnKill.Config>(intPtr) : null;
		}
		set
		{
	...
	static GM_ReviveTeammateOnKill_SO()
	{
		Il2CppClassPointerStore<GM_ReviveTeammateOnKill_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "GM_ReviveTeammateOnKill_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<GM_ReviveTeammateOnKill_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GM_ReviveTeammateOnKill_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_GameModifierConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GM_ReviveTeammateOnKill_SO>.NativeClassPtr, 100683531);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_GameModifier_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GM_ReviveTeammateOnKill_SO>.NativeClassPtr, 100683532);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GM_ReviveTeammateOnKill_SO>.NativeClassPtr, 100683533);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 221297, XrefRangeEnd = 221300, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe GM_ReviveTeammateOnKill_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<GM_ReviveTeammateOnKill_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public GM_ReviveTeammateOnKill_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
