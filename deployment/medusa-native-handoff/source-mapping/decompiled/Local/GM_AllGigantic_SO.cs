...
public class GM_AllGigantic_SO : GameModifierSO
{
	...
	public unsafe GM_AllGigantic.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<GM_AllGigantic.Config>(intPtr) : null;
		}
		set
		{
	...
	static GM_AllGigantic_SO()
	{
		Il2CppClassPointerStore<GM_AllGigantic_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "GM_AllGigantic_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<GM_AllGigantic_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GM_AllGigantic_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_GameModifierConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GM_AllGigantic_SO>.NativeClassPtr, 100683434);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_GameModifier_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GM_AllGigantic_SO>.NativeClassPtr, 100683435);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GM_AllGigantic_SO>.NativeClassPtr, 100683436);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 221020, XrefRangeEnd = 221026, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe GM_AllGigantic_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<GM_AllGigantic_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public GM_AllGigantic_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
