...
public class GM_HpReduction_SO : GameModifierSO
{
	...
	public unsafe GM_HpReduction.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<GM_HpReduction.Config>(intPtr) : null;
		}
		set
		{
	...
	static GM_HpReduction_SO()
	{
		Il2CppClassPointerStore<GM_HpReduction_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "GM_HpReduction_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<GM_HpReduction_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GM_HpReduction_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_GameModifierConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GM_HpReduction_SO>.NativeClassPtr, 100683473);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_GameModifier_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GM_HpReduction_SO>.NativeClassPtr, 100683474);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GM_HpReduction_SO>.NativeClassPtr, 100683475);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 221139, XrefRangeEnd = 221142, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe GM_HpReduction_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<GM_HpReduction_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public GM_HpReduction_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
