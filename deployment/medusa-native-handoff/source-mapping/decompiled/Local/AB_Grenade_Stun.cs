...
public class AB_Grenade_Stun : AbilityBehaviour
{
	...
	public class Config : AbilityBehaviourConfig
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_Grenade_Stun>.NativeClassPtr, "Config");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100683170);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218646, XrefRangeEnd = 218651, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomSetPositionSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_AB_Grenade_Stun_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0;

		public unsafe AB_Grenade_Stun behaviour
		{
			get
			{
				...
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<AB_Grenade_Stun>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_behaviour)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)aB_Grenade_Stun));
			}
		}

		static CustomSetPositionSubroutine()
		{
			Il2CppClassPointerStore<CustomSetPositionSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_Grenade_Stun>.NativeClassPtr, "CustomSetPositionSubroutine");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CustomSetPositionSubroutine>.NativeClassPtr);
			NativeFieldInfoPtr_behaviour = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomSetPositionSubroutine>.NativeClassPtr, "behaviour");
			NativeMethodInfoPtr__ctor_Public_Void_AB_Grenade_Stun_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomSetPositionSubroutine>.NativeClassPtr, 100683171);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomSetPositionSubroutine>.NativeClassPtr, 100683172);
		}
		...
		public unsafe CustomSetPositionSubroutine(AB_Grenade_Stun behaviour)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomSetPositionSubroutine>.NativeClassPtr))
		{
			IntPtr* ptr = stackalloc IntPtr[1];
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)behaviour);
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_AB_Grenade_Stun_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218651, XrefRangeEnd = 218661, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		public CustomSetPositionSubroutine(IntPtr pointer)
			: base(pointer)
		{
		}
	}
	...
	public class CustomVisibleIndicatorSubroutine : NetworkedSimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_AB_Grenade_Stun_Boolean_0;
		...
		{
			Il2CppClassPointerStore<CustomVisibleIndicatorSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_Grenade_Stun>.NativeClassPtr, "CustomVisibleIndicatorSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_AB_Grenade_Stun_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomVisibleIndicatorSubroutine>.NativeClassPtr, 100683173);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomVisibleIndicatorSubroutine>.NativeClassPtr, 100683174);
		}
		...
		public unsafe CustomVisibleIndicatorSubroutine(AB_Grenade_Stun _behaviour, bool _spawn)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomVisibleIndicatorSubroutine>.NativeClassPtr))
		{
			...
			*(bool**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_spawn;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_AB_Grenade_Stun_Boolean_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218661, XrefRangeEnd = 218664, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
	...
	public class CustomThrowGrenadeSubroutine : SimulationSubroutine
	{
		...
		{
			Il2CppClassPointerStore<CustomThrowGrenadeSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_Grenade_Stun>.NativeClassPtr, "CustomThrowGrenadeSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_AB_Grenade_Stun_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomThrowGrenadeSubroutine>.NativeClassPtr, 100683175);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomThrowGrenadeSubroutine>.NativeClassPtr, 100683176);
		}

		[CallerCount(534)]
		[CachedScanResults(RefRangeStart = 124041, RefRangeEnd = 124575, XrefRangeStart = 124041, XrefRangeEnd = 124575, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomThrowGrenadeSubroutine(AB_Grenade_Stun behaviour)
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218664, XrefRangeEnd = 218667, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
	...
	static AB_Grenade_Stun()
	{
		Il2CppClassPointerStore<AB_Grenade_Stun>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "AB_Grenade_Stun");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_Grenade_Stun>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_Grenade_Stun>.NativeClassPtr, "config");
		NativeFieldInfoPtr_targetPos = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_Grenade_Stun>.NativeClassPtr, "targetPos");
		NativeFieldInfoPtr_currentIndicator = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_Grenade_Stun>.NativeClassPtr, "currentIndicator");
		NativeMethodInfoPtr__ctor_Public_Void_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Grenade_Stun>.NativeClassPtr, 100683165);
		NativeMethodInfoPtr_Build_Public_Virtual_Void_Ability_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Grenade_Stun>.NativeClassPtr, 100683166);
		NativeMethodInfoPtr_Shoot_Public_Void_EntityManager_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Grenade_Stun>.NativeClassPtr, 100683167);
		NativeMethodInfoPtr_RpcSpawnVisibleIndicator_Private_Void_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Grenade_Stun>.NativeClassPtr, 100683168);
		NativeMethodInfoPtr_RpcDestroyVisibleIndicator_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Grenade_Stun>.NativeClassPtr, 100683169);
	}
	...
	public unsafe AB_Grenade_Stun(Config _config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_Grenade_Stun>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[1];
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218667, XrefRangeEnd = 218790, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 218844, RefRangeEnd = 218845, XrefRangeStart = 218790, XrefRangeEnd = 218844, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 218870, RefRangeEnd = 218871, XrefRangeStart = 218845, XrefRangeEnd = 218870, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 218876, RefRangeEnd = 218877, XrefRangeStart = 218871, XrefRangeEnd = 218876, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public AB_Grenade_Stun(IntPtr pointer)
		: base(pointer)
	{
	}
}
