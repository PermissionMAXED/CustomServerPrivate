...
public class AB_Grenade_Lob : AbilityBehaviour
{
	...
	public class Config : AbilityBehaviourConfig
	{
		...
		private static readonly IntPtr NativeFieldInfoPtr_travelSpellPrefab;
		...
		private static readonly IntPtr NativeFieldInfoPtr_indicatorChargeFactorMultiplier;
		...
		public unsafe GameObject travelSpellPrefab
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_travelSpellPrefab);
			...
			set
			{
				...
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_travelSpellPrefab)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)gameObject));
			}
		}
		...
		public unsafe float indicatorChargeFactorMultiplier
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_indicatorChargeFactorMultiplier);
				return *(float*)num;
			}
			set
			{
				*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_indicatorChargeFactorMultiplier)) = num;
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_Grenade_Lob>.NativeClassPtr, "Config");
			...
			NativeFieldInfoPtr_travelSpellPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "travelSpellPrefab");
			...
			NativeFieldInfoPtr_indicatorChargeFactorMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "indicatorChargeFactorMultiplier");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100683142);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218269, XrefRangeEnd = 218274, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomChargeSubroutine : NetworkedSimulationSubroutine
	{
		...
		private static readonly IntPtr NativeFieldInfoPtr_maxMouseIndicatorScale;

		private static readonly IntPtr NativeFieldInfoPtr_lerpSize;

		private static readonly IntPtr NativeFieldInfoPtr_timeElapsed;

		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_AB_Grenade_Lob_Byte_0;
		...
		public unsafe AB_Grenade_Lob behaviour
		{
			get
			{
				...
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<AB_Grenade_Lob>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_behaviour)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)aB_Grenade_Lob));
			}
		}
		...
		public unsafe Vector3 maxMouseIndicatorScale
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_maxMouseIndicatorScale);
				return *(Vector3*)num;
			}
			set
			{
				*(Vector3*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_maxMouseIndicatorScale)) = vector;
			}
		}

		public unsafe Vector2 lerpSize
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_lerpSize);
				return *(Vector2*)num;
			}
			set
			{
				*(Vector2*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_lerpSize)) = vector;
			}
		}
		...
		{
			Il2CppClassPointerStore<CustomChargeSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_Grenade_Lob>.NativeClassPtr, "CustomChargeSubroutine");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CustomChargeSubroutine>.NativeClassPtr);
			NativeFieldInfoPtr_behaviour = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomChargeSubroutine>.NativeClassPtr, "behaviour");
			...
			NativeFieldInfoPtr_maxMouseIndicatorScale = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomChargeSubroutine>.NativeClassPtr, "maxMouseIndicatorScale");
			NativeFieldInfoPtr_lerpSize = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomChargeSubroutine>.NativeClassPtr, "lerpSize");
			...
			NativeMethodInfoPtr__ctor_Public_Void_AB_Grenade_Lob_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomChargeSubroutine>.NativeClassPtr, 100683143);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomChargeSubroutine>.NativeClassPtr, 100683144);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomChargeSubroutine>.NativeClassPtr, 100683145);
			NativeMethodInfoPtr_OnExit_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomChargeSubroutine>.NativeClassPtr, 100683146);
			NativeMethodInfoPtr_OnNetDeserialize_Public_Virtual_Void_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomChargeSubroutine>.NativeClassPtr, 100683147);
			NativeMethodInfoPtr_OnNetSerialize_Public_Virtual_Void_NetworkWriter_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomChargeSubroutine>.NativeClassPtr, 100683148);
			NativeMethodInfoPtr_OnNetDebugCompare_Public_Virtual_Boolean_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomChargeSubroutine>.NativeClassPtr, 100683149);
			NativeMethodInfoPtr_OnNetDebugLog_Public_Virtual_Void_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomChargeSubroutine>.NativeClassPtr, 100683150);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218274, XrefRangeEnd = 218275, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomChargeSubroutine(AB_Grenade_Lob ability, byte finishTrigger)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomChargeSubroutine>.NativeClassPtr))
		{
			...
			*(byte**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &finishTrigger;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_AB_Grenade_Lob_Byte_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218275, XrefRangeEnd = 218280, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218280, XrefRangeEnd = 218282, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218282, XrefRangeEnd = 218292, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218292, XrefRangeEnd = 218293, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218293, XrefRangeEnd = 218294, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218294, XrefRangeEnd = 218295, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218295, XrefRangeEnd = 218300, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomThrowGrenadeSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_AB_Grenade_Lob_0;
		...
		static CustomThrowGrenadeSubroutine()
		{
			Il2CppClassPointerStore<CustomThrowGrenadeSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_Grenade_Lob>.NativeClassPtr, "CustomThrowGrenadeSubroutine");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CustomThrowGrenadeSubroutine>.NativeClassPtr);
			NativeFieldInfoPtr_behaviour = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomThrowGrenadeSubroutine>.NativeClassPtr, "behaviour");
			NativeMethodInfoPtr__ctor_Public_Void_AB_Grenade_Lob_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomThrowGrenadeSubroutine>.NativeClassPtr, 100683151);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomThrowGrenadeSubroutine>.NativeClassPtr, 100683152);
		}
		...
		public unsafe CustomThrowGrenadeSubroutine(AB_Grenade_Lob behaviour)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomThrowGrenadeSubroutine>.NativeClassPtr))
		{
			IntPtr* ptr = stackalloc IntPtr[1];
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)behaviour);
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_AB_Grenade_Lob_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218300, XrefRangeEnd = 218303, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
		...
		public CustomThrowGrenadeSubroutine(IntPtr pointer)
			: base(pointer)
		{
		}
	}
	...
	private static readonly IntPtr NativeFieldInfoPtr_mouseIndicatorSubroutine;
	...
	public unsafe MouseIndicatorSubroutine mouseIndicatorSubroutine
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_mouseIndicatorSubroutine);
			IntPtr intPtr = *(IntPtr*)num;
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<MouseIndicatorSubroutine>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_mouseIndicatorSubroutine)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)mouseIndicatorSubroutine));
		}
	}
	...
	public unsafe IndicatorMouse mouseIndicator
	{
		...
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_mouseIndicator)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)indicatorMouse));
		}
	}

	static AB_Grenade_Lob()
	{
		Il2CppClassPointerStore<AB_Grenade_Lob>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "AB_Grenade_Lob");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_Grenade_Lob>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_Grenade_Lob>.NativeClassPtr, "config");
		NativeFieldInfoPtr_targetPos = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_Grenade_Lob>.NativeClassPtr, "targetPos");
		NativeFieldInfoPtr_chargeFactor = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_Grenade_Lob>.NativeClassPtr, "chargeFactor");
		NativeFieldInfoPtr_mouseIndicatorSubroutine = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_Grenade_Lob>.NativeClassPtr, "mouseIndicatorSubroutine");
		NativeFieldInfoPtr_mouseIndicator = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_Grenade_Lob>.NativeClassPtr, "mouseIndicator");
		NativeMethodInfoPtr__ctor_Public_Void_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Grenade_Lob>.NativeClassPtr, 100683139);
		NativeMethodInfoPtr_Build_Public_Virtual_Void_Ability_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Grenade_Lob>.NativeClassPtr, 100683140);
		NativeMethodInfoPtr_Shoot_Public_Void_EntityManager_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Grenade_Lob>.NativeClassPtr, 100683141);
	}
	...
	public unsafe AB_Grenade_Lob(Config _config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_Grenade_Lob>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[1];
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 218303, XrefRangeEnd = 218400, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 218453, RefRangeEnd = 218454, XrefRangeStart = 218400, XrefRangeEnd = 218453, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public AB_Grenade_Lob(IntPtr pointer)
		: base(pointer)
	{
	}
}
