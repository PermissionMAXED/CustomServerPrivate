...
public class AB_MachineGun : AB_Consumable_Base_Spawn
{
	...
	public new class Config : AB_Consumable_Base_Spawn.Config
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_MachineGun>.NativeClassPtr, "Config");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Config>.NativeClassPtr);
			NativeFieldInfoPtr_passive = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "passive");
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100683231);
		}
	...
	static AB_MachineGun()
	{
		Il2CppClassPointerStore<AB_MachineGun>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "AB_MachineGun");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_MachineGun>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_MachineGun>.NativeClassPtr, "config");
		NativeMethodInfoPtr__ctor_Public_Void_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_MachineGun>.NativeClassPtr, 100683229);
		NativeMethodInfoPtr_DoSpawnConsumable_Protected_Virtual_Void_EntityManager_Vector3_Quaternion_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_MachineGun>.NativeClassPtr, 100683230);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe AB_MachineGun(Config _config = null)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_MachineGun>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 219281, XrefRangeEnd = 219286, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public AB_MachineGun(IntPtr pointer)
		: base(pointer)
	{
	}
}
