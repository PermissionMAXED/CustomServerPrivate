...
public class AB_SlimeDash : AbilityBehaviour
{
	...
	public class Config : AbilityBehaviourConfig
	{
		...
		private static readonly IntPtr NativeFieldInfoPtr_puddlePrefab;

		private static readonly IntPtr NativeFieldInfoPtr_puddleStatusEffects;
		...
		public unsafe GameObject puddlePrefab
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_puddlePrefab);
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<GameObject>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_puddlePrefab)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)gameObject));
			}
		}

		public unsafe List<StatusEffectInfo> puddleStatusEffects
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_puddleStatusEffects);
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<List<StatusEffectInfo>>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_puddleStatusEffects)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)list));
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, "Config");
			...
			NativeFieldInfoPtr_puddlePrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "puddlePrefab");
			NativeFieldInfoPtr_puddleStatusEffects = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "puddleStatusEffects");
			NativeFieldInfoPtr_puddleTtl = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "puddleTtl");
			NativeFieldInfoPtr_slowSpawnDistance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "slowSpawnDistance");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100683352);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220023, XrefRangeEnd = 220030, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomLookAtTargetSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeDash_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0;

		public unsafe AB_SlimeDash behaviour
		{
			get
			{
				...
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<AB_SlimeDash>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_behaviour)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)aB_SlimeDash));
			}
		}

		static CustomLookAtTargetSubroutine()
		{
			Il2CppClassPointerStore<CustomLookAtTargetSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, "CustomLookAtTargetSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeDash_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomLookAtTargetSubroutine>.NativeClassPtr, 100683353);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomLookAtTargetSubroutine>.NativeClassPtr, 100683354);
		}
		...
		public unsafe CustomLookAtTargetSubroutine(AB_SlimeDash _behaviour)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomLookAtTargetSubroutine>.NativeClassPtr))
		{
			...
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_behaviour);
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeDash_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220030, XrefRangeEnd = 220041, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomVisibleIndicatorSubroutine : NetworkedSimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeDash_Boolean_0;
		...
		{
			Il2CppClassPointerStore<CustomVisibleIndicatorSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, "CustomVisibleIndicatorSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeDash_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomVisibleIndicatorSubroutine>.NativeClassPtr, 100683355);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomVisibleIndicatorSubroutine>.NativeClassPtr, 100683356);
		}
		...
		public unsafe CustomVisibleIndicatorSubroutine(AB_SlimeDash _behaviour, bool _spawn)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomVisibleIndicatorSubroutine>.NativeClassPtr))
		{
			...
			*(bool**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_spawn;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeDash_Boolean_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220041, XrefRangeEnd = 220044, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
	...
	public class CustomSlimeBossSwapSubroutine : NetworkedSimulationSubroutine
	{
		...
		{
			Il2CppClassPointerStore<CustomSlimeBossSwapSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, "CustomSlimeBossSwapSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeDash_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomSlimeBossSwapSubroutine>.NativeClassPtr, 100683357);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomSlimeBossSwapSubroutine>.NativeClassPtr, 100683358);
		}

		[CallerCount(35)]
		[CachedScanResults(RefRangeStart = 123824, RefRangeEnd = 123859, XrefRangeStart = 123824, XrefRangeEnd = 123859, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomSlimeBossSwapSubroutine(AB_SlimeDash _behaviour, bool _doEnable)
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220044, XrefRangeEnd = 220048, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
	...
	public class CustomDashSubroutine : NetworkedSimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeDash_Byte_0;
		...
		{
			Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, "CustomDashSubroutine");
			...
			NativeFieldInfoPtr_lastSlowPosition = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr, "lastSlowPosition");
			NativeFieldInfoPtr_slowSpawnDistanceSqr = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr, "slowSpawnDistanceSqr");
			...
			NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeDash_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr, 100683359);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr, 100683360);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr, 100683361);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220048, XrefRangeEnd = 220049, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomDashSubroutine(AB_SlimeDash behaviour, byte finishTrigger)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr))
		{
			...
			*(byte**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &finishTrigger;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeDash_Byte_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220049, XrefRangeEnd = 220059, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220059, XrefRangeEnd = 220065, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static AB_SlimeDash()
	{
		Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "AB_SlimeDash");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, "config");
		NativeFieldInfoPtr_currentIndicator = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, "currentIndicator");
		NativeFieldInfoPtr_currentBossMeshSwap = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, "currentBossMeshSwap");
		NativeFieldInfoPtr_slimeBossSwapEnabled = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, "slimeBossSwapEnabled");
		NativeMethodInfoPtr__ctor_Public_Void_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, 100683339);
		NativeMethodInfoPtr_Build_Public_Virtual_Void_Ability_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, 100683340);
		NativeMethodInfoPtr_OnDeactivate_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, 100683341);
		NativeMethodInfoPtr_ClSpawnVisibleIndicator_Public_Virtual_Void_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, 100683342);
		NativeMethodInfoPtr_ClDestroyVisibleIndicator_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, 100683343);
		NativeMethodInfoPtr_SetSlimeBossSwapState_Private_Void_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, 100683344);
		NativeMethodInfoPtr_SpawnHitbox_Public_Void_Vector3_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, 100683345);
		NativeMethodInfoPtr_SpawnSlowArea_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, 100683346);
		NativeMethodInfoPtr_OnSwapEnabledChanged_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, 100683347);
		NativeMethodInfoPtr_OnNetDeserialize_Public_Virtual_Void_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, 100683348);
		NativeMethodInfoPtr_OnNetSerialize_Public_Virtual_Void_NetworkWriter_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, 100683349);
		NativeMethodInfoPtr_OnNetDebugCompare_Public_Virtual_Boolean_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, 100683350);
		NativeMethodInfoPtr_OnNetDebugLog_Public_Virtual_Void_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr, 100683351);
	}
	...
	public unsafe AB_SlimeDash(Config _config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_SlimeDash>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[1];
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220065, XrefRangeEnd = 220294, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220294, XrefRangeEnd = 220299, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220299, XrefRangeEnd = 220322, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220322, XrefRangeEnd = 220327, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(4)]
	[CachedScanResults(RefRangeStart = 220351, RefRangeEnd = 220355, XrefRangeStart = 220327, XrefRangeEnd = 220351, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 220385, RefRangeEnd = 220386, XrefRangeStart = 220355, XrefRangeEnd = 220385, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 220403, RefRangeEnd = 220405, XrefRangeStart = 220386, XrefRangeEnd = 220403, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220405, XrefRangeEnd = 220406, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220406, XrefRangeEnd = 220409, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220409, XrefRangeEnd = 220415, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public AB_SlimeDash(IntPtr pointer)
		: base(pointer)
	{
	}
}
