...
public class FollowTransform : MonoBehaviour
{
	...
	{
		Il2CppClassPointerStore<FollowTransform>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "FollowTransform");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<FollowTransform>.NativeClassPtr);
		NativeFieldInfoPtr__target = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FollowTransform>.NativeClassPtr, "_target");
		NativeMethodInfoPtr_set_Target_Public_set_Void_Transform_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FollowTransform>.NativeClassPtr, 100684802);
		NativeMethodInfoPtr_get_Target_Public_get_Transform_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FollowTransform>.NativeClassPtr, 100684803);
		NativeMethodInfoPtr_LateUpdate_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FollowTransform>.NativeClassPtr, 100684804);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FollowTransform>.NativeClassPtr, 100684805);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 230722, XrefRangeEnd = 230731, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe FollowTransform()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<FollowTransform>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public FollowTransform(IntPtr pointer)
		: base(pointer)
	{
	}
}
