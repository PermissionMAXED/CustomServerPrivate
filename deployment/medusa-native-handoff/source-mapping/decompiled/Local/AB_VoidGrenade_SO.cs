...
public class AB_VoidGrenade_SO : AbilityBehaviourSO
{
	...
	public unsafe AB_VoidGrenade.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<AB_VoidGrenade.Config>(intPtr) : null;
		}
		set
		{
	...
	static AB_VoidGrenade_SO()
	{
		Il2CppClassPointerStore<AB_VoidGrenade_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "AB_VoidGrenade_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_VoidGrenade_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_VoidGrenade_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_AbilityBehaviourConfig_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_VoidGrenade_SO>.NativeClassPtr, 100683327);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_AbilityBehaviour_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_VoidGrenade_SO>.NativeClassPtr, 100683328);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_VoidGrenade_SO>.NativeClassPtr, 100683329);
	}
	...
	public unsafe AB_VoidGrenade_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_VoidGrenade_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public AB_VoidGrenade_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
