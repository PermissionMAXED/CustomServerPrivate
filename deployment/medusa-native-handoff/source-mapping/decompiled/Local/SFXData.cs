...
public class SFXData : Il2CppSystem.Object
{
	...
	static SFXData()
	{
		Il2CppClassPointerStore<SFXData>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "SFXData");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<SFXData>.NativeClassPtr);
		NativeFieldInfoPtr_sfxId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SFXData>.NativeClassPtr, "sfxId");
		NativeFieldInfoPtr_volume = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SFXData>.NativeClassPtr, "volume");
		NativeFieldInfoPtr_randomPitch = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SFXData>.NativeClassPtr, "randomPitch");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SFXData>.NativeClassPtr, 100683580);
	}
