...
public class AB_BrainFreeze_SO : AbilityBehaviourSO
{
	...
	{
		Il2CppClassPointerStore<AB_BrainFreeze_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "AB_BrainFreeze_SO");
		...
		NativeMethodInfoPtr_get_config_Public_Virtual_get_AbilityBehaviourConfig_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_BrainFreeze_SO>.NativeClassPtr, 100683084);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_AbilityBehaviour_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_BrainFreeze_SO>.NativeClassPtr, 100683085);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_BrainFreeze_SO>.NativeClassPtr, 100683086);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 217691, XrefRangeEnd = 217694, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
