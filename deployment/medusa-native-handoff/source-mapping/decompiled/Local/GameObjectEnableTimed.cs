...
public class GameObjectEnableTimed : MonoBehaviour
{
	...
	static GameObjectEnableTimed()
	{
		Il2CppClassPointerStore<GameObjectEnableTimed>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "GameObjectEnableTimed");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<GameObjectEnableTimed>.NativeClassPtr);
		NativeFieldInfoPtr_doSetEnabled = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GameObjectEnableTimed>.NativeClassPtr, "doSetEnabled");
		NativeFieldInfoPtr_ttl = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GameObjectEnableTimed>.NativeClassPtr, "ttl");
		NativeFieldInfoPtr_time = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GameObjectEnableTimed>.NativeClassPtr, "time");
		NativeFieldInfoPtr_done = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GameObjectEnableTimed>.NativeClassPtr, "done");
		NativeFieldInfoPtr_gameObjects = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GameObjectEnableTimed>.NativeClassPtr, "gameObjects");
		NativeMethodInfoPtr_SetTtl_Public_Void_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GameObjectEnableTimed>.NativeClassPtr, 100683990);
		NativeMethodInfoPtr_Play_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GameObjectEnableTimed>.NativeClassPtr, 100683991);
		NativeMethodInfoPtr_OnEnable_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GameObjectEnableTimed>.NativeClassPtr, 100683992);
		NativeMethodInfoPtr_FixedUpdate_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GameObjectEnableTimed>.NativeClassPtr, 100683993);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GameObjectEnableTimed>.NativeClassPtr, 100683994);
	}
	...
	[CallerCount(16)]
	[CachedScanResults(RefRangeStart = 224182, RefRangeEnd = 224198, XrefRangeStart = 224180, XrefRangeEnd = 224182, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 224198, XrefRangeEnd = 224200, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 224200, XrefRangeEnd = 224203, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe GameObjectEnableTimed()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<GameObjectEnableTimed>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public GameObjectEnableTimed(IntPtr pointer)
		: base(pointer)
	{
	}
}
