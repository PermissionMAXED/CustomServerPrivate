...
public class AB_Pistol : AB_Consumable_Base_Spawn
{
	[Serializable]
	public new class Config : AB_Consumable_Base_Spawn.Config
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_Pistol>.NativeClassPtr, "Config");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Config>.NativeClassPtr);
			NativeFieldInfoPtr_passive = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "passive");
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100683237);
		}
	...
	static AB_Pistol()
	{
		Il2CppClassPointerStore<AB_Pistol>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "AB_Pistol");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_Pistol>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_Pistol>.NativeClassPtr, "config");
		NativeMethodInfoPtr__ctor_Public_Void_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Pistol>.NativeClassPtr, 100683235);
		NativeMethodInfoPtr_DoSpawnConsumable_Protected_Virtual_Void_EntityManager_Vector3_Quaternion_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Pistol>.NativeClassPtr, 100683236);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe AB_Pistol(Config _config = null)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_Pistol>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 219289, XrefRangeEnd = 219294, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public AB_Pistol(IntPtr pointer)
		: base(pointer)
	{
	}
}
