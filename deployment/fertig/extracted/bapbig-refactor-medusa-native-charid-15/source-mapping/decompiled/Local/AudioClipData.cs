...
[System.Serializable]
public class AudioClipData : Il2CppSystem.Object
{
	...
	{
		Il2CppClassPointerStore<AudioClipData>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "AudioClipData");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AudioClipData>.NativeClassPtr);
		NativeFieldInfoPtr_audioClip = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AudioClipData>.NativeClassPtr, "audioClip");
		NativeFieldInfoPtr_volume = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AudioClipData>.NativeClassPtr, "volume");
		NativeFieldInfoPtr_pitchSpread = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AudioClipData>.NativeClassPtr, "pitchSpread");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AudioClipData>.NativeClassPtr, 100683579);
	}

	[CallerCount(5410)]
	[CachedScanResults(RefRangeStart = 11, RefRangeEnd = 5421, XrefRangeStart = 11, XrefRangeEnd = 5421, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe AudioClipData()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AudioClipData>.NativeClassPtr))
	{
	...
	public AudioClipData(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
