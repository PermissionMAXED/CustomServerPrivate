...
public class GM_UniqueItemChance_SO : GameModifierSO
{
	...
	public unsafe GM_UniqueItemChance.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<GM_UniqueItemChance.Config>(intPtr) : null;
		}
		set
		{
	...
	static GM_UniqueItemChance_SO()
	{
		Il2CppClassPointerStore<GM_UniqueItemChance_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "GM_UniqueItemChance_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<GM_UniqueItemChance_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GM_UniqueItemChance_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_GameModifierConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GM_UniqueItemChance_SO>.NativeClassPtr, 100683537);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_GameModifier_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GM_UniqueItemChance_SO>.NativeClassPtr, 100683538);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GM_UniqueItemChance_SO>.NativeClassPtr, 100683539);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 221324, XrefRangeEnd = 221327, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe GM_UniqueItemChance_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<GM_UniqueItemChance_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public GM_UniqueItemChance_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
