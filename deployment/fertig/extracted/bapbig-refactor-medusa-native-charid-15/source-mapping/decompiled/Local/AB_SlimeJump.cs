...
public class AB_SlimeJump : AbilityBehaviour
{
	...
	public class Config : AbilityBehaviourConfig
	{
		...
		private static readonly IntPtr NativeFieldInfoPtr_pointWallCollision;
		...
		private static readonly IntPtr NativeFieldInfoPtr_slimeBossSwapPrefab;

		private static readonly IntPtr NativeFieldInfoPtr_slimeBossSwapAnimStartTime;

		private static readonly IntPtr NativeFieldInfoPtr_slimeBossSwapAnimSpeed;
		...
		private static readonly IntPtr NativeFieldInfoPtr_landVoSfx;
		...
		public unsafe bool pointWallCollision
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_pointWallCollision);
				return *(bool*)num;
			}
			set
			{
				*(bool*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_pointWallCollision)) = flag;
			}
		}
		...
		public unsafe GameObject slimeBossSwapPrefab
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_slimeBossSwapPrefab);
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<GameObject>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_slimeBossSwapPrefab)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)gameObject));
			}
		}

		public unsafe float slimeBossSwapAnimStartTime
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_slimeBossSwapAnimStartTime);
				return *(float*)num;
			}
			set
			{
				*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_slimeBossSwapAnimStartTime)) = num;
			}
		}

		public unsafe float slimeBossSwapAnimSpeed
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_slimeBossSwapAnimSpeed);
				return *(float*)num;
			}
			set
			{
				*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_slimeBossSwapAnimSpeed)) = num;
			}
		}
		...
		public unsafe AudioClipData landVoSfx
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_landVoSfx);
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<AudioClipData>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_landVoSfx)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)audioClipData));
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, "Config");
			...
			NativeFieldInfoPtr_pointWallCollision = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "pointWallCollision");
			...
			NativeFieldInfoPtr_slimeBossSwapPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "slimeBossSwapPrefab");
			NativeFieldInfoPtr_slimeBossSwapAnimStartTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "slimeBossSwapAnimStartTime");
			NativeFieldInfoPtr_slimeBossSwapAnimSpeed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "slimeBossSwapAnimSpeed");
			...
			NativeFieldInfoPtr_landVoSfx = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "landVoSfx");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100683377);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220418, XrefRangeEnd = 220423, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomLockCastAimSubroutine : NetworkedSimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeJump_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0;

		public unsafe AB_SlimeJump behaviour
		{
			get
			{
				...
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<AB_SlimeJump>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_behaviour)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)aB_SlimeJump));
			}
		}
		...
		static CustomLockCastAimSubroutine()
		{
			Il2CppClassPointerStore<CustomLockCastAimSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, "CustomLockCastAimSubroutine");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CustomLockCastAimSubroutine>.NativeClassPtr);
			NativeFieldInfoPtr_behaviour = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomLockCastAimSubroutine>.NativeClassPtr, "behaviour");
			NativeFieldInfoPtr_hit = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomLockCastAimSubroutine>.NativeClassPtr, "hit");
			NativeFieldInfoPtr_obstacleMask = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomLockCastAimSubroutine>.NativeClassPtr, "obstacleMask");
			NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeJump_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomLockCastAimSubroutine>.NativeClassPtr, 100683378);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomLockCastAimSubroutine>.NativeClassPtr, 100683379);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220423, XrefRangeEnd = 220427, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomLockCastAimSubroutine(AB_SlimeJump _behaviour)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomLockCastAimSubroutine>.NativeClassPtr))
		{
			IntPtr* ptr = stackalloc IntPtr[1];
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_behaviour);
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeJump_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220427, XrefRangeEnd = 220453, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		public CustomLockCastAimSubroutine(IntPtr pointer)
			: base(pointer)
		{
		}
	}
	...
	public class CustomSlimeBossSwapSubroutine : NetworkedSimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeJump_Boolean_0;
		...
		static CustomSlimeBossSwapSubroutine()
		{
			Il2CppClassPointerStore<CustomSlimeBossSwapSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, "CustomSlimeBossSwapSubroutine");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CustomSlimeBossSwapSubroutine>.NativeClassPtr);
			NativeFieldInfoPtr_behaviour = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomSlimeBossSwapSubroutine>.NativeClassPtr, "behaviour");
			NativeFieldInfoPtr_doEnable = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomSlimeBossSwapSubroutine>.NativeClassPtr, "doEnable");
			NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeJump_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomSlimeBossSwapSubroutine>.NativeClassPtr, 100683380);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomSlimeBossSwapSubroutine>.NativeClassPtr, 100683381);
		}
		...
		public unsafe CustomSlimeBossSwapSubroutine(AB_SlimeJump _behaviour, bool _doEnable)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomSlimeBossSwapSubroutine>.NativeClassPtr))
		{
			IntPtr* ptr = stackalloc IntPtr[2];
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_behaviour);
			*(bool**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_doEnable;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeJump_Boolean_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220453, XrefRangeEnd = 220456, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
		...
		public CustomSlimeBossSwapSubroutine(IntPtr pointer)
			: base(pointer)
		{
		}
	}
	...
	public class CustomVisibleIndicatorSubroutine : NetworkedSimulationSubroutine
	{
		...
		{
			Il2CppClassPointerStore<CustomVisibleIndicatorSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, "CustomVisibleIndicatorSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeJump_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomVisibleIndicatorSubroutine>.NativeClassPtr, 100683382);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomVisibleIndicatorSubroutine>.NativeClassPtr, 100683383);
		}

		[CallerCount(35)]
		[CachedScanResults(RefRangeStart = 123824, RefRangeEnd = 123859, XrefRangeStart = 123824, XrefRangeEnd = 123859, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomVisibleIndicatorSubroutine(AB_SlimeJump _behaviour, bool _spawn)
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220456, XrefRangeEnd = 220459, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
	...
	public class CustomJumpSubroutine : NetworkedSimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeJump_Byte_0;
		...
		public unsafe Vector3 landingPosition
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_landingPosition);
				return *(Vector3*)num;
			}
			set
			{
				*(Vector3*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_landingPosition)) = vector;
			}
		}

		static CustomJumpSubroutine()
		{
			Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, "CustomJumpSubroutine");
			...
			NativeFieldInfoPtr_hit = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, "hit");
			NativeFieldInfoPtr_obstacleMask = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, "obstacleMask");
			...
			NativeFieldInfoPtr_landingPosition = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, "landingPosition");
			NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeJump_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100683384);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100683385);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100683386);
			NativeMethodInfoPtr_OnExit_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100683387);
			NativeMethodInfoPtr_OnNetDeserialize_Public_Virtual_Void_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100683388);
			NativeMethodInfoPtr_OnNetSerialize_Public_Virtual_Void_NetworkWriter_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100683389);
			NativeMethodInfoPtr_OnNetDebugCompare_Public_Virtual_Boolean_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100683390);
			NativeMethodInfoPtr_OnNetDebugLog_Public_Virtual_Void_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100683391);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220459, XrefRangeEnd = 220463, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomJumpSubroutine(AB_SlimeJump _behaviour, byte _trigger)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr))
		{
			...
			*(byte**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_trigger;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_AB_SlimeJump_Byte_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220463, XrefRangeEnd = 220495, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220495, XrefRangeEnd = 220500, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220500, XrefRangeEnd = 220505, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220505, XrefRangeEnd = 220508, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220508, XrefRangeEnd = 220511, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220511, XrefRangeEnd = 220514, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220514, XrefRangeEnd = 220530, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	private static readonly IntPtr NativeFieldInfoPtr_lockCastAimPos;
	...
	private static readonly IntPtr NativeFieldInfoPtr_slimeBossSwapEnabled;
	...
	private static readonly IntPtr NativeMethodInfoPtr_SetSlimeBossSwapState_Private_Void_Boolean_0;

	private static readonly IntPtr NativeMethodInfoPtr_SpawnLandingHitbox_Public_Void_Vector3_Int32_0;
	...
	public unsafe Vector3 lockCastAimPos
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_lockCastAimPos);
			return *(Vector3*)num;
		}
		set
		{
			*(Vector3*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_lockCastAimPos)) = vector;
		}
	}
	...
	public unsafe bool slimeBossSwapEnabled
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_slimeBossSwapEnabled);
			return *(bool*)num;
		}
		set
		{
			*(bool*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_slimeBossSwapEnabled)) = flag;
		}
	}

	static AB_SlimeJump()
	{
		Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "AB_SlimeJump");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, "config");
		NativeFieldInfoPtr_lockCastAimPos = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, "lockCastAimPos");
		NativeFieldInfoPtr_currentIndicator = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, "currentIndicator");
		NativeFieldInfoPtr_currentBossMeshSwap = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, "currentBossMeshSwap");
		NativeFieldInfoPtr_slimeBossSwapEnabled = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, "slimeBossSwapEnabled");
		NativeMethodInfoPtr__ctor_Public_Void_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, 100683365);
		NativeMethodInfoPtr_Build_Public_Virtual_Void_Ability_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, 100683366);
		NativeMethodInfoPtr_OnDeactivate_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, 100683367);
		NativeMethodInfoPtr_ClSpawnVisibleIndicator_Public_Virtual_Void_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, 100683368);
		NativeMethodInfoPtr_ClDestroyVisibleIndicator_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, 100683369);
		NativeMethodInfoPtr_SetSlimeBossSwapState_Private_Void_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, 100683370);
		NativeMethodInfoPtr_SpawnLandingHitbox_Public_Void_Vector3_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, 100683371);
		NativeMethodInfoPtr_OnSwapEnabledChanged_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, 100683372);
		NativeMethodInfoPtr_OnNetDeserialize_Public_Virtual_Void_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, 100683373);
		NativeMethodInfoPtr_OnNetSerialize_Public_Virtual_Void_NetworkWriter_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, 100683374);
		NativeMethodInfoPtr_OnNetDebugCompare_Public_Virtual_Boolean_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, 100683375);
		NativeMethodInfoPtr_OnNetDebugLog_Public_Virtual_Void_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr, 100683376);
	}
	...
	public unsafe AB_SlimeJump(Config _config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_SlimeJump>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[1];
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220530, XrefRangeEnd = 220731, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220731, XrefRangeEnd = 220736, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220736, XrefRangeEnd = 220756, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe override void ClSpawnVisibleIndicator(Vector3 position)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[1];
		*ptr = (nint)(&position);
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220756, XrefRangeEnd = 220761, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(4)]
	[CachedScanResults(RefRangeStart = 220785, RefRangeEnd = 220789, XrefRangeStart = 220761, XrefRangeEnd = 220785, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void SetSlimeBossSwapState(bool isEnabled)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[1];
		*ptr = (nint)(&isEnabled);
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_SetSlimeBossSwapState_Private_Void_Boolean_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 220810, RefRangeEnd = 220811, XrefRangeStart = 220789, XrefRangeEnd = 220810, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void SpawnLandingHitbox(Vector3 landingPoint, int predTickNum)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[2];
		...
		*(int**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &predTickNum;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_SpawnLandingHitbox_Public_Void_Vector3_Int32_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220811, XrefRangeEnd = 220812, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220812, XrefRangeEnd = 220815, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe override void OnNetDeserialize(NetworkReader netReader)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[1];
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 220815, XrefRangeEnd = 220821, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe override void OnNetDebugLog(StringBuilder sb)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[1];
	...
	public AB_SlimeJump(IntPtr pointer)
		: base(pointer)
	{
	}
}
