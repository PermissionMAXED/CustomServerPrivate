...
public class AB_Explosive_C4_SO : AbilityBehaviourSO
{
	...
	public unsafe AB_Explosive_C4.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<AB_Explosive_C4.Config>(intPtr) : null;
		}
		set
		{
	...
	static AB_Explosive_C4_SO()
	{
		Il2CppClassPointerStore<AB_Explosive_C4_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Local", "AB_Explosive_C4_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_Explosive_C4_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_Explosive_C4_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_AbilityBehaviourConfig_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Explosive_C4_SO>.NativeClassPtr, 100683102);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_AbilityBehaviour_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Explosive_C4_SO>.NativeClassPtr, 100683103);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_Explosive_C4_SO>.NativeClassPtr, 100683104);
	}
	...
	public unsafe AB_Explosive_C4_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_Explosive_C4_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public AB_Explosive_C4_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
