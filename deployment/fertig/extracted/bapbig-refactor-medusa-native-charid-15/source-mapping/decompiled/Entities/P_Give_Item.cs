...
public class P_Give_Item : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		public unsafe Item itemToGive
		{
			...
			set
			{
				...
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_itemToGive)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)item));
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_Give_Item>.NativeClassPtr, "Config");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Config>.NativeClassPtr);
			NativeFieldInfoPtr_itemToGive = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "itemToGive");
			NativeFieldInfoPtr_allowDuplicates = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "allowDuplicates");
			NativeFieldInfoPtr_vfxLoopPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "vfxLoopPrefab");
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677229);
		}
	...
	static P_Give_Item()
	{
		Il2CppClassPointerStore<P_Give_Item>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_Give_Item");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_Give_Item>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Give_Item>.NativeClassPtr, "config");
		NativeFieldInfoPtr_vfxLoopId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Give_Item>.NativeClassPtr, "vfxLoopId");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Give_Item>.NativeClassPtr, 100677224);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Give_Item>.NativeClassPtr, 100677225);
		NativeMethodInfoPtr_ActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Give_Item>.NativeClassPtr, 100677226);
		NativeMethodInfoPtr_ClActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Give_Item>.NativeClassPtr, 100677227);
		NativeMethodInfoPtr_ClDeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Give_Item>.NativeClassPtr, 100677228);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 176365, XrefRangeEnd = 176369, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_Give_Item(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_Give_Item>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 176369, XrefRangeEnd = 176383, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_Give_Item(IntPtr pointer)
		: base(pointer)
	{
	}
}
