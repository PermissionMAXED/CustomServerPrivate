...
public class EntityActivateDamageSelf : EntityActivateBase
{
	...
	static EntityActivateDamageSelf()
	{
		Il2CppClassPointerStore<EntityActivateDamageSelf>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "EntityActivateDamageSelf");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<EntityActivateDamageSelf>.NativeClassPtr);
		NativeFieldInfoPtr_charHurtbox = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EntityActivateDamageSelf>.NativeClassPtr, "charHurtbox");
		NativeFieldInfoPtr_dmg = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EntityActivateDamageSelf>.NativeClassPtr, "dmg");
		NativeMethodInfoPtr_Activate_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EntityActivateDamageSelf>.NativeClassPtr, 100681629);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EntityActivateDamageSelf>.NativeClassPtr, 100681630);
		NativeMethodInfoPtr_Weaved_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EntityActivateDamageSelf>.NativeClassPtr, 100681631);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 206103, XrefRangeEnd = 206107, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe EntityActivateDamageSelf()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<EntityActivateDamageSelf>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public EntityActivateDamageSelf(IntPtr pointer)
		: base(pointer)
	{
	}
}
