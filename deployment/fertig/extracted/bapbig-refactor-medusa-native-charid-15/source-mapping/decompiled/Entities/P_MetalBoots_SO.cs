...
public class P_MetalBoots_SO : PassiveSO
{
	...
	public unsafe P_MetalBoots.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<P_MetalBoots.Config>(intPtr) : null;
		}
		set
		{
	...
	static P_MetalBoots_SO()
	{
		Il2CppClassPointerStore<P_MetalBoots_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_MetalBoots_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_MetalBoots_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_MetalBoots_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_MetalBoots_SO>.NativeClassPtr, 100677247);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_Passive_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_MetalBoots_SO>.NativeClassPtr, 100677248);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_MetalBoots_SO>.NativeClassPtr, 100677249);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 176427, XrefRangeEnd = 176430, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe P_MetalBoots_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_MetalBoots_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public P_MetalBoots_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
