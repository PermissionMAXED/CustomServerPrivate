...
public class AB_MoveDash : AbilityBehaviour
{
	...
	public class Config : AbilityBehaviourConfig
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_MoveDash>.NativeClassPtr, "Config");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100675358);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 161364, XrefRangeEnd = 161365, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomDashSubroutine : NetworkedSimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_AB_MoveDash_Byte_Single_0;
		...
		public unsafe AB_MoveDash behaviour
		{
			get
			{
				...
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<AB_MoveDash>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_behaviour)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)aB_MoveDash));
			}
		}
		...
		{
			Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_MoveDash>.NativeClassPtr, "CustomDashSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_AB_MoveDash_Byte_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr, 100675359);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr, 100675360);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr, 100675361);
			NativeMethodInfoPtr_OnNetDeserialize_Public_Virtual_Void_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr, 100675362);
			NativeMethodInfoPtr_OnNetSerialize_Public_Virtual_Void_NetworkWriter_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr, 100675363);
			NativeMethodInfoPtr_OnNetDebugCompare_Public_Virtual_Boolean_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr, 100675364);
			NativeMethodInfoPtr_OnNetDebugLog_Public_Virtual_Void_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr, 100675365);
		}
		...
		public unsafe CustomDashSubroutine(AB_MoveDash behaviour, byte trigger, float dashTime)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomDashSubroutine>.NativeClassPtr))
		{
			...
			*(float**)((byte*)ptr + checked((nuint)2u * unchecked((nuint)sizeof(IntPtr)))) = &dashTime;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_AB_MoveDash_Byte_Single_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 161365, XrefRangeEnd = 161382, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 161382, XrefRangeEnd = 161387, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static AB_MoveDash()
	{
		Il2CppClassPointerStore<AB_MoveDash>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "AB_MoveDash");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_MoveDash>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_MoveDash>.NativeClassPtr, "config");
		NativeMethodInfoPtr__ctor_Public_Void_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_MoveDash>.NativeClassPtr, 100675356);
		NativeMethodInfoPtr_Build_Public_Virtual_Void_Ability_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_MoveDash>.NativeClassPtr, 100675357);
	}
	...
	public unsafe AB_MoveDash(Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_MoveDash>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[1];
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 161387, XrefRangeEnd = 161430, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public AB_MoveDash(IntPtr pointer)
		: base(pointer)
	{
	}
}
