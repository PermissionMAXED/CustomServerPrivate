...
public class P_Debuff_Bleed : Passive
{
	...
	{
		private static readonly IntPtr NativeFieldInfoPtr_bleedDuration;

		private static readonly IntPtr NativeFieldInfoPtr_bloodSpawnDistance;

		private static readonly IntPtr NativeFieldInfoPtr_puddle;
		...
		public unsafe float bleedDuration
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_bleedDuration);
				return *(float*)num;
			}
			set
			{
				*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_bleedDuration)) = num;
			}
		}
		...
		public unsafe GameObject puddle
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_puddle);
			...
			set
			{
				...
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_puddle)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)gameObject));
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_Debuff_Bleed>.NativeClassPtr, "Config");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Config>.NativeClassPtr);
			NativeFieldInfoPtr_bleedDuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "bleedDuration");
			...
			NativeFieldInfoPtr_puddle = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "puddle");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677115);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175948, XrefRangeEnd = 175949, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomPassiveSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_P_Debuff_Bleed_0;
		...
		public unsafe P_Debuff_Bleed passive
		{
			get
			{
				...
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<P_Debuff_Bleed>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_passive)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)p_Debuff_Bleed));
			}
		}

		static CustomPassiveSubroutine()
		{
			Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_Debuff_Bleed>.NativeClassPtr, "CustomPassiveSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_P_Debuff_Bleed_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677116);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677117);
			NativeMethodInfoPtr_OnExit_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677118);
		}
		...
		public unsafe CustomPassiveSubroutine(P_Debuff_Bleed _ability)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr))
		{
			...
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_ability);
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_P_Debuff_Bleed_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175949, XrefRangeEnd = 175955, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	private static readonly IntPtr NativeFieldInfoPtr_lastTrailPosition;

	private static readonly IntPtr NativeFieldInfoPtr_trailSpawnDistanceSqr;
	...
	private static readonly IntPtr NativeMethodInfoPtr_SpawnTrailArea_Public_Void_0;
	...
	static P_Debuff_Bleed()
	{
		Il2CppClassPointerStore<P_Debuff_Bleed>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_Debuff_Bleed");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_Debuff_Bleed>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Debuff_Bleed>.NativeClassPtr, "config");
		NativeFieldInfoPtr_lastTrailPosition = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Debuff_Bleed>.NativeClassPtr, "lastTrailPosition");
		NativeFieldInfoPtr_trailSpawnDistanceSqr = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Debuff_Bleed>.NativeClassPtr, "trailSpawnDistanceSqr");
		NativeFieldInfoPtr_cooldownSubroutine = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Debuff_Bleed>.NativeClassPtr, "cooldownSubroutine");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Debuff_Bleed>.NativeClassPtr, 100677109);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Debuff_Bleed>.NativeClassPtr, 100677110);
		NativeMethodInfoPtr_Reactivate_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Debuff_Bleed>.NativeClassPtr, 100677111);
		NativeMethodInfoPtr_SpawnTrailArea_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Debuff_Bleed>.NativeClassPtr, 100677112);
		NativeMethodInfoPtr_ActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Debuff_Bleed>.NativeClassPtr, 100677113);
		NativeMethodInfoPtr_DeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Debuff_Bleed>.NativeClassPtr, 100677114);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 175971, RefRangeEnd = 175972, XrefRangeStart = 175955, XrefRangeEnd = 175971, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_Debuff_Bleed(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_Debuff_Bleed>.NativeClassPtr))
	{
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 175996, RefRangeEnd = 175997, XrefRangeStart = 175972, XrefRangeEnd = 175996, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void SpawnTrailArea()
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_SpawnTrailArea_Public_Void_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175997, XrefRangeEnd = 176001, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 176001, XrefRangeEnd = 176005, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_Debuff_Bleed(IntPtr pointer)
		: base(pointer)
	{
	}
}
