...
public class AB_SpawnHitbox_Base : AB_Use_Base
{
	...
	public new class Config : AB_Use_Base.Config
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_SpawnHitbox_Base>.NativeClassPtr, "Config");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100675416);
		}
	...
	static AB_SpawnHitbox_Base()
	{
		Il2CppClassPointerStore<AB_SpawnHitbox_Base>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "AB_SpawnHitbox_Base");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_SpawnHitbox_Base>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_SpawnHitbox_Base>.NativeClassPtr, "config");
		NativeMethodInfoPtr__ctor_Public_Void_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SpawnHitbox_Base>.NativeClassPtr, 100675414);
		NativeMethodInfoPtr_DoUse_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_SpawnHitbox_Base>.NativeClassPtr, 100675415);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe AB_SpawnHitbox_Base(Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_SpawnHitbox_Base>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 161759, XrefRangeEnd = 161782, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public AB_SpawnHitbox_Base(IntPtr pointer)
		: base(pointer)
	{
	}
}
