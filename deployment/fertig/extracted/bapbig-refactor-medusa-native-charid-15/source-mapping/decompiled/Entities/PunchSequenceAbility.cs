...
public class PunchSequenceAbility : Ability
{
	public class CustomShootSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_PunchSequenceAbility_Int32_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0;

		public unsafe PunchSequenceAbility ability
		{
			get
			{
				...
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<PunchSequenceAbility>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_ability)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)punchSequenceAbility));
			}
		}
		...
		{
			Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "CustomShootSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_PunchSequenceAbility_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr, 100673444);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr, 100673445);
		}

		[CallerCount(110)]
		[CachedScanResults(RefRangeStart = 129576, RefRangeEnd = 129686, XrefRangeStart = 129575, XrefRangeEnd = 129576, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomShootSubroutine(PunchSequenceAbility _ability, int _attackId)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr))
		{
			...
			*(int**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_attackId;
			...
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_PunchSequenceAbility_Int32_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 129686, XrefRangeEnd = 129695, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	private static readonly IntPtr NativeFieldInfoPtr_spellPunch3Prefab;
	...
	private static readonly IntPtr NativeFieldInfoPtr_heavyPunchAbility;
	...
	public unsafe GameObject spellPunch3Prefab
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_spellPunch3Prefab);
			IntPtr intPtr = *(IntPtr*)num;
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<GameObject>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_spellPunch3Prefab)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)gameObject));
		}
	}
	...
	public unsafe HeavyPunchAbility heavyPunchAbility
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_heavyPunchAbility);
			IntPtr intPtr = *(IntPtr*)num;
		...
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_heavyPunchAbility)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)heavyPunchAbility));
		}
	}

	static PunchSequenceAbility()
	{
		Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "PunchSequenceAbility");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr);
		NativeFieldInfoPtr_spellPunch1Prefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "spellPunch1Prefab");
		NativeFieldInfoPtr_spellPunch2Prefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "spellPunch2Prefab");
		NativeFieldInfoPtr_spellPunch3Prefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "spellPunch3Prefab");
		NativeFieldInfoPtr_firingPoint = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "firingPoint");
		NativeFieldInfoPtr_castMotionLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "castMotionLockType");
		NativeFieldInfoPtr_applyAtkSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "applyAtkSpeedMultiplier");
		NativeFieldInfoPtr_applyCooldownMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "applyCooldownMultiplier");
		NativeFieldInfoPtr_inputType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "inputType");
		NativeFieldInfoPtr_damage1 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "damage1");
		NativeFieldInfoPtr_damage1Scaling = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "damage1Scaling");
		NativeFieldInfoPtr_ttl1 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "ttl1");
		NativeFieldInfoPtr_damage2 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "damage2");
		NativeFieldInfoPtr_damage2Scaling = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "damage2Scaling");
		NativeFieldInfoPtr_ttl2 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "ttl2");
		NativeFieldInfoPtr_damage3 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "damage3");
		NativeFieldInfoPtr_damage3Scaling = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "damage3Scaling");
		NativeFieldInfoPtr_ttl3 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "ttl3");
		NativeFieldInfoPtr_statusEffects = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "statusEffects");
		NativeFieldInfoPtr_castingTime1 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "castingTime1");
		NativeFieldInfoPtr_recoveryTime1 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "recoveryTime1");
		NativeFieldInfoPtr_cooldownTime1 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "cooldownTime1");
		NativeFieldInfoPtr_castingTime2 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "castingTime2");
		NativeFieldInfoPtr_recoveryTime2 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "recoveryTime2");
		NativeFieldInfoPtr_cooldownTime2 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "cooldownTime2");
		NativeFieldInfoPtr_castingTime3 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "castingTime3");
		NativeFieldInfoPtr_recoveryTime3 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "recoveryTime3");
		NativeFieldInfoPtr_baseCooldownTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "baseCooldownTime");
		NativeFieldInfoPtr_comboResetTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "comboResetTime");
		NativeFieldInfoPtr_vfxCast1Prefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "vfxCast1Prefab");
		NativeFieldInfoPtr_vfxCast2Prefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "vfxCast2Prefab");
		NativeFieldInfoPtr_sfxCast1 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "sfxCast1");
		NativeFieldInfoPtr_sfxCast2 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "sfxCast2");
		NativeFieldInfoPtr_animLayer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "animLayer");
		NativeFieldInfoPtr_heavyPunchAbility = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, "heavyPunchAbility");
		NativeMethodInfoPtr_PreAwake_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, 100673437);
		NativeMethodInfoPtr_DoPunch_Private_Void_Vector3_GameObject_Int32_Single_Single_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, 100673438);
		NativeMethodInfoPtr_OnTargetHit_Public_Virtual_Void_EntityManager_HitboxBase_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, 100673439);
		NativeMethodInfoPtr_GetTooltipDescription_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, 100673440);
		NativeMethodInfoPtr_GetTooltipExpandedDescription_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, 100673441);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, 100673442);
		NativeMethodInfoPtr_Weaved_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr, 100673443);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 129695, XrefRangeEnd = 130017, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 130049, RefRangeEnd = 130050, XrefRangeStart = 130017, XrefRangeEnd = 130049, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130050, XrefRangeEnd = 130063, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130063, XrefRangeEnd = 130067, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130067, XrefRangeEnd = 130071, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130071, XrefRangeEnd = 130076, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe PunchSequenceAbility()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PunchSequenceAbility>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public PunchSequenceAbility(IntPtr pointer)
		: base(pointer)
	{
	}
}
