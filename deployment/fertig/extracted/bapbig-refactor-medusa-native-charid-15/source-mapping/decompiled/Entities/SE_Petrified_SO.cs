...
public class SE_Petrified_SO : StatusEffectSO
{
	...
	public unsafe SE_Petrified.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<SE_Petrified.Config>(intPtr) : null;
		}
		set
		{
	...
	static SE_Petrified_SO()
	{
		Il2CppClassPointerStore<SE_Petrified_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "SE_Petrified_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<SE_Petrified_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SE_Petrified_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_StatusEffectConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SE_Petrified_SO>.NativeClassPtr, 100678546);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_StatusEffect_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SE_Petrified_SO>.NativeClassPtr, 100678547);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SE_Petrified_SO>.NativeClassPtr, 100678548);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 181766, XrefRangeEnd = 181769, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe SE_Petrified_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<SE_Petrified_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public SE_Petrified_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
