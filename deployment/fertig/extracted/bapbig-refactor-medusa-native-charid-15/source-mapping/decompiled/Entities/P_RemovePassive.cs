...
public class P_RemovePassive : NetworkedSimulationSubroutine
{
	...
	private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_Passive_0;
	...
	static P_RemovePassive()
	{
		Il2CppClassPointerStore<P_RemovePassive>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_RemovePassive");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_RemovePassive>.NativeClassPtr);
		NativeFieldInfoPtr_passive = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_RemovePassive>.NativeClassPtr, "passive");
		NativeMethodInfoPtr__ctor_Public_Void_Passive_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_RemovePassive>.NativeClassPtr, 100678212);
		NativeMethodInfoPtr_OnExit_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_RemovePassive>.NativeClassPtr, 100678213);
	}
	...
	public unsafe P_RemovePassive(Passive passive)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_RemovePassive>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[1];
		*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)passive);
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_Passive_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
	...
	public P_RemovePassive(IntPtr pointer)
		: base(pointer)
	{
	}
}
