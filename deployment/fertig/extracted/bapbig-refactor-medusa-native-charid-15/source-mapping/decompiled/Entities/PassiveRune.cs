...
public class PassiveRune : InteractableStation
{
	...
	private static readonly IntPtr NativeFieldInfoPtr_purchasePrice;
	...
	public unsafe int purchasePrice
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_purchasePrice);
			return *(int*)num;
		}
		set
		{
			*(int*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_purchasePrice)) = num;
		}
	}

	static PassiveRune()
	{
		Il2CppClassPointerStore<PassiveRune>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "PassiveRune");
		NativeFieldInfoPtr_passivePool = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PassiveRune>.NativeClassPtr, "passivePool");
		NativeFieldInfoPtr_purchasePrice = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PassiveRune>.NativeClassPtr, "purchasePrice");
		NativeMethodInfoPtr_Start_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PassiveRune>.NativeClassPtr, 100680225);
		NativeMethodInfoPtr_Localise_Public_Void_Translator_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PassiveRune>.NativeClassPtr, 100680226);
		NativeMethodInfoPtr_UIShowInvalidWindow_Public_Virtual_Void_InteractableCollider_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PassiveRune>.NativeClassPtr, 100680227);
		NativeMethodInfoPtr_UIShowValidWindow_Public_Virtual_Void_InteractableCollider_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PassiveRune>.NativeClassPtr, 100680228);
		NativeMethodInfoPtr_TryUseStation_Public_Virtual_Boolean_EntityManager_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PassiveRune>.NativeClassPtr, 100680229);
		NativeMethodInfoPtr_AbleToUseStation_Public_Virtual_Boolean_EntityManager_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PassiveRune>.NativeClassPtr, 100680230);
		NativeMethodInfoPtr_RpcOnUseFail_Public_Virtual_Void_EntityManager_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PassiveRune>.NativeClassPtr, 100680231);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PassiveRune>.NativeClassPtr, 100680232);
		NativeMethodInfoPtr_Weaved_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PassiveRune>.NativeClassPtr, 100680233);
		NativeMethodInfoPtr_UserCode_RpcOnUseFail__EntityManager__Int32_Protected_Virtual_Void_EntityManager_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PassiveRune>.NativeClassPtr, 100680234);
		NativeMethodInfoPtr_InvokeUserCode_RpcOnUseFail__EntityManager__Int32_Protected_Static_Void_NetworkBehaviour_NetworkReader_NetworkConnectionToClient_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PassiveRune>.NativeClassPtr, 100680235);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 195001, XrefRangeEnd = 195004, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 195004, XrefRangeEnd = 195016, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 195016, XrefRangeEnd = 195033, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 195033, XrefRangeEnd = 195037, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 195037, XrefRangeEnd = 195048, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 195048, XrefRangeEnd = 195051, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe PassiveRune()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PassiveRune>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 195051, XrefRangeEnd = 195060, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public PassiveRune(IntPtr pointer)
		: base(pointer)
	{
	}
}
