...
public class WaitSubroutine : NetworkedSimulationSubroutine
{
	...
	private static readonly IntPtr NativeMethodInfoPtr_SetWaitTime_Public_Void_Single_0;
	...
	static WaitSubroutine()
	{
		Il2CppClassPointerStore<WaitSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "WaitSubroutine");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<WaitSubroutine>.NativeClassPtr);
		NativeFieldInfoPtr_ability = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<WaitSubroutine>.NativeClassPtr, "ability");
		NativeFieldInfoPtr_trigger = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<WaitSubroutine>.NativeClassPtr, "trigger");
		NativeFieldInfoPtr_waitTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<WaitSubroutine>.NativeClassPtr, "waitTime");
		NativeFieldInfoPtr_timeElapsed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<WaitSubroutine>.NativeClassPtr, "timeElapsed");
		NativeMethodInfoPtr__ctor_Public_Void_Ability_Byte_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitSubroutine>.NativeClassPtr, 100675151);
		NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitSubroutine>.NativeClassPtr, 100675152);
		NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitSubroutine>.NativeClassPtr, 100675153);
		NativeMethodInfoPtr_SetWaitTime_Public_Void_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitSubroutine>.NativeClassPtr, 100675154);
		NativeMethodInfoPtr_OnNetDeserialize_Public_Virtual_Void_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitSubroutine>.NativeClassPtr, 100675155);
		NativeMethodInfoPtr_OnNetSerialize_Public_Virtual_Void_NetworkWriter_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitSubroutine>.NativeClassPtr, 100675156);
		NativeMethodInfoPtr_OnNetDebugCompare_Public_Virtual_Boolean_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitSubroutine>.NativeClassPtr, 100675157);
		NativeMethodInfoPtr_OnNetDebugLog_Public_Virtual_Void_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitSubroutine>.NativeClassPtr, 100675158);
	}
	...
	public unsafe WaitSubroutine(Ability ability, byte trigger, float waitTime)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<WaitSubroutine>.NativeClassPtr))
	{
	...
	public unsafe void SetWaitTime(float wt)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[1];
		*ptr = (nint)(&wt);
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_SetWaitTime_Public_Void_Single_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 158620, XrefRangeEnd = 158627, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public WaitSubroutine(IntPtr pointer)
		: base(pointer)
	{
	}
}
