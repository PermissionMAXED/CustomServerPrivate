...
public class SE_Rooted_SO : StatusEffectSO
{
	...
	public unsafe SE_Rooted.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<SE_Rooted.Config>(intPtr) : null;
		}
		set
		{
	...
	static SE_Rooted_SO()
	{
		Il2CppClassPointerStore<SE_Rooted_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "SE_Rooted_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<SE_Rooted_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SE_Rooted_SO>.NativeClassPtr, "configuration");
		NativeFieldInfoPtr_Id = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SE_Rooted_SO>.NativeClassPtr, "Id");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_StatusEffectConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SE_Rooted_SO>.NativeClassPtr, 100678616);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_StatusEffect_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SE_Rooted_SO>.NativeClassPtr, 100678617);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SE_Rooted_SO>.NativeClassPtr, 100678618);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 182067, XrefRangeEnd = 182070, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe SE_Rooted_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<SE_Rooted_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public SE_Rooted_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
