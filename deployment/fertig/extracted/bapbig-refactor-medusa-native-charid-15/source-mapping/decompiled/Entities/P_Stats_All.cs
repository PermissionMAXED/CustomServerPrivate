...
public class P_Stats_All : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_Stats_All>.NativeClassPtr, "Config");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Config>.NativeClassPtr);
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100678053);
		}

		[CallerCount(113)]
		[CachedScanResults(RefRangeStart = 179342, RefRangeEnd = 179455, XrefRangeStart = 179341, XrefRangeEnd = 179342, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static P_Stats_All()
	{
		Il2CppClassPointerStore<P_Stats_All>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_Stats_All");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_Stats_All>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Stats_All>.NativeClassPtr, "config");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Stats_All>.NativeClassPtr, 100678051);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Stats_All>.NativeClassPtr, 100678052);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_Stats_All(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_Stats_All>.NativeClassPtr))
	{
	...
	public P_Stats_All(IntPtr pointer)
		: base(pointer)
	{
	}
}
