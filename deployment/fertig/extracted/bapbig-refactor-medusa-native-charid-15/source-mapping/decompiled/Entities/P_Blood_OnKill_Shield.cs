...
public class P_Blood_OnKill_Shield : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_Blood_OnKill_Shield>.NativeClassPtr, "Config");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100676980);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175670, XrefRangeEnd = 175672, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static P_Blood_OnKill_Shield()
	{
		Il2CppClassPointerStore<P_Blood_OnKill_Shield>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_Blood_OnKill_Shield");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_Blood_OnKill_Shield>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Blood_OnKill_Shield>.NativeClassPtr, "config");
		NativeFieldInfoPtr_vfxReadyId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Blood_OnKill_Shield>.NativeClassPtr, "vfxReadyId");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Shield>.NativeClassPtr, 100676971);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Shield>.NativeClassPtr, 100676972);
		NativeMethodInfoPtr_GetValue_Public_Virtual_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Shield>.NativeClassPtr, 100676973);
		NativeMethodInfoPtr_GetPassiveName_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Shield>.NativeClassPtr, 100676974);
		NativeMethodInfoPtr_OnKillTrigger_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Shield>.NativeClassPtr, 100676975);
		NativeMethodInfoPtr_ActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Shield>.NativeClassPtr, 100676976);
		NativeMethodInfoPtr_DeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Shield>.NativeClassPtr, 100676977);
		NativeMethodInfoPtr_ClActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Shield>.NativeClassPtr, 100676978);
		NativeMethodInfoPtr_ClDeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_Shield>.NativeClassPtr, 100676979);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175672, XrefRangeEnd = 175676, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_Blood_OnKill_Shield(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_Blood_OnKill_Shield>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175676, XrefRangeEnd = 175678, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175678, XrefRangeEnd = 175680, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175680, XrefRangeEnd = 175682, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_Blood_OnKill_Shield(IntPtr pointer)
		: base(pointer)
	{
	}
}
