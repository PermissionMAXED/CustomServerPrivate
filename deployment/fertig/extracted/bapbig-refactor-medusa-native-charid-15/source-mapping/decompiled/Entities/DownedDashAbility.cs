...
public class DownedDashAbility : Ability
{
	public class CustomTeleportLerpSubroutine : NetworkedSimulationSubroutine
	{
		...
		private static readonly IntPtr NativeFieldInfoPtr_adjustedTime;
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_DownedDashAbility_Byte_Single_0;
		...
		public unsafe DownedDashAbility ability
		{
			get
			{
				...
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<DownedDashAbility>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_ability)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)downedDashAbility));
			}
		}
		...
		public unsafe float adjustedTime
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_adjustedTime);
				return *(float*)num;
			}
			set
			{
				*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_adjustedTime)) = num;
			}
		}
		...
		{
			Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "CustomTeleportLerpSubroutine");
			...
			NativeFieldInfoPtr_adjustedTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, "adjustedTime");
			...
			NativeMethodInfoPtr__ctor_Public_Void_DownedDashAbility_Byte_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673468);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673469);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673470);
			NativeMethodInfoPtr_OnExit_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673471);
			NativeMethodInfoPtr_OnNetDeserialize_Public_Virtual_Void_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673472);
			NativeMethodInfoPtr_OnNetSerialize_Public_Virtual_Void_NetworkWriter_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673473);
			NativeMethodInfoPtr_OnNetDebugCompare_Public_Virtual_Boolean_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673474);
			NativeMethodInfoPtr_OnNetDebugLog_Public_Virtual_Void_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr, 100673475);
		}
		...
		public unsafe CustomTeleportLerpSubroutine(DownedDashAbility _ability, byte _trigger, float _waitTime)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomTeleportLerpSubroutine>.NativeClassPtr))
		{
			...
			*(float**)((byte*)ptr + checked((nuint)2u * unchecked((nuint)sizeof(IntPtr)))) = &_waitTime;
			...
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_DownedDashAbility_Byte_Single_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130384, XrefRangeEnd = 130411, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130411, XrefRangeEnd = 130416, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130416, XrefRangeEnd = 130418, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130418, XrefRangeEnd = 130421, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130421, XrefRangeEnd = 130424, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130424, XrefRangeEnd = 130427, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130427, XrefRangeEnd = 130443, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static DownedDashAbility()
	{
		Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "DownedDashAbility");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr);
		NativeFieldInfoPtr_inputType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "inputType");
		NativeFieldInfoPtr_indicatorPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "indicatorPrefab");
		NativeFieldInfoPtr_indicatorHalfScale = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "indicatorHalfScale");
		NativeFieldInfoPtr_indicatorOffset = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "indicatorOffset");
		NativeFieldInfoPtr_indicatorDoCollision = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "indicatorDoCollision");
		NativeFieldInfoPtr_indicatorClampToMouse = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "indicatorClampToMouse");
		NativeFieldInfoPtr_castingTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "castingTime");
		NativeFieldInfoPtr_teleportLerpTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "teleportLerpTime");
		NativeFieldInfoPtr_recoveryTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "recoveryTime");
		NativeFieldInfoPtr_baseCooldownTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "baseCooldownTime");
		NativeFieldInfoPtr_jumpLerpCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "jumpLerpCurve");
		NativeFieldInfoPtr_teleportMaxDistance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "teleportMaxDistance");
		NativeFieldInfoPtr_teleportRadiusCheck = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "teleportRadiusCheck");
		NativeFieldInfoPtr_camShakeTrauma = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "camShakeTrauma");
		NativeFieldInfoPtr_vfxDashCastPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "vfxDashCastPrefab");
		NativeFieldInfoPtr_vfxDashFollowPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "vfxDashFollowPrefab");
		NativeFieldInfoPtr_sfxDashCast = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "sfxDashCast");
		NativeFieldInfoPtr_animLayer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, "animLayer");
		NativeMethodInfoPtr_PreAwake_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, 100673463);
		NativeMethodInfoPtr_GetTooltipDescription_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, 100673464);
		NativeMethodInfoPtr_GetTooltipExpandedDescription_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, 100673465);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, 100673466);
		NativeMethodInfoPtr_Weaved_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr, 100673467);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130443, XrefRangeEnd = 130549, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130549, XrefRangeEnd = 130552, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 130552, XrefRangeEnd = 130556, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe DownedDashAbility()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<DownedDashAbility>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public DownedDashAbility(IntPtr pointer)
		: base(pointer)
	{
	}
}
