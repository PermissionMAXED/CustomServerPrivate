...
public class P_OnHitboxSpawned_AddStatusEffect : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OnHitboxSpawned_AddStatusEffect>.NativeClassPtr, "Config");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677493);
		}
	...
	static P_OnHitboxSpawned_AddStatusEffect()
	{
		Il2CppClassPointerStore<P_OnHitboxSpawned_AddStatusEffect>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_OnHitboxSpawned_AddStatusEffect");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_OnHitboxSpawned_AddStatusEffect>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnHitboxSpawned_AddStatusEffect>.NativeClassPtr, "config");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnHitboxSpawned_AddStatusEffect>.NativeClassPtr, 100677489);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnHitboxSpawned_AddStatusEffect>.NativeClassPtr, 100677490);
		NativeMethodInfoPtr_OnHitboxSpawned_Public_Virtual_Void_GameObject_EntityManager_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnHitboxSpawned_AddStatusEffect>.NativeClassPtr, 100677491);
		NativeMethodInfoPtr_ModifyHitbox_Private_Void_GameObject_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnHitboxSpawned_AddStatusEffect>.NativeClassPtr, 100677492);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177419, XrefRangeEnd = 177425, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_OnHitboxSpawned_AddStatusEffect(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_OnHitboxSpawned_AddStatusEffect>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177425, XrefRangeEnd = 177432, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_OnHitboxSpawned_AddStatusEffect(IntPtr pointer)
		: base(pointer)
	{
	}
}
