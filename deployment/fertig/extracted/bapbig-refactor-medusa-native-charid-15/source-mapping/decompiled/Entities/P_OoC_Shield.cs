...
public class P_OoC_Shield : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr, "Config");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677909);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 178878, XrefRangeEnd = 178879, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomShieldSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_P_OoC_Shield_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0;

		public unsafe P_OoC_Shield passive
		{
			get
			{
				...
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<P_OoC_Shield>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_passive)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)p_OoC_Shield));
			}
		}

		static CustomShieldSubroutine()
		{
			Il2CppClassPointerStore<CustomShieldSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr, "CustomShieldSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_P_OoC_Shield_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShieldSubroutine>.NativeClassPtr, 100677910);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShieldSubroutine>.NativeClassPtr, 100677911);
		}
		...
		public unsafe CustomShieldSubroutine(P_OoC_Shield _ability)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomShieldSubroutine>.NativeClassPtr))
		{
			...
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_ability);
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_P_OoC_Shield_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}
	...
	public class CustomPassiveSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_P_OoC_Shield_Byte_0;
		...
		{
			Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr, "CustomPassiveSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_P_OoC_Shield_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677912);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677913);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677914);
		}
		...
		public unsafe CustomPassiveSubroutine(P_OoC_Shield _ability, byte _triggerFinished)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr))
		{
			...
			*(byte**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_triggerFinished;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_P_OoC_Shield_Byte_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 178879, XrefRangeEnd = 178885, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static P_OoC_Shield()
	{
		Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_OoC_Shield");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr, "config");
		NativeFieldInfoPtr_cooldownSubroutine = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr, "cooldownSubroutine");
		NativeFieldInfoPtr_hit = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr, "hit");
		NativeFieldInfoPtr_shieldTimer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr, "shieldTimer");
		NativeFieldInfoPtr_shieldDamageTaken = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr, "shieldDamageTaken");
		NativeFieldInfoPtr_shield = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr, "shield");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr, 100677904);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr, 100677905);
		NativeMethodInfoPtr_OnTakeDamageTrigger_Public_Virtual_Void_Int32_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr, 100677906);
		NativeMethodInfoPtr_ClDeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr, 100677907);
		NativeMethodInfoPtr_DeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr, 100677908);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 178912, RefRangeEnd = 178913, XrefRangeStart = 178885, XrefRangeEnd = 178912, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_OoC_Shield(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_OoC_Shield>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[2];
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 178913, XrefRangeEnd = 178915, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_OoC_Shield(IntPtr pointer)
		: base(pointer)
	{
	}
}
