...
public class P_OnKill_TakePassives : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_OnKill_TakePassives>.NativeClassPtr, "Config");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677646);
		}
	...
	static P_OnKill_TakePassives()
	{
		Il2CppClassPointerStore<P_OnKill_TakePassives>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_OnKill_TakePassives");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_OnKill_TakePassives>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnKill_TakePassives>.NativeClassPtr, "config");
		NativeFieldInfoPtr_vfxReadyId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnKill_TakePassives>.NativeClassPtr, "vfxReadyId");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_TakePassives>.NativeClassPtr, 100677641);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_TakePassives>.NativeClassPtr, 100677642);
		NativeMethodInfoPtr_OnKillTrigger_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_TakePassives>.NativeClassPtr, 100677643);
		NativeMethodInfoPtr_ClActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_TakePassives>.NativeClassPtr, 100677644);
		NativeMethodInfoPtr_ClDeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnKill_TakePassives>.NativeClassPtr, 100677645);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177934, XrefRangeEnd = 177938, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_OnKill_TakePassives(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_OnKill_TakePassives>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177938, XrefRangeEnd = 177948, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_OnKill_TakePassives(IntPtr pointer)
		: base(pointer)
	{
	}
}
