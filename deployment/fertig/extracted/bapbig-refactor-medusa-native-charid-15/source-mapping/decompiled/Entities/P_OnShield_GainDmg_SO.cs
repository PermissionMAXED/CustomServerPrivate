...
public class P_OnShield_GainDmg_SO : PassiveSO
{
	...
	public unsafe P_OnShield_GainDmg.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<P_OnShield_GainDmg.Config>(intPtr) : null;
		}
		set
		{
	...
	static P_OnShield_GainDmg_SO()
	{
		Il2CppClassPointerStore<P_OnShield_GainDmg_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_OnShield_GainDmg_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_OnShield_GainDmg_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnShield_GainDmg_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnShield_GainDmg_SO>.NativeClassPtr, 100677661);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_Passive_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnShield_GainDmg_SO>.NativeClassPtr, 100677662);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnShield_GainDmg_SO>.NativeClassPtr, 100677663);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177991, XrefRangeEnd = 177994, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe P_OnShield_GainDmg_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_OnShield_GainDmg_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public P_OnShield_GainDmg_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
