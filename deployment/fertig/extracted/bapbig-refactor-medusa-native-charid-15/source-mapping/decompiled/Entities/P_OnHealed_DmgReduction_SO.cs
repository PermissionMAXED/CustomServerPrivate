...
public class P_OnHealed_DmgReduction_SO : PassiveSO
{
	...
	public unsafe P_OnHealed_DmgReduction.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<P_OnHealed_DmgReduction.Config>(intPtr) : null;
		}
		set
		{
	...
	static P_OnHealed_DmgReduction_SO()
	{
		Il2CppClassPointerStore<P_OnHealed_DmgReduction_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_OnHealed_DmgReduction_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_OnHealed_DmgReduction_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnHealed_DmgReduction_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnHealed_DmgReduction_SO>.NativeClassPtr, 100677473);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_Passive_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnHealed_DmgReduction_SO>.NativeClassPtr, 100677474);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnHealed_DmgReduction_SO>.NativeClassPtr, 100677475);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 177368, XrefRangeEnd = 177371, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe P_OnHealed_DmgReduction_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_OnHealed_DmgReduction_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public P_OnHealed_DmgReduction_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
