...
public class NpcChargedArrowsAbility : Ability
{
	public class CustomShootSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_NpcChargedArrowsAbility_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0;

		public unsafe NpcChargedArrowsAbility ability
		{
			get
			{
				...
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<NpcChargedArrowsAbility>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_ability)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)npcChargedArrowsAbility));
			}
		}

		static CustomShootSubroutine()
		{
			Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "CustomShootSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_NpcChargedArrowsAbility_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr, 100674106);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr, 100674107);
		}
		...
		public unsafe CustomShootSubroutine(NpcChargedArrowsAbility _ability)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr))
		{
			...
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_ability);
			...
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_NpcChargedArrowsAbility_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 141960, XrefRangeEnd = 141963, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomVisibleIndicatorSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_NpcChargedArrowsAbility_Boolean_0;
		...
		{
			Il2CppClassPointerStore<CustomVisibleIndicatorSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "CustomVisibleIndicatorSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_NpcChargedArrowsAbility_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomVisibleIndicatorSubroutine>.NativeClassPtr, 100674108);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomVisibleIndicatorSubroutine>.NativeClassPtr, 100674109);
		}
		...
		public unsafe CustomVisibleIndicatorSubroutine(NpcChargedArrowsAbility _ability, bool _setEnabled)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomVisibleIndicatorSubroutine>.NativeClassPtr))
		{
			...
			*(bool**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_setEnabled;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_NpcChargedArrowsAbility_Boolean_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 141963, XrefRangeEnd = 141995, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
	...
	{
		Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "NpcChargedArrowsAbility");
		NativeFieldInfoPtr_spellPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "spellPrefab");
		NativeFieldInfoPtr_firingPoint = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "firingPoint");
		NativeFieldInfoPtr_castMotionLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "castMotionLockType");
		NativeFieldInfoPtr_applyAtkSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "applyAtkSpeedMultiplier");
		NativeFieldInfoPtr_applyCooldownMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "applyCooldownMultiplier");
		NativeFieldInfoPtr_inputType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "inputType");
		NativeFieldInfoPtr_abilityRadius = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "abilityRadius");
		NativeFieldInfoPtr_indicatorPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "indicatorPrefab");
		NativeFieldInfoPtr_damage = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "damage");
		NativeFieldInfoPtr_damageRate = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "damageRate");
		NativeFieldInfoPtr_damageScaling = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "damageScaling");
		NativeFieldInfoPtr_speed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "speed");
		NativeFieldInfoPtr_ttl = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "ttl");
		NativeFieldInfoPtr_hitboxRadius = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "hitboxRadius");
		NativeFieldInfoPtr_hitboxActivateTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "hitboxActivateTime");
		NativeFieldInfoPtr_randomOffset = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "randomOffset");
		NativeFieldInfoPtr_statusEffects = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "statusEffects");
		NativeFieldInfoPtr_castingTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "castingTime");
		NativeFieldInfoPtr_recoveryTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "recoveryTime");
		NativeFieldInfoPtr_baseCooldownTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "baseCooldownTime");
		NativeFieldInfoPtr_camKickPower = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "camKickPower");
		NativeFieldInfoPtr_vfxCastPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "vfxCastPrefab");
		NativeFieldInfoPtr_sfxCast = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "sfxCast");
		NativeFieldInfoPtr_animLayer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "animLayer");
		NativeFieldInfoPtr_currentIndicator = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "currentIndicator");
		NativeFieldInfoPtr_npcBehaviour = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "npcBehaviour");
		NativeFieldInfoPtr_targetPositions = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, "targetPositions");
		NativeMethodInfoPtr_PreAwake_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, 100674093);
		NativeMethodInfoPtr_Shoot_Private_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, 100674094);
		NativeMethodInfoPtr_ClDestroyVisibleIndicator_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, 100674095);
		NativeMethodInfoPtr_RpcSpawnVisibleIndicator_Private_Void_Vector3_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, 100674096);
		NativeMethodInfoPtr_RpcDestroyVisibleIndicator_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, 100674097);
		NativeMethodInfoPtr_OnDestroy_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, 100674098);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, 100674099);
		NativeMethodInfoPtr_Weaved_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, 100674100);
		NativeMethodInfoPtr_UserCode_RpcSpawnVisibleIndicator__Vector3__Vector3_Protected_Void_Vector3_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, 100674101);
		NativeMethodInfoPtr_InvokeUserCode_RpcSpawnVisibleIndicator__Vector3__Vector3_Protected_Static_Void_NetworkBehaviour_NetworkReader_NetworkConnectionToClient_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, 100674102);
		NativeMethodInfoPtr_UserCode_RpcDestroyVisibleIndicator_Protected_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, 100674103);
		NativeMethodInfoPtr_InvokeUserCode_RpcDestroyVisibleIndicator_Protected_Static_Void_NetworkBehaviour_NetworkReader_NetworkConnectionToClient_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr, 100674104);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 141995, XrefRangeEnd = 142136, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 142168, RefRangeEnd = 142169, XrefRangeStart = 142136, XrefRangeEnd = 142168, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(3)]
	[CachedScanResults(RefRangeStart = 142174, RefRangeEnd = 142177, XrefRangeStart = 142169, XrefRangeEnd = 142174, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 142188, RefRangeEnd = 142190, XrefRangeStart = 142177, XrefRangeEnd = 142188, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 142190, XrefRangeEnd = 142199, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 142199, XrefRangeEnd = 142200, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 142200, XrefRangeEnd = 142205, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe NpcChargedArrowsAbility()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<NpcChargedArrowsAbility>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 142230, RefRangeEnd = 142231, XrefRangeStart = 142205, XrefRangeEnd = 142230, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 142231, XrefRangeEnd = 142240, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 142240, XrefRangeEnd = 142247, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public NpcChargedArrowsAbility(IntPtr pointer)
		: base(pointer)
	{
	}
}
