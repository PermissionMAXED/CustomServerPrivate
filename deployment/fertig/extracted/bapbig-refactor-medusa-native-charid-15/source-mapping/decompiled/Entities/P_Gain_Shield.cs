...
public class P_Gain_Shield : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		private static readonly IntPtr NativeFieldInfoPtr_percentHpShield;
		...
		public unsafe float percentHpShield
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_percentHpShield);
				return *(float*)num;
			}
			set
			{
				*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_percentHpShield)) = num;
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_Gain_Shield>.NativeClassPtr, "Config");
			...
			NativeFieldInfoPtr_percentHpShield = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "percentHpShield");
			NativeFieldInfoPtr_shieldAmount = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "shieldAmount");
			NativeFieldInfoPtr_showCooldown = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "showCooldown");
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677209);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 176320, XrefRangeEnd = 176321, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomPassiveSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_P_Gain_Shield_Byte_0;
		...
		public unsafe P_Gain_Shield passive
		{
			get
			{
				...
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<P_Gain_Shield>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_passive)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)p_Gain_Shield));
			}
		}
		...
		{
			Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_Gain_Shield>.NativeClassPtr, "CustomPassiveSubroutine");
			...
			NativeFieldInfoPtr_timer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, "timer");
			NativeMethodInfoPtr__ctor_Public_Void_P_Gain_Shield_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677210);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677211);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr, 100677212);
		}
		...
		public unsafe CustomPassiveSubroutine(P_Gain_Shield _ability, byte _triggerFinished)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomPassiveSubroutine>.NativeClassPtr))
		{
			...
			*(byte**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_triggerFinished;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_P_Gain_Shield_Byte_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 176321, XrefRangeEnd = 176328, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static P_Gain_Shield()
	{
		Il2CppClassPointerStore<P_Gain_Shield>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_Gain_Shield");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_Gain_Shield>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Gain_Shield>.NativeClassPtr, "config");
		NativeFieldInfoPtr_shieldDamageTaken = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Gain_Shield>.NativeClassPtr, "shieldDamageTaken");
		NativeFieldInfoPtr_amount = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Gain_Shield>.NativeClassPtr, "amount");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Gain_Shield>.NativeClassPtr, 100677206);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Gain_Shield>.NativeClassPtr, 100677207);
		NativeMethodInfoPtr_OnTakeDamageTrigger_Public_Virtual_Void_Int32_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Gain_Shield>.NativeClassPtr, 100677208);
	}

	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 176344, RefRangeEnd = 176345, XrefRangeStart = 176328, XrefRangeEnd = 176344, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_Gain_Shield(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_Gain_Shield>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[2];
	...
	public P_Gain_Shield(IntPtr pointer)
		: base(pointer)
	{
	}
}
