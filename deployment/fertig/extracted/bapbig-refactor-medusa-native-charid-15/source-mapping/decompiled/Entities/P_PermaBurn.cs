...
public class P_PermaBurn : Passive
{
	...
	{
		private static readonly IntPtr NativeFieldInfoPtr_burnDamage;

		private static readonly IntPtr NativeFieldInfoPtr_burnDamagePercentHp;
		...
		public unsafe int burnDamage
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_burnDamage);
				return *(int*)num;
			}
			set
			{
				*(int*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_burnDamage)) = num;
			}
		}

		public unsafe float burnDamagePercentHp
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_burnDamagePercentHp);
				return *(float*)num;
			}
			set
			{
				*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_burnDamagePercentHp)) = num;
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_PermaBurn>.NativeClassPtr, "Config");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Config>.NativeClassPtr);
			NativeFieldInfoPtr_burnDamage = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "burnDamage");
			NativeFieldInfoPtr_burnDamagePercentHp = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "burnDamagePercentHp");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677955);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 178961, XrefRangeEnd = 178962, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static P_PermaBurn()
	{
		Il2CppClassPointerStore<P_PermaBurn>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_PermaBurn");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_PermaBurn>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_PermaBurn>.NativeClassPtr, "config");
		NativeFieldInfoPtr_hitTimer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_PermaBurn>.NativeClassPtr, "hitTimer");
		NativeFieldInfoPtr_vfxLoopId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_PermaBurn>.NativeClassPtr, "vfxLoopId");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_PermaBurn>.NativeClassPtr, 100677950);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_PermaBurn>.NativeClassPtr, 100677951);
		NativeMethodInfoPtr_Tick_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_PermaBurn>.NativeClassPtr, 100677952);
		NativeMethodInfoPtr_ClActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_PermaBurn>.NativeClassPtr, 100677953);
		NativeMethodInfoPtr_ClDeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_PermaBurn>.NativeClassPtr, 100677954);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 178962, XrefRangeEnd = 178966, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_PermaBurn(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_PermaBurn>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 178966, XrefRangeEnd = 178971, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_PermaBurn(IntPtr pointer)
		: base(pointer)
	{
	}
}
