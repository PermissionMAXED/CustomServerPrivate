...
public class ArrowMissileAbility : Ability
{
	public class CustomZoomOutSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_ArrowMissileAbility_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0;

		public unsafe ArrowMissileAbility ability
		{
			get
			{
				...
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<ArrowMissileAbility>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_ability)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)arrowMissileAbility));
			}
		}

		static CustomZoomOutSubroutine()
		{
			Il2CppClassPointerStore<CustomZoomOutSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "CustomZoomOutSubroutine");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CustomZoomOutSubroutine>.NativeClassPtr);
			NativeFieldInfoPtr_ability = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomZoomOutSubroutine>.NativeClassPtr, "ability");
			NativeMethodInfoPtr__ctor_Public_Void_ArrowMissileAbility_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomZoomOutSubroutine>.NativeClassPtr, 100673738);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomZoomOutSubroutine>.NativeClassPtr, 100673739);
		}
		...
		public unsafe CustomZoomOutSubroutine(ArrowMissileAbility _ability)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomZoomOutSubroutine>.NativeClassPtr))
		{
			IntPtr* ptr = stackalloc IntPtr[1];
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_ability);
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_ArrowMissileAbility_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		...
		public CustomZoomOutSubroutine(IntPtr pointer)
			: base(pointer)
		{
		}
	}
	...
	public class CustomResetZoomSubroutine : SimulationSubroutine
	{
		...
		static CustomResetZoomSubroutine()
		{
			Il2CppClassPointerStore<CustomResetZoomSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "CustomResetZoomSubroutine");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CustomResetZoomSubroutine>.NativeClassPtr);
			NativeFieldInfoPtr_ability = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomResetZoomSubroutine>.NativeClassPtr, "ability");
			NativeMethodInfoPtr__ctor_Public_Void_ArrowMissileAbility_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomResetZoomSubroutine>.NativeClassPtr, 100673740);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomResetZoomSubroutine>.NativeClassPtr, 100673741);
		}

		[CallerCount(534)]
		[CachedScanResults(RefRangeStart = 124041, RefRangeEnd = 124575, XrefRangeStart = 124041, XrefRangeEnd = 124575, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomResetZoomSubroutine(ArrowMissileAbility _ability)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomResetZoomSubroutine>.NativeClassPtr))
		{
			IntPtr* ptr = stackalloc IntPtr[1];
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_ability);
			Unsafe.SkipInit(out IntPtr intPtr2);
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 135743, XrefRangeEnd = 135746, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
		...
		public CustomResetZoomSubroutine(IntPtr pointer)
			: base(pointer)
		{
		}
	}
	...
	public class CustomShootSubroutine : SimulationSubroutine
	{
		...
		{
			Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "CustomShootSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_ArrowMissileAbility_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr, 100673742);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootSubroutine>.NativeClassPtr, 100673743);
		}

		[CallerCount(534)]
		[CachedScanResults(RefRangeStart = 124041, RefRangeEnd = 124575, XrefRangeStart = 124041, XrefRangeEnd = 124575, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomShootSubroutine(ArrowMissileAbility _ability)
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 135746, XrefRangeEnd = 135756, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
	...
	private static readonly IntPtr NativeFieldInfoPtr_castVisibilityRadius;

	private static readonly IntPtr NativeFieldInfoPtr_vfxCastPrefab;

	private static readonly IntPtr NativeFieldInfoPtr_sfxCast;

	private static readonly IntPtr NativeFieldInfoPtr_sfxCastEnemy;
	...
	private static readonly IntPtr NativeFieldInfoPtr_currIndicatorObject;

	private static readonly IntPtr NativeFieldInfoPtr__isOwned;

	private static readonly IntPtr NativeFieldInfoPtr__isServer;

	private static readonly IntPtr NativeFieldInfoPtr__isClient;
	...
	private static readonly IntPtr NativeMethodInfoPtr_OnZoomMultiplierChanged_Private_Void_0;
	...
	public unsafe float castVisibilityRadius
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_castVisibilityRadius);
			return *(float*)num;
		}
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_castVisibilityRadius)) = num;
		}
	}
	...
	public unsafe AudioClipData sfxCastEnemy
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_sfxCastEnemy);
			IntPtr intPtr = *(IntPtr*)num;
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<AudioClipData>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_sfxCastEnemy)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)audioClipData));
		}
	}
	...
	public unsafe GameObject currIndicatorObject
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_currIndicatorObject);
			IntPtr intPtr = *(IntPtr*)num;
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<GameObject>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_currIndicatorObject)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)gameObject));
		}
	}
	...
	{
		Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "ArrowMissileAbility");
		NativeFieldInfoPtr_spellPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "spellPrefab");
		NativeFieldInfoPtr_firingPoint = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "firingPoint");
		NativeFieldInfoPtr_castMotionLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "castMotionLockType");
		NativeFieldInfoPtr_castRotationLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "castRotationLockType");
		NativeFieldInfoPtr_applyAtkSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "applyAtkSpeedMultiplier");
		NativeFieldInfoPtr_applyCooldownMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "applyCooldownMultiplier");
		NativeFieldInfoPtr_inputType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "inputType");
		NativeFieldInfoPtr_indicatorPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "indicatorPrefab");
		NativeFieldInfoPtr_indicatorHalfScale = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "indicatorHalfScale");
		NativeFieldInfoPtr_indicatorOffset = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "indicatorOffset");
		NativeFieldInfoPtr_indicatorDoCollision = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "indicatorDoCollision");
		NativeFieldInfoPtr_indicatorClampToMouse = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "indicatorClampToMouse");
		NativeFieldInfoPtr_damage = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "damage");
		NativeFieldInfoPtr_damageScaling = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "damageScaling");
		NativeFieldInfoPtr_speed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "speed");
		NativeFieldInfoPtr_ttl = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "ttl");
		NativeFieldInfoPtr_statusEffects = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "statusEffects");
		NativeFieldInfoPtr_castingTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "castingTime");
		NativeFieldInfoPtr_recoveryTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "recoveryTime");
		NativeFieldInfoPtr_baseCooldownTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "baseCooldownTime");
		NativeFieldInfoPtr_startCooldownTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "startCooldownTime");
		NativeFieldInfoPtr_camShakeTrauma = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "camShakeTrauma");
		NativeFieldInfoPtr_zoomOutMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "zoomOutMultiplier");
		NativeFieldInfoPtr_castVisibilityRadius = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "castVisibilityRadius");
		NativeFieldInfoPtr_vfxCastPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "vfxCastPrefab");
		NativeFieldInfoPtr_sfxCast = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "sfxCast");
		NativeFieldInfoPtr_sfxCastEnemy = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "sfxCastEnemy");
		NativeFieldInfoPtr_targetHitAudioClipData = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "targetHitAudioClipData");
		NativeFieldInfoPtr_sfxCastGlobalDistMult = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "sfxCastGlobalDistMult");
		NativeFieldInfoPtr_sfxCastGlobalMinDist = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "sfxCastGlobalMinDist");
		NativeFieldInfoPtr_animLayer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "animLayer");
		NativeFieldInfoPtr_fowController = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "fowController");
		NativeFieldInfoPtr_camController = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "camController");
		NativeFieldInfoPtr_currIndicatorObject = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "currIndicatorObject");
		NativeFieldInfoPtr__isOwned = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "_isOwned");
		NativeFieldInfoPtr__isServer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "_isServer");
		NativeFieldInfoPtr__isClient = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "_isClient");
		NativeFieldInfoPtr_zoomMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, "zoomMultiplier");
		NativeMethodInfoPtr_PreAwake_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673720);
		NativeMethodInfoPtr_Start_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673721);
		NativeMethodInfoPtr_OnDestroy_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673722);
		NativeMethodInfoPtr_Shoot_Private_Void_Vector3_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673723);
		NativeMethodInfoPtr_OnTargetHit_Public_Virtual_Void_EntityManager_HitboxBase_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673724);
		NativeMethodInfoPtr_RpcOnTargetHit_Public_Void_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673725);
		NativeMethodInfoPtr_GetTooltipDescription_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673726);
		NativeMethodInfoPtr_GetTooltipExpandedDescription_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673727);
		NativeMethodInfoPtr_OnZoomMultiplierChanged_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673728);
		NativeMethodInfoPtr_OnNetDeserialize_Public_Virtual_Void_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673729);
		NativeMethodInfoPtr_OnNetSerialize_Public_Virtual_Void_NetworkWriter_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673730);
		NativeMethodInfoPtr_OnNetDebugCompare_Public_Virtual_Boolean_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673731);
		NativeMethodInfoPtr_OnNetDebugLog_Public_Virtual_Void_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673732);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673733);
		NativeMethodInfoPtr_Weaved_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673734);
		NativeMethodInfoPtr_UserCode_RpcOnTargetHit__Vector3_Protected_Void_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673735);
		NativeMethodInfoPtr_InvokeUserCode_RpcOnTargetHit__Vector3_Protected_Static_Void_NetworkBehaviour_NetworkReader_NetworkConnectionToClient_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr, 100673736);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 135756, XrefRangeEnd = 135929, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 135929, XrefRangeEnd = 135936, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 135936, XrefRangeEnd = 135951, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 135987, RefRangeEnd = 135988, XrefRangeStart = 135951, XrefRangeEnd = 135987, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 135988, XrefRangeEnd = 136011, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 136011, XrefRangeEnd = 136021, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 136021, XrefRangeEnd = 136031, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 136039, XrefRangeEnd = 136043, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void OnZoomMultiplierChanged()
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_OnZoomMultiplierChanged_Private_Void_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 136043, XrefRangeEnd = 136049, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 136049, XrefRangeEnd = 136051, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 136051, XrefRangeEnd = 136053, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 136053, XrefRangeEnd = 136059, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 136059, XrefRangeEnd = 136064, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ArrowMissileAbility()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ArrowMissileAbility>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 136064, XrefRangeEnd = 136074, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 136074, XrefRangeEnd = 136091, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public ArrowMissileAbility(IntPtr pointer)
		: base(pointer)
	{
	}
}
