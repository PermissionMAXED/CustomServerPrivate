...
public class NpcTrackTargetSubroutine : SimulationSubroutine
{
	...
	static NpcTrackTargetSubroutine()
	{
		Il2CppClassPointerStore<NpcTrackTargetSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "NpcTrackTargetSubroutine");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<NpcTrackTargetSubroutine>.NativeClassPtr);
		NativeFieldInfoPtr_npcBehaviour = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NpcTrackTargetSubroutine>.NativeClassPtr, "npcBehaviour");
		NativeMethodInfoPtr__ctor_Public_Void_NpcBehaviour_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcTrackTargetSubroutine>.NativeClassPtr, 100675767);
		NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NpcTrackTargetSubroutine>.NativeClassPtr, 100675768);
	}
	...
	public unsafe NpcTrackTargetSubroutine(NpcBehaviour _npcBehaviour)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<NpcTrackTargetSubroutine>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 165129, XrefRangeEnd = 165136, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public NpcTrackTargetSubroutine(IntPtr pointer)
		: base(pointer)
	{
	}
}
