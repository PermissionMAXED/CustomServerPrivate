...
public class P_Blood_OnKill_GainGold : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		private static readonly IntPtr NativeFieldInfoPtr_goldAmount;
		...
		public unsafe int goldAmount
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_goldAmount);
				return *(int*)num;
			}
			set
			{
				*(int*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_goldAmount)) = num;
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_Blood_OnKill_GainGold>.NativeClassPtr, "Config");
			...
			NativeFieldInfoPtr_goldAmount = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "goldAmount");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100676967);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175653, XrefRangeEnd = 175655, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static P_Blood_OnKill_GainGold()
	{
		Il2CppClassPointerStore<P_Blood_OnKill_GainGold>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_Blood_OnKill_GainGold");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_Blood_OnKill_GainGold>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Blood_OnKill_GainGold>.NativeClassPtr, "config");
		NativeFieldInfoPtr_vfxReadyId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Blood_OnKill_GainGold>.NativeClassPtr, "vfxReadyId");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_GainGold>.NativeClassPtr, 100676958);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_GainGold>.NativeClassPtr, 100676959);
		NativeMethodInfoPtr_GetValue_Public_Virtual_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_GainGold>.NativeClassPtr, 100676960);
		NativeMethodInfoPtr_GetPassiveName_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_GainGold>.NativeClassPtr, 100676961);
		NativeMethodInfoPtr_OnKillTrigger_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_GainGold>.NativeClassPtr, 100676962);
		NativeMethodInfoPtr_ActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_GainGold>.NativeClassPtr, 100676963);
		NativeMethodInfoPtr_DeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_GainGold>.NativeClassPtr, 100676964);
		NativeMethodInfoPtr_ClActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_GainGold>.NativeClassPtr, 100676965);
		NativeMethodInfoPtr_ClDeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Blood_OnKill_GainGold>.NativeClassPtr, 100676966);
	}
	...
	public unsafe P_Blood_OnKill_GainGold(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_Blood_OnKill_GainGold>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175659, XrefRangeEnd = 175660, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175660, XrefRangeEnd = 175662, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175662, XrefRangeEnd = 175664, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_Blood_OnKill_GainGold(IntPtr pointer)
		: base(pointer)
	{
	}
}
