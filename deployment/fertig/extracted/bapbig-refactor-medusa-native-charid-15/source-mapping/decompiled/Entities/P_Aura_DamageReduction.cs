...
public class P_Aura_DamageReduction : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		public unsafe float damageReduction
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_damageReduction);
				return *(float*)num;
			}
			set
			{
				*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_damageReduction)) = num;
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_Aura_DamageReduction>.NativeClassPtr, "Config");
			...
			NativeFieldInfoPtr_damageReduction = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "damageReduction");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100676809);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 174660, XrefRangeEnd = 174661, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	private static readonly IntPtr NativeFieldInfoPtr_hitboxObj;
	...
	private static readonly IntPtr NativeMethodInfoPtr_SpawnAuraObject_Private_Void_0;
	...
	public unsafe GameObject hitboxObj
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_hitboxObj);
			IntPtr intPtr = *(IntPtr*)num;
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<GameObject>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_hitboxObj)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)gameObject));
		}
	}
	...
	static P_Aura_DamageReduction()
	{
		Il2CppClassPointerStore<P_Aura_DamageReduction>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_Aura_DamageReduction");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_Aura_DamageReduction>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Aura_DamageReduction>.NativeClassPtr, "config");
		NativeFieldInfoPtr_hitboxObj = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Aura_DamageReduction>.NativeClassPtr, "hitboxObj");
		NativeFieldInfoPtr_vfxFollowId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Aura_DamageReduction>.NativeClassPtr, "vfxFollowId");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_DamageReduction>.NativeClassPtr, 100676802);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_DamageReduction>.NativeClassPtr, 100676803);
		NativeMethodInfoPtr_SpawnAuraObject_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_DamageReduction>.NativeClassPtr, 100676804);
		NativeMethodInfoPtr_ActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_DamageReduction>.NativeClassPtr, 100676805);
		NativeMethodInfoPtr_DeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_DamageReduction>.NativeClassPtr, 100676806);
		NativeMethodInfoPtr_ClActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_DamageReduction>.NativeClassPtr, 100676807);
		NativeMethodInfoPtr_ClDeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Aura_DamageReduction>.NativeClassPtr, 100676808);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 174661, XrefRangeEnd = 174665, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_Aura_DamageReduction(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_Aura_DamageReduction>.NativeClassPtr))
	{
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 174691, RefRangeEnd = 174692, XrefRangeStart = 174665, XrefRangeEnd = 174691, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void SpawnAuraObject()
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_SpawnAuraObject_Private_Void_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 174692, XrefRangeEnd = 174694, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 174694, XrefRangeEnd = 174704, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_Aura_DamageReduction(IntPtr pointer)
		: base(pointer)
	{
	}
}
