...
public class SlimeBossMoveJumpAbility : Ability
{
	public class CustomGetJumpPointSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_SlimeBossMoveJumpAbility_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0;

		public unsafe SlimeBossMoveJumpAbility ability
		{
			get
			{
				...
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<SlimeBossMoveJumpAbility>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_ability)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)slimeBossMoveJumpAbility));
			}
		}

		static CustomGetJumpPointSubroutine()
		{
			Il2CppClassPointerStore<CustomGetJumpPointSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "CustomGetJumpPointSubroutine");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CustomGetJumpPointSubroutine>.NativeClassPtr);
			NativeFieldInfoPtr_ability = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomGetJumpPointSubroutine>.NativeClassPtr, "ability");
			NativeMethodInfoPtr__ctor_Public_Void_SlimeBossMoveJumpAbility_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomGetJumpPointSubroutine>.NativeClassPtr, 100673314);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomGetJumpPointSubroutine>.NativeClassPtr, 100673315);
		}
		...
		public unsafe CustomGetJumpPointSubroutine(SlimeBossMoveJumpAbility _ability)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomGetJumpPointSubroutine>.NativeClassPtr))
		{
			IntPtr* ptr = stackalloc IntPtr[1];
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_ability);
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_SlimeBossMoveJumpAbility_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 127218, XrefRangeEnd = 127231, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		public CustomGetJumpPointSubroutine(IntPtr pointer)
			: base(pointer)
		{
		}
	}
	...
	public class CustomLookAtTargetSubroutine : SimulationSubroutine
	{
		...
		{
			Il2CppClassPointerStore<CustomLookAtTargetSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "CustomLookAtTargetSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_SlimeBossMoveJumpAbility_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomLookAtTargetSubroutine>.NativeClassPtr, 100673316);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomLookAtTargetSubroutine>.NativeClassPtr, 100673317);
		}

		[CallerCount(534)]
		[CachedScanResults(RefRangeStart = 124041, RefRangeEnd = 124575, XrefRangeStart = 124041, XrefRangeEnd = 124575, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomLookAtTargetSubroutine(SlimeBossMoveJumpAbility _ability)
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 127231, XrefRangeEnd = 127232, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public class CustomJumpSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_SlimeBossMoveJumpAbility_Byte_Single_0;
		...
		{
			Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "CustomJumpSubroutine");
			...
			NativeMethodInfoPtr__ctor_Public_Void_SlimeBossMoveJumpAbility_Byte_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100673318);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100673319);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100673320);
			NativeMethodInfoPtr_OnExit_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr, 100673321);
		}
		...
		public unsafe CustomJumpSubroutine(SlimeBossMoveJumpAbility _ability, byte _trigger, float _waitTime)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomJumpSubroutine>.NativeClassPtr))
		{
			...
			*(float**)((byte*)ptr + checked((nuint)2u * unchecked((nuint)sizeof(IntPtr)))) = &_waitTime;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_SlimeBossMoveJumpAbility_Byte_Single_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 127232, XrefRangeEnd = 127235, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 127235, XrefRangeEnd = 127243, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override byte OnTick(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 127243, XrefRangeEnd = 127245, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static SlimeBossMoveJumpAbility()
	{
		Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "SlimeBossMoveJumpAbility");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr);
		NativeFieldInfoPtr_castMotionLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "castMotionLockType");
		NativeFieldInfoPtr_castRotationLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "castRotationLockType");
		NativeFieldInfoPtr_applyAtkSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "applyAtkSpeedMultiplier");
		NativeFieldInfoPtr_applyCooldownMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "applyCooldownMultiplier");
		NativeFieldInfoPtr_inputType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "inputType");
		NativeFieldInfoPtr_maxRange = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "maxRange");
		NativeFieldInfoPtr_castingTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "castingTime");
		NativeFieldInfoPtr_jumpTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "jumpTime");
		NativeFieldInfoPtr_recoveryTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "recoveryTime");
		NativeFieldInfoPtr_baseCooldownTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "baseCooldownTime");
		NativeFieldInfoPtr_camShakeTrauma = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "camShakeTrauma");
		NativeFieldInfoPtr_takeoffVfxId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "takeoffVfxId");
		NativeFieldInfoPtr_castSfx = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "castSfx");
		NativeFieldInfoPtr_jumpLerpCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "jumpLerpCurve");
		NativeFieldInfoPtr_baseShadowAlphaCurve = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "baseShadowAlphaCurve");
		NativeFieldInfoPtr_jumpRadiusCheck = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "jumpRadiusCheck");
		NativeFieldInfoPtr_animLayer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "animLayer");
		NativeFieldInfoPtr_jumpPoint = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "jumpPoint");
		NativeFieldInfoPtr_EXT_TRIGGER_RESET = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, "EXT_TRIGGER_RESET");
		NativeMethodInfoPtr_PreAwake_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, 100673310);
		NativeMethodInfoPtr_ResetCooldown_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, 100673311);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, 100673312);
		NativeMethodInfoPtr_Weaved_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr, 100673313);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 127245, XrefRangeEnd = 127398, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 127398, XrefRangeEnd = 127399, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe SlimeBossMoveJumpAbility()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<SlimeBossMoveJumpAbility>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public SlimeBossMoveJumpAbility(IntPtr pointer)
		: base(pointer)
	{
	}
}
