...
public class P_CharAugment_UltraViolet : Passive
{
	...
	public class Config : PassiveConfiguration
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_CharAugment_UltraViolet>.NativeClassPtr, "Config");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Config>.NativeClassPtr);
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100676587);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 173068, XrefRangeEnd = 173069, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static P_CharAugment_UltraViolet()
	{
		Il2CppClassPointerStore<P_CharAugment_UltraViolet>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_CharAugment_UltraViolet");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_CharAugment_UltraViolet>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_CharAugment_UltraViolet>.NativeClassPtr, "config");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_CharAugment_UltraViolet>.NativeClassPtr, 100676583);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_CharAugment_UltraViolet>.NativeClassPtr, 100676584);
		NativeMethodInfoPtr_OnHitboxSpawned_Public_Virtual_Void_GameObject_EntityManager_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_CharAugment_UltraViolet>.NativeClassPtr, 100676585);
		NativeMethodInfoPtr_ModifyHitbox_Private_Void_GameObject_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_CharAugment_UltraViolet>.NativeClassPtr, 100676586);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 173069, XrefRangeEnd = 173075, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_CharAugment_UltraViolet(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_CharAugment_UltraViolet>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 173075, XrefRangeEnd = 173080, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_CharAugment_UltraViolet(IntPtr pointer)
		: base(pointer)
	{
	}
}
