...
public class P_OnDamage_IfBurned_Heal_SO : PassiveSO
{
	...
	public unsafe P_OnDamage_IfBurned_Heal.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<P_OnDamage_IfBurned_Heal.Config>(intPtr) : null;
		}
		set
		{
	...
	static P_OnDamage_IfBurned_Heal_SO()
	{
		Il2CppClassPointerStore<P_OnDamage_IfBurned_Heal_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_OnDamage_IfBurned_Heal_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_OnDamage_IfBurned_Heal_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_OnDamage_IfBurned_Heal_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnDamage_IfBurned_Heal_SO>.NativeClassPtr, 100677441);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_Passive_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnDamage_IfBurned_Heal_SO>.NativeClassPtr, 100677442);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_OnDamage_IfBurned_Heal_SO>.NativeClassPtr, 100677443);
	}
	...
	public unsafe P_OnDamage_IfBurned_Heal_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_OnDamage_IfBurned_Heal_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public P_OnDamage_IfBurned_Heal_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
