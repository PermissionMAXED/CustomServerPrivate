...
public class AimLockSubroutine : SimulationSubroutine
{
	...
	static AimLockSubroutine()
	{
		Il2CppClassPointerStore<AimLockSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "AimLockSubroutine");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AimLockSubroutine>.NativeClassPtr);
		NativeFieldInfoPtr_inputSystem = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AimLockSubroutine>.NativeClassPtr, "inputSystem");
		NativeFieldInfoPtr_ability = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AimLockSubroutine>.NativeClassPtr, "ability");
		NativeMethodInfoPtr__ctor_Public_Void_Ability_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AimLockSubroutine>.NativeClassPtr, 100674933);
		NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AimLockSubroutine>.NativeClassPtr, 100674934);
		NativeMethodInfoPtr_OnExit_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AimLockSubroutine>.NativeClassPtr, 100674935);
	}

	[CallerCount(27)]
	[CachedScanResults(RefRangeStart = 154912, RefRangeEnd = 154939, XrefRangeStart = 154909, XrefRangeEnd = 154912, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe AimLockSubroutine(Ability ability)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AimLockSubroutine>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 154939, XrefRangeEnd = 154941, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 154941, XrefRangeEnd = 154943, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public AimLockSubroutine(IntPtr pointer)
		: base(pointer)
	{
	}
}
