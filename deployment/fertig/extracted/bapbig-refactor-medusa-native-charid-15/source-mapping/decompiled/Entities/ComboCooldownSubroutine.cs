...
public class ComboCooldownSubroutine : NetworkedSimulationSubroutine
{
	...
	static ComboCooldownSubroutine()
	{
		Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "ComboCooldownSubroutine");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr);
		NativeFieldInfoPtr_ability = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr, "ability");
		NativeFieldInfoPtr_triggerFinished = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr, "triggerFinished");
		NativeFieldInfoPtr_triggerSilenced = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr, "triggerSilenced");
		NativeFieldInfoPtr_cooldownTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr, "cooldownTime");
		NativeFieldInfoPtr_applyAtkSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr, "applyAtkSpeedMultiplier");
		NativeFieldInfoPtr_timeElapsed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr, "timeElapsed");
		NativeMethodInfoPtr__ctor_Public_Void_Ability_Byte_Byte_Single_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr, 100674996);
		NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr, 100674997);
		NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr, 100674998);
		NativeMethodInfoPtr_GetAdjustedCooldownTime_Private_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr, 100674999);
		NativeMethodInfoPtr_ReupdateCooldown_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr, 100675000);
		NativeMethodInfoPtr_OnNetDeserialize_Public_Virtual_Void_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr, 100675001);
		NativeMethodInfoPtr_OnNetSerialize_Public_Virtual_Void_NetworkWriter_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr, 100675002);
		NativeMethodInfoPtr_OnNetDebugCompare_Public_Virtual_Boolean_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr, 100675003);
		NativeMethodInfoPtr_OnNetDebugLog_Public_Virtual_Void_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr, 100675004);
	}
	...
	public unsafe ComboCooldownSubroutine(Ability ability, byte triggerFinished, byte triggerSilenced, float cooldownTime, bool applyAtkSpeedMultiplier)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ComboCooldownSubroutine>.NativeClassPtr))
	{
		...
		*(float**)((byte*)ptr + checked((nuint)3u * unchecked((nuint)sizeof(IntPtr)))) = &cooldownTime;
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 155685, XrefRangeEnd = 155686, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 155686, XrefRangeEnd = 155694, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 155694, XrefRangeEnd = 155699, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 155699, XrefRangeEnd = 155705, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 155705, XrefRangeEnd = 155712, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public ComboCooldownSubroutine(IntPtr pointer)
		: base(pointer)
	{
	}
}
