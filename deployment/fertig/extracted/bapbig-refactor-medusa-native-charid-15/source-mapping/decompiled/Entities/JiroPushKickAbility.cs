...
public class JiroPushKickAbility : Ability
{
	public class WaitToRotationLockSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeFieldInfoPtr_doLock;

		private static readonly IntPtr NativeFieldInfoPtr_isLock;

		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_JiroPushKickAbility_Single_Boolean_Boolean_0;
		...
		public unsafe JiroPushKickAbility ability
		{
			get
			{
				...
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<JiroPushKickAbility>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_ability)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)jiroPushKickAbility));
			}
		}
		...
		public unsafe bool doLock
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_doLock);
				return *(bool*)num;
			}
			set
			{
				*(bool*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_doLock)) = flag;
			}
		}
		...
		static WaitToRotationLockSubroutine()
		{
			Il2CppClassPointerStore<WaitToRotationLockSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "WaitToRotationLockSubroutine");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<WaitToRotationLockSubroutine>.NativeClassPtr);
			NativeFieldInfoPtr_ability = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<WaitToRotationLockSubroutine>.NativeClassPtr, "ability");
			NativeFieldInfoPtr_time = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<WaitToRotationLockSubroutine>.NativeClassPtr, "time");
			NativeFieldInfoPtr_timeElapsed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<WaitToRotationLockSubroutine>.NativeClassPtr, "timeElapsed");
			NativeFieldInfoPtr_doLock = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<WaitToRotationLockSubroutine>.NativeClassPtr, "doLock");
			NativeFieldInfoPtr_isLock = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<WaitToRotationLockSubroutine>.NativeClassPtr, "isLock");
			NativeMethodInfoPtr__ctor_Public_Void_JiroPushKickAbility_Single_Boolean_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitToRotationLockSubroutine>.NativeClassPtr, 100673620);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitToRotationLockSubroutine>.NativeClassPtr, 100673621);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WaitToRotationLockSubroutine>.NativeClassPtr, 100673622);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 133185, XrefRangeEnd = 133186, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe WaitToRotationLockSubroutine(JiroPushKickAbility _ability, float rTime, bool rotation, bool iLock)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<WaitToRotationLockSubroutine>.NativeClassPtr))
		{
			IntPtr* ptr = stackalloc IntPtr[4];
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_ability);
			*(float**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &rTime;
			*(bool**)((byte*)ptr + checked((nuint)2u * unchecked((nuint)sizeof(IntPtr)))) = &rotation;
			*(bool**)((byte*)ptr + checked((nuint)3u * unchecked((nuint)sizeof(IntPtr)))) = &iLock;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_JiroPushKickAbility_Single_Boolean_Boolean_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 133186, XrefRangeEnd = 133187, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 133187, XrefRangeEnd = 133188, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		public WaitToRotationLockSubroutine(IntPtr pointer)
			: base(pointer)
		{
		}
	}
	...
	public class CustomShootKickSubroutine : SimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_JiroPushKickAbility_Byte_0;
		...
		static CustomShootKickSubroutine()
		{
			Il2CppClassPointerStore<CustomShootKickSubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "CustomShootKickSubroutine");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CustomShootKickSubroutine>.NativeClassPtr);
			NativeFieldInfoPtr_ability = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomShootKickSubroutine>.NativeClassPtr, "ability");
			NativeFieldInfoPtr_trigger = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomShootKickSubroutine>.NativeClassPtr, "trigger");
			NativeMethodInfoPtr__ctor_Public_Void_JiroPushKickAbility_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootKickSubroutine>.NativeClassPtr, 100673623);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootKickSubroutine>.NativeClassPtr, 100673624);
			NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomShootKickSubroutine>.NativeClassPtr, 100673625);
		}
		...
		public unsafe CustomShootKickSubroutine(JiroPushKickAbility _ability, byte _trigger)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomShootKickSubroutine>.NativeClassPtr))
		{
			IntPtr* ptr = stackalloc IntPtr[2];
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_ability);
			*(byte**)((byte*)ptr + checked((nuint)1u * unchecked((nuint)sizeof(IntPtr)))) = &_trigger;
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_JiroPushKickAbility_Byte_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 133188, XrefRangeEnd = 133192, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe override void OnEnter(float fixedDt, Command cmd, bool isResim)
		{
			IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IntPtr* ptr = stackalloc IntPtr[3];
		...
		public CustomShootKickSubroutine(IntPtr pointer)
			: base(pointer)
		{
		}
	}
	...
	private static readonly IntPtr NativeFieldInfoPtr_doRotationLockTime;

	private static readonly IntPtr NativeFieldInfoPtr_rotationLockTime;
	...
	private static readonly IntPtr NativeFieldInfoPtr_rotationLocked;
	...
	public unsafe bool doRotationLockTime
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_doRotationLockTime);
			return *(bool*)num;
		}
		set
		{
			*(bool*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_doRotationLockTime)) = flag;
		}
	}

	public unsafe float rotationLockTime
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_rotationLockTime);
			return *(float*)num;
		}
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_rotationLockTime)) = num;
		}
	}
	...
	public unsafe bool rotationLocked
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_rotationLocked);
			return *(bool*)num;
		}
		set
		{
			*(bool*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_rotationLocked)) = flag;
		}
	}

	static JiroPushKickAbility()
	{
		Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "JiroPushKickAbility");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr);
		NativeFieldInfoPtr_spellPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "spellPrefab");
		NativeFieldInfoPtr_firingPoint = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "firingPoint");
		NativeFieldInfoPtr_castMotionLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "castMotionLockType");
		NativeFieldInfoPtr_castRotationLockType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "castRotationLockType");
		NativeFieldInfoPtr_applyAtkSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "applyAtkSpeedMultiplier");
		NativeFieldInfoPtr_applyCooldownMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "applyCooldownMultiplier");
		NativeFieldInfoPtr_inputType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "inputType");
		NativeFieldInfoPtr_damage = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "damage");
		NativeFieldInfoPtr_damageScaling = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "damageScaling");
		NativeFieldInfoPtr_ttl = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "ttl");
		NativeFieldInfoPtr_hitboxRadius = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "hitboxRadius");
		NativeFieldInfoPtr_hitboxConeAngleHalf = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "hitboxConeAngleHalf");
		NativeFieldInfoPtr_statusEffects = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "statusEffects");
		NativeFieldInfoPtr_doRotationLockTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "doRotationLockTime");
		NativeFieldInfoPtr_rotationLockTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "rotationLockTime");
		NativeFieldInfoPtr_castingTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "castingTime");
		NativeFieldInfoPtr_recoveryTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "recoveryTime");
		NativeFieldInfoPtr_baseCooldownTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "baseCooldownTime");
		NativeFieldInfoPtr_indicatorPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "indicatorPrefab");
		NativeFieldInfoPtr_indicatorMouseHalfScale = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "indicatorMouseHalfScale");
		NativeFieldInfoPtr_indicatorBaseHalfScale = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "indicatorBaseHalfScale");
		NativeFieldInfoPtr_indicatorOffset = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "indicatorOffset");
		NativeFieldInfoPtr_indicatorMaxDistance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "indicatorMaxDistance");
		NativeFieldInfoPtr_indicatorRotateWithDirection = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "indicatorRotateWithDirection");
		NativeFieldInfoPtr_vfxCastPrefab = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "vfxCastPrefab");
		NativeFieldInfoPtr_sfxCast = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "sfxCast");
		NativeFieldInfoPtr_animLayer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "animLayer");
		NativeFieldInfoPtr_rotationLocked = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, "rotationLocked");
		NativeMethodInfoPtr_PreAwake_Public_Virtual_Void_EntityManager_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, 100673613);
		NativeMethodInfoPtr_ShootKick_Private_Void_Vector3_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, 100673614);
		NativeMethodInfoPtr_HitSuccess_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, 100673615);
		NativeMethodInfoPtr_GetTooltipDescription_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, 100673616);
		NativeMethodInfoPtr_GetTooltipExpandedDescription_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, 100673617);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, 100673618);
		NativeMethodInfoPtr_Weaved_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr, 100673619);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 133192, XrefRangeEnd = 133368, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 133391, RefRangeEnd = 133392, XrefRangeStart = 133368, XrefRangeEnd = 133391, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 133392, XrefRangeEnd = 133402, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 133402, XrefRangeEnd = 133410, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 133410, XrefRangeEnd = 133415, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe JiroPushKickAbility()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<JiroPushKickAbility>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public JiroPushKickAbility(IntPtr pointer)
		: base(pointer)
	{
	}
}
