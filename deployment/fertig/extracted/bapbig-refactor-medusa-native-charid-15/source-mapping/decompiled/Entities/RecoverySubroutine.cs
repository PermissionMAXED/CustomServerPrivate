...
public class RecoverySubroutine : NetworkedSimulationSubroutine
{
	...
	private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_Ability_Byte_Byte_Single_Boolean_0;
	...
	private static readonly IntPtr NativeMethodInfoPtr_GetAdjustedRecoveryDuration_Private_Single_0;

	private static readonly IntPtr NativeMethodInfoPtr_SetRecoveryDuration_Public_Void_Single_0;
	...
	static RecoverySubroutine()
	{
		Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "RecoverySubroutine");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr);
		NativeFieldInfoPtr_ability = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr, "ability");
		NativeFieldInfoPtr_triggerFinished = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr, "triggerFinished");
		NativeFieldInfoPtr_triggerSilenced = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr, "triggerSilenced");
		NativeFieldInfoPtr_duration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr, "duration");
		NativeFieldInfoPtr_applyAtkSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr, "applyAtkSpeedMultiplier");
		NativeFieldInfoPtr_timeElapsed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr, "timeElapsed");
		NativeMethodInfoPtr__ctor_Public_Void_Ability_Byte_Byte_Single_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr, 100675097);
		NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr, 100675098);
		NativeMethodInfoPtr_OnTick_Public_Virtual_Byte_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr, 100675099);
		NativeMethodInfoPtr_GetAdjustedRecoveryDuration_Private_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr, 100675100);
		NativeMethodInfoPtr_SetRecoveryDuration_Public_Void_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr, 100675101);
		NativeMethodInfoPtr_OnNetDeserialize_Public_Virtual_Void_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr, 100675102);
		NativeMethodInfoPtr_OnNetSerialize_Public_Virtual_Void_NetworkWriter_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr, 100675103);
		NativeMethodInfoPtr_OnNetDebugCompare_Public_Virtual_Boolean_NetworkReader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr, 100675104);
		NativeMethodInfoPtr_OnNetDebugLog_Public_Virtual_Void_StringBuilder_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr, 100675105);
	}
	...
	public unsafe RecoverySubroutine(Ability ability, byte triggerFinished, byte triggerSilenced, float duration, bool applyAtkSpeedMultiplier)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<RecoverySubroutine>.NativeClassPtr))
	{
		...
		*(byte**)((byte*)ptr + checked((nuint)2u * unchecked((nuint)sizeof(IntPtr)))) = &triggerSilenced;
		...
		*(bool**)((byte*)ptr + checked((nuint)4u * unchecked((nuint)sizeof(IntPtr)))) = &applyAtkSpeedMultiplier;
		...
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_Ability_Byte_Byte_Single_Boolean_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 157074, XrefRangeEnd = 157079, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	public unsafe float GetAdjustedRecoveryDuration()
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_GetAdjustedRecoveryDuration_Private_Single_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	...
	public unsafe void SetRecoveryDuration(float duration)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[1];
		*ptr = (nint)(&duration);
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_SetRecoveryDuration_Public_Void_Single_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 157079, XrefRangeEnd = 157086, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public RecoverySubroutine(IntPtr pointer)
		: base(pointer)
	{
	}
}
