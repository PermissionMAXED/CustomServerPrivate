...
public class P_Buff_HP : Passive
{
	...
	{
		private static readonly IntPtr NativeFieldInfoPtr_healthAmount;

		private static readonly IntPtr NativeFieldInfoPtr_bonusHealthPerAmount;
		...
		public unsafe int healthAmount
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_healthAmount);
				return *(int*)num;
			}
			set
			{
				*(int*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_healthAmount)) = num;
			}
		}

		public unsafe int bonusHealthPerAmount
		{
			get
			{
				nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_bonusHealthPerAmount);
				return *(int*)num;
			}
			set
			{
				*(int*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_bonusHealthPerAmount)) = num;
			}
		}
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr, "Config");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Config>.NativeClassPtr);
			NativeFieldInfoPtr_healthAmount = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "healthAmount");
			NativeFieldInfoPtr_bonusHealthPerAmount = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Config>.NativeClassPtr, "bonusHealthPerAmount");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100677080);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175861, XrefRangeEnd = 175862, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	private static readonly IntPtr NativeFieldInfoPtr_buffAmount;
	...
	private static readonly IntPtr NativeMethodInfoPtr_TryApplyBuff_Private_Void_0;
	...
	public unsafe int buffAmount
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_buffAmount);
			return *(int*)num;
		}
		set
		{
			*(int*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_buffAmount)) = num;
		}
	}
	...
	static P_Buff_HP()
	{
		Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "P_Buff_HP");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr, "config");
		NativeFieldInfoPtr_timeElapsed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr, "timeElapsed");
		NativeFieldInfoPtr_buffApplied = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr, "buffApplied");
		NativeFieldInfoPtr_maxHpAmount = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr, "maxHpAmount");
		NativeFieldInfoPtr_buffAmount = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr, "buffAmount");
		NativeFieldInfoPtr_vfxLoopId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr, "vfxLoopId");
		NativeMethodInfoPtr_get_passiveConfig_Public_Virtual_get_PassiveConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr, 100677073);
		NativeMethodInfoPtr__ctor_Public_Void_EntityManager_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr, 100677074);
		NativeMethodInfoPtr_Tick_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr, 100677075);
		NativeMethodInfoPtr_TryApplyBuff_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr, 100677076);
		NativeMethodInfoPtr_DeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr, 100677077);
		NativeMethodInfoPtr_ClActivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr, 100677078);
		NativeMethodInfoPtr_ClDeactivatePassive_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr, 100677079);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175862, XrefRangeEnd = 175866, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe P_Buff_HP(EntityManager entityManager, Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<P_Buff_HP>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175866, XrefRangeEnd = 175869, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175869, XrefRangeEnd = 175871, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe void TryApplyBuff()
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_TryApplyBuff_Private_Void_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175871, XrefRangeEnd = 175873, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175873, XrefRangeEnd = 175876, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 175876, XrefRangeEnd = 175878, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public P_Buff_HP(IntPtr pointer)
		: base(pointer)
	{
	}
}
