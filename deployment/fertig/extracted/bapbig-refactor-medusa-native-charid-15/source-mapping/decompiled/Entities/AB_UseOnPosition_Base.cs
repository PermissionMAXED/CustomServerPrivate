...
public class AB_UseOnPosition_Base : AbilityBehaviour
{
	...
	public class Config : AbilityBehaviourConfig
	{
		...
		static Config()
		{
			Il2CppClassPointerStore<Config>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_UseOnPosition_Base>.NativeClassPtr, "Config");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Config>.NativeClassPtr, 100675426);
		}
	...
	public class CustomSpawnEntitySubroutine : NetworkedSimulationSubroutine
	{
		...
		private static readonly IntPtr NativeMethodInfoPtr__ctor_Public_Void_AB_UseOnPosition_Base_0;

		private static readonly IntPtr NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0;

		public unsafe AB_UseOnPosition_Base behaviour
		{
			get
			{
				...
				IntPtr intPtr = *(IntPtr*)num;
				return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<AB_UseOnPosition_Base>(intPtr) : null;
			}
			set
			{
				IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
				IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_behaviour)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)aB_UseOnPosition_Base));
			}
		}
		...
		static CustomSpawnEntitySubroutine()
		{
			Il2CppClassPointerStore<CustomSpawnEntitySubroutine>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<AB_UseOnPosition_Base>.NativeClassPtr, "CustomSpawnEntitySubroutine");
			IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CustomSpawnEntitySubroutine>.NativeClassPtr);
			NativeFieldInfoPtr_behaviour = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomSpawnEntitySubroutine>.NativeClassPtr, "behaviour");
			NativeFieldInfoPtr_hit = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomSpawnEntitySubroutine>.NativeClassPtr, "hit");
			NativeFieldInfoPtr_obstacleMask = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CustomSpawnEntitySubroutine>.NativeClassPtr, "obstacleMask");
			NativeMethodInfoPtr__ctor_Public_Void_AB_UseOnPosition_Base_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomSpawnEntitySubroutine>.NativeClassPtr, 100675427);
			NativeMethodInfoPtr_OnEnter_Public_Virtual_Void_Single_Command_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CustomSpawnEntitySubroutine>.NativeClassPtr, 100675428);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 161935, XrefRangeEnd = 161939, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		public unsafe CustomSpawnEntitySubroutine(AB_UseOnPosition_Base _behaviour)
			: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CustomSpawnEntitySubroutine>.NativeClassPtr))
		{
			IntPtr* ptr = stackalloc IntPtr[1];
			*ptr = IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)_behaviour);
			Unsafe.SkipInit(out IntPtr intPtr2);
			IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_AB_UseOnPosition_Base_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
			Il2CppException.RaiseExceptionIfNecessary(intPtr2);
		}

		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 161939, XrefRangeEnd = 161968, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		public CustomSpawnEntitySubroutine(IntPtr pointer)
			: base(pointer)
		{
		}
	}
	...
	private static readonly IntPtr NativeFieldInfoPtr_spawnPos;
	...
	private static readonly IntPtr NativeMethodInfoPtr_DoUse_Protected_Virtual_New_Void_Vector3_0;
	...
	public unsafe Vector3 spawnPos
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_spawnPos);
			return *(Vector3*)num;
		}
		set
		{
			*(Vector3*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_spawnPos)) = vector;
		}
	}

	static AB_UseOnPosition_Base()
	{
		Il2CppClassPointerStore<AB_UseOnPosition_Base>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Entities", "AB_UseOnPosition_Base");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<AB_UseOnPosition_Base>.NativeClassPtr);
		NativeFieldInfoPtr_config = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_UseOnPosition_Base>.NativeClassPtr, "config");
		NativeFieldInfoPtr_spawnPos = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AB_UseOnPosition_Base>.NativeClassPtr, "spawnPos");
		NativeMethodInfoPtr__ctor_Public_Void_Config_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_UseOnPosition_Base>.NativeClassPtr, 100675423);
		NativeMethodInfoPtr_Build_Public_Virtual_Void_Ability_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_UseOnPosition_Base>.NativeClassPtr, 100675424);
		NativeMethodInfoPtr_DoUse_Protected_Virtual_New_Void_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AB_UseOnPosition_Base>.NativeClassPtr, 100675425);
	}
	...
	public unsafe AB_UseOnPosition_Base(Config config)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AB_UseOnPosition_Base>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[1];
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 161968, XrefRangeEnd = 162150, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe virtual void DoUse(Vector3 spawnPos)
	{
		IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
		IntPtr* ptr = stackalloc IntPtr[1];
		*ptr = (nint)(&spawnPos);
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(IL2CPP.il2cpp_object_get_virtual_method(IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)this), NativeMethodInfoPtr_DoUse_Protected_Virtual_New_Void_Vector3_0), IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	public AB_UseOnPosition_Base(IntPtr pointer)
		: base(pointer)
	{
	}
}
