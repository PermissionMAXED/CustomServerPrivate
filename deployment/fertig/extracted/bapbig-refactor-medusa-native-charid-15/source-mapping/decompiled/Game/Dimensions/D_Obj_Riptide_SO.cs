...
public class D_Obj_Riptide_SO : D_Obj_SO
{
	...
	public unsafe D_Obj_Riptide.Config configuration
	{
		get
		{
			...
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<D_Obj_Riptide.Config>(intPtr) : null;
		}
		set
		{
	...
	static D_Obj_Riptide_SO()
	{
		Il2CppClassPointerStore<D_Obj_Riptide_SO>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Game.Dimensions", "D_Obj_Riptide_SO");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<D_Obj_Riptide_SO>.NativeClassPtr);
		NativeFieldInfoPtr_configuration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D_Obj_Riptide_SO>.NativeClassPtr, "configuration");
		NativeMethodInfoPtr_get_config_Public_Virtual_get_D_ObjConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<D_Obj_Riptide_SO>.NativeClassPtr, 100672963);
		NativeMethodInfoPtr_NewInstance_Public_Virtual_D_Obj_Dimension_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<D_Obj_Riptide_SO>.NativeClassPtr, 100672964);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<D_Obj_Riptide_SO>.NativeClassPtr, 100672965);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 121794, XrefRangeEnd = 121807, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe D_Obj_Riptide_SO()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<D_Obj_Riptide_SO>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public D_Obj_Riptide_SO(IntPtr pointer)
		: base(pointer)
	{
	}
}
