...
[System.Serializable]
public class LeaderboardSelfResponse : Il2CppSystem.Object
{
	[System.Serializable]
	public class LeaderboardEntry : Il2CppSystem.Object
	{
		...
		{
			Il2CppClassPointerStore<LeaderboardEntry>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<LeaderboardSelfResponse>.NativeClassPtr, "LeaderboardEntry");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LeaderboardEntry>.NativeClassPtr, 100666565);
		}
	...
	public unsafe LeaderboardEntry self
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_self);
			System.IntPtr intPtr = *(System.IntPtr*)num;
			return (intPtr != (System.IntPtr)0) ? Il2CppObjectPool.Get<LeaderboardEntry>(intPtr) : null;
		}
		set
		{
			System.IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (System.IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_self)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)leaderboardEntry));
		}
	}
	...
	static LeaderboardSelfResponse()
	{
		Il2CppClassPointerStore<LeaderboardSelfResponse>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Network", "LeaderboardSelfResponse");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<LeaderboardSelfResponse>.NativeClassPtr);
		NativeFieldInfoPtr_self = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<LeaderboardSelfResponse>.NativeClassPtr, "self");
		NativeFieldInfoPtr_top = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<LeaderboardSelfResponse>.NativeClassPtr, "top");
		NativeFieldInfoPtr_isEnd = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<LeaderboardSelfResponse>.NativeClassPtr, "isEnd");
		NativeFieldInfoPtr_pageOffset = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<LeaderboardSelfResponse>.NativeClassPtr, "pageOffset");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LeaderboardSelfResponse>.NativeClassPtr, 100666564);
	}

	[CallerCount(5410)]
	[CachedScanResults(RefRangeStart = 11, RefRangeEnd = 5421, XrefRangeStart = 11, XrefRangeEnd = 5421, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe LeaderboardSelfResponse()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<LeaderboardSelfResponse>.NativeClassPtr))
	{
		System.IntPtr* ptr = null;
		Unsafe.SkipInit(out System.IntPtr intPtr2);
		System.IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
	...
	public LeaderboardSelfResponse(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
