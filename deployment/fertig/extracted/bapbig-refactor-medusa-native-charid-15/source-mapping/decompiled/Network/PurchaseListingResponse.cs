...
[System.Serializable]
public class PurchaseListingResponse : Il2CppSystem.Object
{
	[System.Serializable]
	public class Asset : Il2CppSystem.Object
	{
		...
		static Asset()
		{
			Il2CppClassPointerStore<Asset>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<PurchaseListingResponse>.NativeClassPtr, "Asset");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Asset>.NativeClassPtr, 100666586);
		}
	...
	static PurchaseListingResponse()
	{
		Il2CppClassPointerStore<PurchaseListingResponse>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Network", "PurchaseListingResponse");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<PurchaseListingResponse>.NativeClassPtr);
		NativeFieldInfoPtr_listingId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PurchaseListingResponse>.NativeClassPtr, "listingId");
		NativeFieldInfoPtr_purchases = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PurchaseListingResponse>.NativeClassPtr, "purchases");
		NativeFieldInfoPtr_cost = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PurchaseListingResponse>.NativeClassPtr, "cost");
		NativeFieldInfoPtr_rewards = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PurchaseListingResponse>.NativeClassPtr, "rewards");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PurchaseListingResponse>.NativeClassPtr, 100666585);
	}

	[CallerCount(5410)]
	[CachedScanResults(RefRangeStart = 11, RefRangeEnd = 5421, XrefRangeStart = 11, XrefRangeEnd = 5421, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe PurchaseListingResponse()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PurchaseListingResponse>.NativeClassPtr))
	{
		System.IntPtr* ptr = null;
		Unsafe.SkipInit(out System.IntPtr intPtr2);
		System.IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
	...
	public PurchaseListingResponse(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
