...
[System.Serializable]
public class LiveFeedUpdatedMessage : Il2CppSystem.Object
{
	[System.Serializable]
	public class Payload : Il2CppSystem.Object
	{
		...
		public unsafe Il2CppReferenceArray<WinnerLiveFeedElement> feed
		{
			get
			{
				...
				return (intPtr != (System.IntPtr)0) ? Il2CppObjectPool.Get<Il2CppReferenceArray<WinnerLiveFeedElement>>(intPtr) : null;
			}
			set
			{
		...
		static Payload()
		{
			Il2CppClassPointerStore<Payload>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<LiveFeedUpdatedMessage>.NativeClassPtr, "Payload");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Payload>.NativeClassPtr, 100666444);
		}
	...
	static LiveFeedUpdatedMessage()
	{
		Il2CppClassPointerStore<LiveFeedUpdatedMessage>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "BAPBAP.Network", "LiveFeedUpdatedMessage");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<LiveFeedUpdatedMessage>.NativeClassPtr);
		NativeFieldInfoPtr_event = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<LiveFeedUpdatedMessage>.NativeClassPtr, "event");
		NativeFieldInfoPtr_payload = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<LiveFeedUpdatedMessage>.NativeClassPtr, "payload");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LiveFeedUpdatedMessage>.NativeClassPtr, 100666443);
	}

	[CallerCount(5410)]
	[CachedScanResults(RefRangeStart = 11, RefRangeEnd = 5421, XrefRangeStart = 11, XrefRangeEnd = 5421, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe LiveFeedUpdatedMessage()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<LiveFeedUpdatedMessage>.NativeClassPtr))
	{
		System.IntPtr* ptr = null;
		Unsafe.SkipInit(out System.IntPtr intPtr2);
		System.IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
	...
	public LiveFeedUpdatedMessage(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
