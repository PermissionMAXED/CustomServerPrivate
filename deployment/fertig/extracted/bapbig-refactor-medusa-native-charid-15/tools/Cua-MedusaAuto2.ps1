...
for($k=0;$k -lt 12;$k++){ $sz=WH $gpid $wid; if($sz[0] -gt 0){ CR $gpid $wid 0.761 0.879 $sz[0] $sz[1]; Start-Sleep -Milliseconds 350; CR $gpid $wid 0.497 0.647 $sz[0] $sz[1] }; Start-Sleep -Milliseconds 1500 }
