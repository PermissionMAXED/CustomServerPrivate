...
Set-JsonProperty $settings.CustomServer 'RequireGameServerKcpPort' $false
...
Set-JsonProperty $settings.CustomServer 'GameServerStartRetryDelaySeconds' 2
...
Set-JsonProperty $settings.CustomServer 'GameServerWrapperOnlyStartupStallGraceSeconds' 8
Set-JsonProperty $settings.CustomServer 'GameServerWrapperOnlyStartupStallSeconds' 5
...
Set-JsonProperty $settings.CustomServer.MatchmakingQueue 'DefaultBotCount' 4
Set-JsonProperty $settings.CustomServer.MatchmakingQueue 'MaxBotCount' 4
Set-JsonProperty $settings.CustomServer.MatchmakingQueue 'DefaultBotDifficulty' 1
Set-JsonProperty $settings.CustomServer.MatchmakingQueue 'DefaultMapId' 1
...
$settings | ConvertTo-Json -Depth 50 | Set-Content -LiteralPath $appsettings -Encoding UTF8
...
"@ | Set-Content -LiteralPath (Join-Path $ServerRoot "start-linux-wine.sh") -Encoding UTF8
...
$deploymentInfo | ConvertTo-Json -Depth 8 | Set-Content -LiteralPath $deploymentInfoPath -Encoding UTF8
...
LocalProxyPort=5055
```
'@ | Set-Content -LiteralPath (Join-Path $PackageRoot "README-FULL-LINUX-WINE.md") -Encoding UTF8
...
$ExpectedModDllSha256 = 'A32BF4340BA5E285699BE0B4A0DF9436D5C7B7171FC050E4D24A7F735FC83B86'
$ExpectedMedusaDllSha256 = '1CB0A7D1EA66EFF1B53162CC0CC2E10059AC30A0E3F038FA241629FD73D8F38A'
