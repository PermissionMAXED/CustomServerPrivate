...
public class GameMode : NetworkBehaviour
{
	...
	[CompilerGenerated]
	public sealed class <LoadCoroutine>d__79 : IEnumerator<object>, IEnumerator, IDisposable
	{
		[NonSerialized]
		public int <>1__state;
		...
		[DebuggerHidden]
		public <LoadCoroutine>d__79(int <>1__state)
		{
		}
	...
	[CompilerGenerated]
	public sealed class <WaitToDestroyMapIconCoroutine>d__135 : IEnumerator<object>, IEnumerator, IDisposable
	{
		[NonSerialized]
		public int <>1__state;
		...
		[DebuggerHidden]
		public <WaitToDestroyMapIconCoroutine>d__135(int <>1__state)
		{
		}
	...
	[CompilerGenerated]
	public sealed class <WaitToEnableSpectatorModeOnKilledPlayerSubroutine>d__178 : IEnumerator<object>, IEnumerator, IDisposable
	{
		[NonSerialized]
		public int <>1__state;
		...
		[DebuggerHidden]
		public <WaitToEnableSpectatorModeOnKilledPlayerSubroutine>d__178(int <>1__state)
		{
		}
	...
	[CompilerGenerated]
	public sealed class <WaitToPlayAugmentAudio>d__148 : IEnumerator<object>, IEnumerator, IDisposable
	{
		[NonSerialized]
		public int <>1__state;
		...
		[DebuggerHidden]
		public <WaitToPlayAugmentAudio>d__148(int <>1__state)
		{
		}
	...
	[CompilerGenerated]
	public sealed class <WaitToUpdateSpectatorTargetOnPlayer>d__181 : IEnumerator<object>, IEnumerator, IDisposable
	{
		[NonSerialized]
		public int <>1__state;
		...
		[DebuggerHidden]
		public <WaitToUpdateSpectatorTargetOnPlayer>d__181(int <>1__state)
		{
		}
	...
	[IteratorStateMachine(typeof(<LoadCoroutine>d__79))]
	...
	[IteratorStateMachine(typeof(<WaitToDestroyMapIconCoroutine>d__135))]
	...
	[IteratorStateMachine(typeof(<WaitToPlayAugmentAudio>d__148))]
	...
	[IteratorStateMachine(typeof(<WaitToEnableSpectatorModeOnKilledPlayerSubroutine>d__178))]
	...
	[IteratorStateMachine(typeof(<WaitToUpdateSpectatorTargetOnPlayer>d__181))]
	...
	public void UserCode_TargetSyncMapEntities__NetworkConnection__List`1(NetworkConnection conn, List<EntityMapIconSync> entitiesToSync)
	{
	}

	public static void InvokeUserCode_TargetSyncMapEntities__NetworkConnection__List`1(NetworkBehaviour obj, NetworkReader reader, NetworkConnectionToClient senderConnection)
	{
	}
